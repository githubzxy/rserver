 ...
 * @date 19-5-13
 */
define('kmms/productionManage/taskManage/taskApprove/taskApprovePage',
	[
	 	'bui/common',
	 	'bui/data',
	 	'bui/grid',
	 	...
	 	'kmms/productionManage/taskManage/taskApprove/taskApproveAdd',
    ...
    var BUI = r('bui/common'),
    	...
    	taskApproveAdd = r('kmms/productionManage/taskManage/taskApprove/taskApproveAdd'),
    	taskApplyDetail = r('kmms/productionManage/taskManage/taskApply/taskApplyDetail');
    var taskApprovePage = BUI.Component.Controller.extend(
        {
            ...
            bindUI:function(){
                ...
                table.on('cellclick',function(ev){
                    ...
                    if(target.hasClass('approveBtn')){
                        var approveDialog = new taskApproveAdd({
                            collectionName:_self.get('collectionName'),
            ...
            _initStore:function () {
                ...
                var store = new Data.Store({
                    url : "/kmms/taskApproveAction/findAll.cn",
                    autoLoad : true ,
                    pageSize : 20,
                    proxy : {
                        method : 'post',
