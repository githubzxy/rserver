 ...
 * @date 19-5-13
 */
define('kmms/productionManage/taskManage/taskReply/taskWorkshopReplyDistribute',
		[
			'bui/common',
			'bui/form',
			'bui/select',
    ...
    var taskWorkshopReplyDistribute = BUI.Overlay.Dialog.extend({
...
//		    $('#formContainer #submitOrgId').val(_self.get('orgId'));
        ...
        _initDepartPicker:function(){
        	...
        	var orgPicker = new OrganizationPicker({
        		...
        		url : '/kmms/taskWorkshopReplyAction/getDepart',//必填项
        		autoHide : true,
...
//        		checkType:"all",//有勾选框
        ...
        _getDepartData:function(){
			...
			var store = new Data.Store({
			    url : '/kmms/taskWorkshopReplyAction/getDepart', 
			    params:{workShopName:_self.get("orgId")},
			    autoLoad : true,    
			    proxy : {
			      method : 'post',
...
//	     	  				'</div>'
            ...
            var form = new FormContainer({
                id : 'taskWorkshopReplyDistributeForm',
                colNum : colNum,
...
//                elStyle:{overflowY:'scroll',height:'400px'}
        ...
        ATTRS : {
            id : {value : 'taskWorkshopReplyDistributeDialog'},
            elAttrs : {value : {id:"taskWorkshopReplyDistribute"}},
            title:{value:'派发'},
            width:{value:600},
            height:{value:260},
            contextPath : {},
            ...
            apply:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('taskWorkshopReplyDistributeForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
...
//	        		}
                    ...
                    var pl = new PostLoad({
        				url : '/zuul/kmms/taskWorkshopReplyAction/distributeDoc',
        				el : _self.get('el'),
        				loadMsg : '上传中...'
        			}); 
    ...
    return taskWorkshopReplyDistribute;
});