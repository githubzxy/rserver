 ...
 * @date 19-5-13
 */
define('kmms/productionManage/taskManage/taskQuery/taskQueryPageOfSendUser',
	[
	 	'bui/common',
	 	'bui/data',
	 	'bui/grid',
    ...
    var taskQueryPageOfSendUser = BUI.Component.Controller.extend(
        {
...
//                    permissionStore : _self._initPermissionStore()
    	...
    	return taskQueryPageOfSendUser;
});