 ...
 * @date 19-5-13
 */
define('kmms/productionManage/taskManage/taskCheck/taskCheckPage',
	[
	 	'bui/common',
	 	'bui/data',
	 	'bui/grid',
	 	...
	 	'kmms/productionManage/taskManage/taskCheck/taskCheckAdd',
    ...
    var BUI = r('bui/common'),
    	...
    	taskCheckAdd = r('kmms/productionManage/taskManage/taskCheck/taskCheckAdd'),
    	taskApplyDetail = r('kmms/productionManage/taskManage/taskApply/taskApplyDetail');
    var taskCheckPage = BUI.Component.Controller.extend(
        {
            ...
            bindUI:function(){
                ...
                table.on('cellclick',function(ev){
                    ...
                    if(target.hasClass('checkBtn')){
                        var checkDialog = new taskCheckAdd({
                            collectionName:_self.get('collectionName'),
            ...
            _initStore:function () {
                ...
                var store = new Data.Store({
                    url : "/kmms/taskCheckAction/findAll.cn",
                    autoLoad : true ,
                    pageSize : 20,
                    proxy : {
                        method : 'post',
