 ...
 * @date 19-3-5
 */
define('kmms/productionManage/circuitWorkOrderManage/circuitWorkOrderQuery/circuitWorkOrderQueryPage',
	[
	 	'bui/common',
	 	'bui/data',
	 	'bui/grid',
    ...
    var CircuitWorkOrderQueryPage = BUI.Component.Controller.extend(
        {
            ...
            _initStore:function () {
                ...
                var store = new Data.Store({
                    url : "/kmms/circuitWorkOrderQueryAction/findAll.cn",
                    autoLoad : true ,
                    pageSize : 20,
                    proxy : {
                        method : 'post',
...
//                    permissionStore : _self._initPermissionStore()
    	...
    	return CircuitWorkOrderQueryPage;
});