 ...
 * @date 18-11-21
 */
define('kmms/technicalManagement/communicationResumeManage/tat/otherEdit',['bui/common',
	'common/form/FormContainer',
    'bui/form',
    ],function(r){
    var BUI = r('bui/common'),
        FormContainer= r('common/form/FormContainer');
    var otherEdit = BUI.Overlay.Dialog.extend({
            ...
            var childs = [
            	{
                    ...
                    redStarFlag : true,
                    itemColspan : 1,
                    item : '<input type="text" name="capacityCallsNumber" id="capacityCallsNumber" style="width:98.5%" data-rules="{required:true}"/>'
                },{
                    label : '容量单位（自动计算）：',
                    redStarFlag : true,
                    itemColspan : 1,
                    item : '<input type="text" name="capacityUnit" id="capacityUnit" style="width:98.5%" data-rules="{required:true}"/>'
                },{
                    label : '设备厂家：',
                    redStarFlag : true,
                    itemColspan : 1,
        ...
        ATTRS : {
            ...
            success:{
                value : function(){
                    ...
                    xhr.open("POST", "/zuul/kmms/tatAction/otherUpdateDoc");
                    xhr.send(formData);
