 ...
 * 详情模块
 */
define('kmms/technicalManagement/communicationResumeManage/tat/otherInfo',['bui/common',
          		...
          		success:function(res){
					...
					if(data){
						 $("#formContainer #workshop").val(data.workshop);
	            		    ...
	            		    $('#formContainer #capacityCallsNumber').val(data.capacityCallsNumber);
	            		    $('#formContainer #capacityUnit').val(data.capacityUnit);
		            ...
		            var childs = [
		            	{
		                    ...
		                    item : 
							       ...
							       '</th>'+
							       '<td style="width:30%">'+
								   '<input type="text" id="site_station_line" readOnly name="site_station_line" class="station" style="width:98%;" />'+
								   '</td>'+
								   '</tr>'+
								   '<tr class="thTdPadding">'+
							       ...
							       '</th>'+
							       '<td style="width:30%">'+
								   '<input type="text" id="site_station_name" readOnly name="site_station_name" class="station" style="width:98%;" />'+
								   '</td>'+
								   '</tr>'+
								   '<tr class="thTdPadding">'+
							       ...
							       '</th>'+
							       '<td style="width:30%">'+
								   '<input type="text" id="site_station_place" readOnly name="site_station_place" class="station" style="width:98%;" />'+
								   '</td>'+
							       '</tr>'+
							       '<tr class="thTdPadding">'+
							       '<th rowspan="3">区间</th>'+
							       ...
							       '</th>'+
							       '<td style="width:30%">'+
								   '<input type="text" id="site_range_line" readOnly name="site_range_line" class="range" style="width:98%;" />'+
								   '</td>'+
								   '</tr>'+
								   '<tr class="thTdPadding">'+
							       ...
							       '</th>'+
							       '<td style="width:30%">'+
								   '<input type="text" id="site_range_post" readOnly name="site_range_post" class="range" style="width:98%;" />'+
								   '</td>'+
								   '</tr>'+
								   '<tr class="thTdPadding">'+
								   '<th style="width:20%" ">安装地点：'+
							       '</th>'+
							       '<td style="width:30%">'+
								   '<input type="text" id="site_range_place" readOnly name="site_range_place" class="range" style="width:98%;" />'+
								   '</td>'+
							       '</tr>'+
							       '<tr class="thTdPadding">'+
							       '<th rowspan="2">其他</th>'+
							       ...
							       '</th>'+
							       '<td style="width:30%">'+
								   '<input type="text" id="site_other_line" readOnly name="site_other_line" class="other" style="width:98%;" />'+
								   '</td>'+
								   '</tr>'+
								   '<tr class="thTdPadding">'+
								   '<th style="width:20%" >安装地点：'+
							       '</th>'+
							       '<td style="width:30%">'+
								   '<input type="text" id="site_other_place" readOnly name="site_other_place" class="other" style="width:98%;" />'+
								   '</td>'+
								   '</tr>'+
								   '<tr class="thTdPadding">'+
							       ...
							       '</th>'+
							       '<td style="width:30%">'+
								   '<input type="text" id="site_machineRoomCode" readOnly name="site_machineRoomCode"  style="width:98%;" data-rules="{required:true}" />'+
								   '</td>'+
								   '</tr>'+
							       '</tbody>'+
							       '</table>'
		                    ...
		                    redStarFlag : true,
		                    itemColspan : 1,
		                    item : '<input type="text" name="capacityCallsNumber" id="capacityCallsNumber" style="width:98.5%" readOnly/>'
		                },{
		                    label : '容量单位（自动计算）：',
		                    redStarFlag : true,
		                    itemColspan : 1,
		                    item : '<input type="text" name="capacityUnit" id="capacityUnit" style="width:98.5%" readOnly/>'
		                },{
		                    label : '设备厂家：',
		                    redStarFlag : true,
		                    itemColspan : 1,
		                    ...
		                    label : '固资编号：',
		                    itemColspan : 2,
		                    item : '<input type="text" name="fixedAssetsCode" readOnly id="fixedAssetsCode" style="width:99%" />'
		                },{
		                    label : '备注：',
		                    itemColspan : 2,
