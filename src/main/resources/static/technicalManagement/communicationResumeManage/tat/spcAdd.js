 ...
 * @date 18-11-21
 */
define('kmms/technicalManagement/communicationResumeManage/tat/spcAdd',
		   ['bui/common',
    ...
    var spcAdd = BUI.Overlay.Dialog.extend({
        ...
        ATTRS : {
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('spcAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/tatAction/spcAddDoc");
                    xhr.send(formData);
