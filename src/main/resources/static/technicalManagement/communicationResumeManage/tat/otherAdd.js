 ...
 * @date 18-11-21
 */
define('kmms/technicalManagement/communicationResumeManage/tat/otherAdd',
		   ['bui/common',
    ...
    var otherAdd = BUI.Overlay.Dialog.extend({
        ...
        ATTRS : {
            ...
            success:{
                value : function(){
                    ...
                    xhr.open("POST", "/zuul/kmms/tatAction/otherAddDoc");
                    xhr.send(formData);
