 ...
 * @date 19-6-19
 */
define('kmms/technicalManagement/communicationResumeManage/dispatch/trunkAdd',
		   ['bui/common',
    ...
    var trunkAdd = BUI.Overlay.Dialog.extend({
        ...
        ATTRS : {
            id : {value : 'trunkDialog'},
            elAttrs : {value: {id:"trunkAdd"}},
            title:{value:'干线调度-01'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('trunkAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/dispatchAction/trunk/addDoc");
                    xhr.send(formData);
