 ...
 * @date 19-6-19
 */
define('kmms/technicalManagement/communicationResumeManage/dispatch/stationChangerInfo',['bui/common',
	...
	var stationChangerInfo = BUI.Overlay.Dialog.extend({
			...
			var colNum = 2;
		            var childs = [
		                ...
		                },
		                {
		                    ...
		                    redStarFlag : true,
		                    itemColspan : 1,
		                    item : '<input type="text" name="numOfTrunkConf" id="numOfTrunkConf" style="width:98.5%" readOnly/>'
		                },
		                {
		                    label : '2M端口实际使用数量：',
		                    redStarFlag : true,
		                    itemColspan : 1,
		                    item : '<input type="text" name="numOfTrunkUsed" id="numOfTrunkUsed" style="width:98.5%" readOnly/>'
		                },
		                {
		                    label : '值班台数量：',
		                    redStarFlag : true,
		                    itemColspan : 1,
		                    item : '<input type="text" name="numOfUserConf" id="numOfUserConf" style="width:98.5%" readOnly/>'
		                },
		                {
		                    label : '电话分机数量：',
		                    redStarFlag : true,
		                    itemColspan : 1,
		                    item : '<input type="text" name="numOfUserUsed" id="numOfUserUsed" style="width:98.5%" readOnly/>'
		                },
		                {
		                    label : '固资编号：',
		                    itemColspan : 2,
