 ...
 * @date 19-6-19
 */
define('kmms/technicalManagement/communicationResumeManage/dispatch/dutyAdd',
		   ['bui/common',
    ...
    var dutyAdd = BUI.Overlay.Dialog.extend({
            ...
            var childs = [
            	{
                    ...
                    redStarFlag : true,
                    itemColspan : 1,
                    item : '<input type="text" name="numbeDigital" style="width:98%" id="numbeDigital" data-rules="{required:true}"></input>'
                },
                {
                    label : '所属调度操作台序号：',
                    redStarFlag : true,
                    itemColspan : 1,
                    item : '<input type="text" name="numberDispatch" style="width:98%" id="numberDispatch" data-rules="{required:true}"></input>'
                },
				{
                    label : '车间：',
                    redStarFlag : true,
        ...
        ATTRS : {
            id : {value : 'dutyDialog'},
            elAttrs : {value: {id:"dutyAdd"}},
            title:{value:'车站值班台-04'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('dutyAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/dispatchAction/duty/addDoc");
                    xhr.send(formData);
