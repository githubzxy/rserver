 ...
 * @date 19-6-19
 */
define('kmms/technicalManagement/communicationResumeManage/dispatch/stationChangerAdd',
		   ['bui/common',
    ...
    var stationChangerAdd = BUI.Overlay.Dialog.extend({
        ...
        ATTRS : {
            id : {value : 'stationChangerDialog'},
            elAttrs : {value: {id:"stationChangerAdd"}},
            title:{value:'车站交换机-03'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('stationChangerAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/dispatchAction/stationChanger/addDoc");
                    xhr.send(formData);
