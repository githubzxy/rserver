 ...
 * @date 18-11-21
 */
define('kmms/technicalManagement/communicationResumeManage/line/pipelineAdd',
		   ['bui/common',
    ...
    var pipelineAdd = BUI.Overlay.Dialog.extend({
        ...
        ATTRS : {
            id : {value : 'pipelineDialog'},
            elAttrs : {value: {id:"pipelineAdd"}},
            title:{value:'新增管道'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('pipelineAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/lineAction/pipelineAddDoc");
                    xhr.send(formData);
