 ...
 * @date 18-11-21
 */
define('kmms/technicalManagement/communicationResumeManage/line/lineAndLightAdd',
		   ['bui/common',
    ...
    var lineAndLightAdd = BUI.Overlay.Dialog.extend({
        ...
        ATTRS : {
            id : {value : 'lineAndLightDialog'},
            elAttrs : {value: {id:"lineAndLightAdd"}},
            title:{value:'新增线缆与光缆配套(含电杆类)'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('lineAndLightAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/lineAction/lineAndLightAddDoc");
                    xhr.send(formData);
