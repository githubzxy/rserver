 ...
 * @date 18-11-21
 */
define('kmms/technicalManagement/communicationResumeManage/line/lightAdd',
		   ['bui/common',
    ...
    var lightAdd = BUI.Overlay.Dialog.extend({
        ...
        ATTRS : {
            id : {value : 'lightDialog'},
            elAttrs : {value: {id:"lightAdd"}},
            title:{value:'新增光缆属性'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('lightAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/lineAction/lightAddDoc");
                    xhr.send(formData);
