 ...
 * @date 18-11-21
 */
define('kmms/technicalManagement/communicationResumeManage/line/pipelineEdit',['bui/common',
	'common/form/FormContainer',
    'bui/form',
    ],function(r){
    var BUI = r('bui/common'),
        FormContainer= r('common/form/FormContainer');
    var pipelineEdit = BUI.Overlay.Dialog.extend({
            ...
            var childs = [
            	{
                    ...
                    redStarFlag : true,
                    itemColspan : 1,
                    item : '<input type="text" name="length" id="length" style="width:99%" data-rules="{required:true}"/>'
                },{
                    label : '总容量：',
                    redStarFlag : true,
                    itemColspan : 1,
        ...
        ATTRS : {
            id : {value : 'pipelineEditDialog'},
            elAttrs : {value: {id:"pipelinePointEdit"}},
            title:{value:'编辑管道'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('pipelineEditForm'),delData=_self.get('delData');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/lineAction/pipelineUpdateDoc");
                    xhr.send(formData);
