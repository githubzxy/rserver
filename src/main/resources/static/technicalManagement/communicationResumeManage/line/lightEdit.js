 ...
 * @date 18-11-21
 */
define('kmms/technicalManagement/communicationResumeManage/line/lightEdit',['bui/common',
	'common/form/FormContainer',
    'bui/form',
    ],function(r){
    var BUI = r('bui/common'),
        FormContainer= r('common/form/FormContainer');
    var lightEdit = BUI.Overlay.Dialog.extend({
            ...
            var childs = [
            	{
                    ...
                    redStarFlag : true,
                    itemColspan : 1,
                    item : '<input type="text" name="coreNumber" id="coreNumber" style="width:99%" data-rules="{required:true}"/>'
                },{
                    label : '在用芯数：',
                    redStarFlag : true,
                    itemColspan : 1,
        ...
        ATTRS : {
            id : {value : 'lightEditDialog'},
            elAttrs : {value: {id:"lightPointEdit"}},
            title:{value:'编辑光缆属性'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('lightEditForm'),delData=_self.get('delData');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/lineAction/lightUpdateDoc");
                    xhr.send(formData);
