 ...
 * @date 18-11-21
 */
define('kmms/technicalManagement/communicationResumeManage/data/routerEdit',['bui/common',
...
//        },
            ...
            var childs = [
                {
                    ...
                    redStarFlag : true,
                    itemColspan : 1,
                    item : '<input type="text" name="slotType" id="slotType" style="width:99%" data-rules="{required:true}"/>'
                },{
                    label : '设备厂家：',
                    redStarFlag : true,
                    itemColspan : 1,
                    item : '<input type="text" name="manufacturers" id="manufacturers" style="width:98.5%" data-rules="{required:true}"/>'
                },{
                    label : '设备型号：',
                    redStarFlag : true,
                    itemColspan : 1,
                    ...
                    label : '使用单位：',
                    itemColspan : 1,
                    item : '<input type="text" name="useUnit" id="useUnit" style="width:98.5%" />'
                },{
                    label : '出厂日期：',
                    itemColspan : 1,
                    item : '<input type="text" class="calendar" readonly name="productionDate" id="productionDate" style="width:99%" />'
                },{
                    label : '使用日期：',
                    redStarFlag : true,
                    itemColspan : 1,
                    item : '<input type="text" class="calendar" readonly name="useDate" id="useDate" style="width:98.5%" data-rules="{required:true}"/>'
                },{
                    label : '设备运行状态：',
                    redStarFlag : true,
                    itemColspan : 1,
                    item : '<input type="text" name="deviceOperationStatus" id="deviceOperationStatus" style="width:99%" data-rules="{required:true}"/>'
                },{
                    label : '停用日期：',
                    itemColspan : 1,
                    item : '<input type="text" class="calendar"  readonly name="stopDate" id="stopDate" style="width:98.5%" />'
                },{
                    label : '报废日期：',
                    itemColspan : 1,
                    item : '<input type="text" class="calendar" readonly name="scrapDate" id="scrapDate" style="width:99%" />'
                },{
                    label : '应用层次：',
                    itemColspan : 1,
                    item : '<input type="text" name="applicationLevel" id="applicationLevel" style="width:98.5%" />'
                },{
                    label : '槽位总数：',
                    itemColspan : 1,
                    ...
                    label : '622M端口配置数：',
                    itemColspan : 1,
                    item : '<input type="text" name="_622MportConfigNumber" id="_622MportConfigNumber" style="width:99%"/>'
                },{
                    label : '622M端口占用数：',
                    itemColspan : 1,
                    item : '<input type="text" name="_622MportUseNumber" id="_622MportUseNumber" style="width:98.5%"/>'
                },{
                    label : '155M端口配置数：',
                    itemColspan : 1,
                    item : '<input type="text" name="_155MportConfigNumber" id="_155MportConfigNumber" style="width:99%"/>'
                },{
                    label : '155M端口占用数：',
                    itemColspan : 1,
                    item : '<input type="text" name="_155MportUseNumber" id="_155MportUseNumber" style="width:98.5%"/>'
                },{
                    label : '2M端口配置数：',
                    itemColspan : 1,
                    item : '<input type="text" name="_2MportConfigNumber" id="_2MportConfigNumber" style="width:99%"/>'
                },{
                    label : '2M端口占用数：',
                    itemColspan : 1,
                    item : '<input type="text" name="_2MportUseNumber" id="_2MportUseNumber" style="width:98.5%"/>'
                },{
                    label : 'GE端口配置数：',
                    itemColspan : 1,
        ...
        ATTRS : {
            id : {value : 'routerEditDialog'},
            elAttrs : {value: {id:"routerPointEdit"}},
            title:{value:'编辑路由器-01'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('routerEditForm'),delData=_self.get('delData');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/dataAction/updateDocRouter");
                    xhr.send(formData);
