 ...
 * 详情模块
 */
define('kmms/technicalManagement/communicationResumeManage/data/otherInfo',['bui/common',
				...
				url:'/kmms/dataAction/findById',
          		...
          		success:function(res){
					...
					if(data){
						...
						$('#formContainer #accessType').val(data.accessType);
			...
			var childs = [
				{
					...
					label : '出厂日期：',
					itemColspan : 1,
					item : '<input type="text" name="productionDate" id="productionDate" style="width:98.5%" readOnly/>'
				},{
					label : '使用日期：',
					itemColspan : 1,
					...
					label : '停用日期：',
					itemColspan : 1,
					item : '<input type="text"  readonly name="stopDate" id="stopDate" style="width:99%"/>'
				},{
					label : '报废日期：',
					itemColspan : 1,
					item : '<input type="text"readonly name="scrapDate" id="scrapDate" style="width:98.5%" readOnly/>'
				},{
					label : '容量单位：',
					itemColspan : 1,
					item : '<input type="text" name="capacityUnit" id="capacityUnit" style="width:99%" readOnly/>'
				},{
					label : '容量：',
					itemColspan : 1,
					item : '<input type="text" name="capacity" id="capacity" style="width:98.5%" readOnly/>'
				},{
					label : '接入类型：',
					itemColspan : 1,
					item : '<input type="text" name="accessType" id="accessType" style="width:99%" readOnly/>'
				},{
					label : '固资编号：',
					itemColspan : 1,
					item : '<input type="text" name="fixedAssetsCode" id="fixedAssetsCode" style="width:98.5%" readOnly/>'
				},{
					label : '备注：',
					itemColspan : 2,
					item : '<textarea name="remark" id="remark" style="width:99%;height:50px" readOnly/></textarea>'
				}
			];
