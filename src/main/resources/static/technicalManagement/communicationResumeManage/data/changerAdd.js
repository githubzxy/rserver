 ...
 * @date 2019-6-17
 */
define('kmms/technicalManagement/communicationResumeManage/data/changerAdd',
		   ['bui/common',
    ...
    var RouterAdd = BUI.Overlay.Dialog.extend({
        ...
        ATTRS : {
            id : {value : 'changerDialog'},
            elAttrs : {value: {id:"changerAdd"}},
            title:{value:'新增交换机-02'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('changerAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/dataAction/addDocChanger");
                    xhr.send(formData);
