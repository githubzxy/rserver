 ...
 * @date 2019-6-17
 */
define('kmms/technicalManagement/communicationResumeManage/data/otherAdd',
		   ['bui/common',
    ...
    var RouterAdd = BUI.Overlay.Dialog.extend({
        ...
        ATTRS : {
            id : {value : 'otherDialog'},
            elAttrs : {value: {id:"otherAdd"}},
            title:{value:'新增其它设备-03'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('otherAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/dataAction/addDocOther");
                    xhr.send(formData);
