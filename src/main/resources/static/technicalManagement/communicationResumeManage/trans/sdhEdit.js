 ...
 * @date 18-11-21
 */
define('kmms/technicalManagement/communicationResumeManage/trans/sdhEdit',['bui/common',
	'common/form/FormContainer',
    'bui/form',
    ],function(r){
    var BUI = r('bui/common'),
        FormContainer= r('common/form/FormContainer');
    var sdhEdit = BUI.Overlay.Dialog.extend({
            ...
            var childs = [
            	{
                    ...
                    redStarFlag : true,
                    itemColspan : 1,
                    item : '<input type="text" name="deviceId" id="deviceId" style="width:98.5%" data-rules="{required:true}"/>'
                },{
                    label : '系统名称：',
                    redStarFlag : true,
                    itemColspan : 1,
                    item : '<input type="text" name="systemName" id="systemName" style="width:99%" data-rules="{required:true}"/>'
                },{
                    ...
                    label : '使用单位：',
                    itemColspan : 1,
                    item : '<input type="text" name="useUnit" id="useUnit" style="width:99%;height:60px;" />'
                },{
                    label : '总容量（折合622Mb/s个数）：',
                    itemColspan : 1,
                    item : '<input type="text" name="totalCapacity" id="totalCapacity" style="width:98.5%;height:60px;" />'
                },{
                    label : '路产容量（折合622Mb/s个数）：',
                    itemColspan : 1,
                    item : '<input type="text" name="roadCapacity" id="roadCapacity" style="width:99%;height:60px;" />'
                },{
                    label : '资产比例：',
                    itemColspan : 1,
                    item : '<input type="text" name="assetRatio" id="assetRatio" style="width:99%;height:60px;" />'
                },{
                    label : '出厂日期：',
                    itemColspan : 1,
        ...
        ATTRS : {
            id : {value : 'sdhEditDialog'},
            elAttrs : {value: {id:"sdhPointEdit"}},
            title:{value:'编辑同步数字体系(SDH)'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('sdhEditForm'),delData=_self.get('delData');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/transAction/sdhUpdateDoc");
                    xhr.send(formData);
