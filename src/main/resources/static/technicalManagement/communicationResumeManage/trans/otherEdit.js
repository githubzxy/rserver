 ...
 * @date 18-11-21
 */
define('kmms/technicalManagement/communicationResumeManage/trans/otherEdit',['bui/common',
            ...
            var childs = [
        		{
                    ...
                    redStarFlag : true,
                    itemColspan : 1,
                    item : '<input type="text" name="accessType" id="accessType" style="width:98.5%" data-rules="{required:true}"/>'
                },{
                    label : '设备厂家：',
                    redStarFlag : true,
                    itemColspan : 1,
        ...
        ATTRS : {
            ...
            success:{
                value : function(){
                    ...
                    xhr.open("POST", "/zuul/kmms/transAction/otherUpdateDoc");
                    xhr.send(formData);
