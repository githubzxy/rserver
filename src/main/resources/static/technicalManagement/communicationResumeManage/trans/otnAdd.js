 ...
 * @date 18-11-21
 */
define('kmms/technicalManagement/communicationResumeManage/trans/otnAdd',
		   ['bui/common',
    ...
    var otnAdd = BUI.Overlay.Dialog.extend({
        ...
        ATTRS : {
            id : {value : 'otnDialog'},
            elAttrs : {value: {id:"otnAdd"}},
            title:{value:'新增光传送网(OTN)'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('otnAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/transAction/otnAddDoc");
                    xhr.send(formData);
