 ...
 * @date 18-11-21
 */
define('kmms/technicalManagement/communicationResumeManage/trans/numberTransEdit',['bui/common',
	'common/form/FormContainer',
    'bui/form',
    ],function(r){
    var BUI = r('bui/common'),
        FormContainer= r('common/form/FormContainer');
    var numberTransEdit = BUI.Overlay.Dialog.extend({
        ...
        ATTRS : {
            id : {value : 'numberTransEditDialog'},
            elAttrs : {value: {id:"numberTransPointEdit"}},
            title:{value:'编辑波分(numberTrans)'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('numberTransEditForm'),delData=_self.get('delData');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/transAction/numberTransUpdateDoc");
                    xhr.send(formData);
