 ...
 * @date 18-11-21
 */
define('kmms/technicalManagement/communicationResumeManage/trans/otnEdit',['bui/common',
	'common/form/FormContainer',
    'bui/form',
    ],function(r){
    var BUI = r('bui/common'),
        FormContainer= r('common/form/FormContainer');
    var otnEdit = BUI.Overlay.Dialog.extend({
        ...
        ATTRS : {
            id : {value : 'otnEditDialog'},
            elAttrs : {value: {id:"otnPointEdit"}},
            title:{value:'编辑光传送网(OTN)'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('otnEditForm'),delData=_self.get('delData');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/transAction/otnUpdateDoc");
                    xhr.send(formData);
