 ...
 * @date 18-11-21
 */
define('kmms/technicalManagement/communicationResumeManage/trans/sdhAdd',
		   ['bui/common',
    ...
    var sdhAdd = BUI.Overlay.Dialog.extend({
        ...
        ATTRS : {
            id : {value : 'sdhDialog'},
            elAttrs : {value: {id:"sdhAdd"}},
            title:{value:'新增同步数字体系(SDH)'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('sdhAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/transAction/sdhAddDoc");
                    xhr.send(formData);
