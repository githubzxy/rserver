 ...
 * @date 19-06-17
 */
define('kmms/technicalManagement/communicationResumeManage/video/videoAdd',
    ['bui/common',
        ...
        var VideoAdd = BUI.Overlay.Dialog.extend({
            ...
            ATTRS : {
                id : {value : 'videoDialog'},
                elAttrs : {value: {id:"videoAdd"}},
                title:{value:'新增视频监控类-01'},
                width:{value:630},
                height:{value:500},
                contextPath : {},
                ...
                success:{
                    value : function(){
                        var _self = this;
                        var formAdd = _self.getChild('videoAddForm');
                        //验证不通过
                        if(!formAdd.isValid()){
                            return;
                        }
                        ...
                        xhr.open("POST", "/zuul/kmms/videoAction/addDocVideo");
                        xhr.send(formData);
