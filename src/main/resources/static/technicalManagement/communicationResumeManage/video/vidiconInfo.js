 ...
 * 详情模块
 */
define('kmms/technicalManagement/communicationResumeManage/video/vidiconInfo',['bui/common',
	...
	var VidiconInfo = BUI.Overlay.Dialog.extend({
		            ...
		            var childs = [
		            	{
                            ...
                            label : '摄像机类型：',
                            itemColspan : 1,
                            item : '<input type="text" name="vidiconType" id="vidiconType" style="width:98.5%" readOnly/>'
                        },{
		                    label : '设备厂家：',
		                    itemColspan : 1,
