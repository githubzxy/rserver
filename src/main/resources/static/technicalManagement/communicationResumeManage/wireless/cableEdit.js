 ...
 * @date 19-06-17
 */
define('kmms/technicalManagement/communicationResumeManage/wireless/cableEdit',['bui/common',
	'common/form/FormContainer',
    'bui/form',
    ],function(r){
    var BUI = r('bui/common'),
        FormContainer= r('common/form/FormContainer');
    var CableEdit = BUI.Overlay.Dialog.extend({
            ...
            var childs = [
                {
                    ...
                    '</th>'+
                    '<td style="width:30%">'+
                    '<input type="text" id="site_start_station_line" name="site_start_station_line" class="station" style="width:98%;" />'+
                    '</td>'+
                    '</tr>'+
                    '<tr class="thTdPadding">'+
                    ...
                    '</th>'+
                    '<td style="width:30%">'+
                    '<input type="text" id="site_start_station_name" name="site_start_station_name" class="station" style="width:98%;" />'+
                    '</td>'+
                    '</tr>'+
                    '<tr class="thTdPadding">'+
                    ...
                    '</th>'+
                    '<td style="width:30%">'+
                    '<input type="text" id="site_start_station_place" name="site_start_station_place" class="station" style="width:98%;" />'+
                    '</td>'+
                    '</tr>'+
                    '<tr class="thTdPadding">'+
                    '<th rowspan="3">区间</th>'+
                    ...
                    '</th>'+
                    '<td style="width:30%">'+
                    '<input type="text" id="site_start_range_line" name="site_start_range_line" class="range" style="width:98%;" />'+
                    '</td>'+
                    '</tr>'+
                    '<tr class="thTdPadding">'+
                    ...
                    '</th>'+
                    '<td style="width:30%">'+
                    '<input type="text" id="site_start_range_post" name="site_start_range_post" class="range" style="width:98%;" />'+
                    '</td>'+
                    '</tr>'+
                    '<tr class="thTdPadding">'+
                    '<th style="width:20%" >安装地点：'+
                    '</th>'+
                    '<td style="width:30%">'+
                    '<input type="text" id="site_start_range_place" name="site_start_range_place" class="range" style="width:98%;" />'+
                    '</td>'+
                    '</tr>'+
                    '<tr class="thTdPadding">'+
                    '<th rowspan="2">其他</th>'+
                    ...
                    '</th>'+
                    '<td style="width:30%">'+
                    '<input type="text" id="site_start_other_line" name="site_start_other_line" class="other" style="width:98%;" />'+
                    '</td>'+
                    '</tr>'+
                    '<tr class="thTdPadding">'+
                    '<th style="width:20%" >安装地点：'+
                    '</th>'+
                    '<td style="width:30%">'+
                    '<input type="text" id="site_start_other_place" name="site_start_other_place" class="other" style="width:98%;" />'+
                    '</td>'+
                    '</tr>'+
                    '<tr class="thTdPadding">'+
                    ...
                    '</th>'+
                    '<td style="width:30%">'+
                    '<input type="text" id="site_start_machineRoomCode" name="site_start_machineRoomCode"  style="width:98%;" data-rules="{required:true}" />'+
                    '</td>'+
                    '</tr>'+
                    '</tbody>'+
                    '</table>'
                    ...
                    '</th>'+
                    '<td style="width:30%">'+
                    '<input type="text" id="site_end_station_line" name="site_end_station_line" class="station" style="width:98%;" />'+
                    '</td>'+
                    '</tr>'+
                    '<tr class="thTdPadding">'+
                    '<th style="width:20%" >车站名称：'+
                    '</th>'+
                    '<td style="width:30%">'+
                    '<input type="text" id="site_end_station_name" name="site_end_station_name" class="station" style="width:98%;" />'+
                    '</td>'+
                    '</tr>'+
                    '<tr class="thTdPadding">'+
                    '<th style="width:20%" >安装地点：'+
                    '</th>'+
                    '<td style="width:30%">'+
                    '<input type="text" id="site_end_station_place" name="site_end_station_place" class="station" style="width:98%;" />'+
                    '</td>'+
                    '</tr>'+
                    '<tr class="thTdPadding">'+
                    '<th rowspan="3">区间</th>'+
                    ...
                    '</th>'+
                    '<td style="width:30%">'+
                    '<input type="text" id="site_end_range_line" name="site_end_range_line" class="range" style="width:98%;" />'+
                    '</td>'+
                    '</tr>'+
                    '<tr class="thTdPadding">'+
                    '<th style="width:20%" >公里标（米）：'+
                    '</th>'+
                    '<td style="width:30%">'+
                    '<input type="text" id="site_end_range_post" name="site_end_range_post" class="range" style="width:98%;" />'+
                    '</td>'+
                    '</tr>'+
                    '<tr class="thTdPadding">'+
                    '<th style="width:20%" >安装地点：'+
                    '</th>'+
                    '<td style="width:30%">'+
                    '<input type="text" id="site_end_range_place" name="site_end_range_place" class="range" style="width:98%;" />'+
                    '</td>'+
                    '</tr>'+
                    '<tr class="thTdPadding">'+
                    '<th rowspan="2">其他</th>'+
                    ...
                    '</th>'+
                    '<td style="width:30%">'+
                    '<input type="text" id="site_end_other_line" name="site_end_other_line" class="other" style="width:98%;" />'+
                    '</td>'+
                    '</tr>'+
                    '<tr class="thTdPadding">'+
                    '<th style="width:20%" >安装地点：'+
                    '</th>'+
                    '<td style="width:30%">'+
                    '<input type="text" id="site_end_other_place" name="site_end_other_place" class="other" style="width:98%;" />'+
                    '</td>'+
                    '</tr>'+
                    '<tr class="thTdPadding">'+
                    '<th style="width:20%"  colspan="2" ><span style="color:red">*</span>机房、接入点编码：'+
                    '</th>'+
                    '<td style="width:30%">'+
                    '<input type="text" id="site_end_machineRoomCode" name="site_end_machineRoomCode"  style="width:98%;" data-rules="{required:true}" />'+
                    '</td>'+
                    '</tr>'+
                    '</tbody>'+
                    '</table>'
                    ...
                    redStarFlag : true,
                    itemColspan : 1,
                    item : '<input type="text" name="cableLength" id="cableLength" style="width:99%" data-rules="{required:true}"/>'
                },{
                    label : '资产归属：',
                    redStarFlag : true,
                    itemColspan : 1,
        ...
        ATTRS : {
            id : {value : 'cableEditDialog'},
            elAttrs : {value: {id:"cablePointEdit"}},
            title:{value:'编辑漏泄同轴电缆-02'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('cableEditForm'),delData=_self.get('delData');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/wirelessAction/updateDocCable");
                    xhr.send(formData);
