 ...
 * @date 19-06-17
 */
define('kmms/technicalManagement/communicationResumeManage/wireless/wirelessEdit',['bui/common',
	'common/form/FormContainer',
    'bui/form',
    ],function(r){
    var BUI = r('bui/common'),
        FormContainer= r('common/form/FormContainer');
    var WirelessEdit = BUI.Overlay.Dialog.extend({
        ...
        ATTRS : {
            id : {value : 'wirelessEditDialog'},
            elAttrs : {value: {id:"wirelessPointEdit"}},
            title:{value:'编辑无线类-01'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('wirelessEditForm'),delData=_self.get('delData');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/wirelessAction/updateDocWireless");
                    xhr.send(formData);
