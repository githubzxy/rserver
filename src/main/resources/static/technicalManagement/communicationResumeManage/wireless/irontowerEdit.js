 ...
 * @date 19-06-17
 */
define('kmms/technicalManagement/communicationResumeManage/wireless/irontowerEdit',['bui/common',
	'common/form/FormContainer',
    'bui/form',
    ],function(r){
    var BUI = r('bui/common'),
        FormContainer= r('common/form/FormContainer');
    var IrontowerEdit = BUI.Overlay.Dialog.extend({
            ...
            var childs = [
                {
                    ...
                    '</th>'+
                    '<td style="width:30%">'+
                    '<input type="text" id="site_range_upPost" name="site_range_upPost" class="range" style="width:98%;" />'+
                    '</td>'+
                    '</tr>'+
                    '<tr class="thTdPadding">'+
                    ...
                    '</th>'+
                    '<td style="width:30%">'+
                    '<input type="text" id="site_range_downPost" name="site_range_downPost" class="range" style="width:98%;" />'+
                    '</td>'+
                    '</tr>'+
                    '<tr class="thTdPadding">'+
                    '<th rowspan="2">其他</th>'+
                    ...
                    redStarFlag : true,
                    itemColspan : 1,
                    item : '<input type="text" name="towerType" id="towerType" style="width:98.5%" data-rules="{required:true}"/>'
                },{
                    label : '塔高（米）：',
                    redStarFlag : true,
                    itemColspan : 1,
                    item : '<input type="text" name="towerHeight" id="towerHeight" style="width:98.5%" data-rules="{required:true}"/>'
                },{
                    label : '经度：',
                    redStarFlag : true,
                    itemColspan : 1,
                    item : '<input type="text" name="longitude" id="longitude" style="width:98.5%" data-rules="{required:true}"/>'
                },{
                    label : '纬度：',
                    redStarFlag : true,
                    itemColspan : 1,
                    item : '<input type="text" name="latitude" id="latitude" style="width:98.5%" data-rules="{required:true}"/>'
                },{
                    label : '海拔高度（米）：',
                    redStarFlag : true,
                    itemColspan : 1,
                    item : '<input type="text" name="altitude" id="altitude" style="width:98.5%" data-rules="{required:true}"/>'
                },{
                    label : '设备厂家：',
                    redStarFlag : true,
                    itemColspan : 1,
        ...
        ATTRS : {
            id : {value : 'irontowerEditDialog'},
            elAttrs : {value: {id:"irontowerPointEdit"}},
            title:{value:'编辑铁塔-04'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('irontowerEditForm'),delData=_self.get('delData');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/wirelessAction/updateDocIrontower");
                    xhr.send(formData);
