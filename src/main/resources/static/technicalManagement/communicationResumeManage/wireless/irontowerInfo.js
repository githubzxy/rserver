 ...
 * 详情模块
 */
define('kmms/technicalManagement/communicationResumeManage/wireless/irontowerInfo',['bui/common',
		            ...
		            var childs = [
		            	{
		                    ...
		                    item : 
							       ...
							       '</th>'+
							       '<td style="width:30%">'+
								   '<input type="text" id="site_station_line" name="site_station_line"  style="width:98%;" />'+
								   '</td>'+
								   '</tr>'+
								   '<tr class="thTdPadding">'+
							       ...
							       '</th>'+
							       '<td style="width:30%">'+
								   '<input type="text" id="site_station_name" name="site_station_name"  style="width:98%;" />'+
								   '</td>'+
								   '</tr>'+
								   '<tr class="thTdPadding">'+
							       ...
							       '</th>'+
							       '<td style="width:30%">'+
								   '<input type="text" id="site_station_place" name="site_station_place"  style="width:98%;" />'+
								   '</td>'+
							       '</tr>'+
							       '<tr class="thTdPadding">'+
							       '<th rowspan="3">区间</th>'+
							       ...
							       '</th>'+
							       '<td style="width:30%">'+
								   '<input type="text" id="site_range_line" name="site_range_line"  style="width:98%;" />'+
								   '</td>'+
								   '</tr>'+
                                   '<tr class="thTdPadding">'+
							       ...
							       '</th>'+
							       '<td style="width:30%">'+
								   '<input type="text" id="site_other_line" name="site_other_line"  style="width:98%;" />'+
								   '</td>'+
								   '</tr>'+
								   '<tr class="thTdPadding">'+
								   '<th style="width:20%" >安装地点：'+
							       '</th>'+
							       '<td style="width:30%">'+
								   '<input type="text" id="site_other_place" name="site_other_place"  style="width:98%;" />'+
								   '</td>'+
								   '</tr>'+
							...
							label : '中修日期：',
							itemColspan : 1,
							item : '<input type="text" name="middleRepairDate" id="middleRepairDate" style="width:99%" readOnly/>'
						},{
							label : '大修日期：',
							itemColspan : 1,
							item : '<input type="text" name="largeRepairDate" id="largeRepairDate" style="width:99%" readOnly/>'
						},{
		                    label : '设备运行状态：',
		                    itemColspan : 1,
