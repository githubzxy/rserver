 ...
 * @date 18-11-26
 */
define('kmms/workPlanMangement/workPlan/WorkPlanPage',[
	'bui/common','bui/data','bui/grid',
    'common/grid/SearchGridContainer',
    'bui/calendar',
    'common/org/OrganizationPicker',
    'common/data/PostLoad',
    'kmms/workPlanMangement/workPlan/WorkPlanAdd',
    'kmms/workPlanMangement/workPlan/WorkPlanEdit',
    'kmms/workPlanMangement/workPlan/WorkPlanAuditStatus',
    'kmms/workPlanMangement/workPlan/WorkPlanInfo'
    ],function (r) {
    var BUI = r('bui/common'),
    	...
    	WorkPlanAdd = r('kmms/workPlanMangement/workPlan/WorkPlanAdd'),
    	WorkPlanEdit = r('kmms/workPlanMangement/workPlan/WorkPlanEdit'),
    	WorkPlanInfo = r('kmms/workPlanMangement/workPlan/WorkPlanInfo'),
    	WorkPlanAuditStatus = r('kmms/workPlanMangement/workPlan/WorkPlanAuditStatus'),
        SearchGridContainer = r('common/grid/SearchGridContainer');

    var SecurityRiskPointPage = BUI.Component.Controller.extend(
        {
            ...
            bindUI:function(){
                ...
                $(".auditBtn").on('click',function () {
            	   ...
            	   var auditDialog = new WorkPlanAuditStatus({
                ...
                table.on('cellclick',function(ev){
                    ...
                    if(target.hasClass('infoBtn')){
                        var infoDialog = new WorkPlanInfo({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                            shiftId:docId
                        });
                    ...
                    if(target.hasClass('editBtn')){
                        var editDialog = new WorkPlanEdit({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                            shiftId:docId
                        });
...
//                    autoLoad : true ,
        ...
        },
        {
            ATTRS : {
                 ...
                 * 存储表名(施工计划表名)
                 */
                collectionName : {value:'workPlan'}
            }
        });
    return SecurityRiskPointPage;
});