 ...
 * @date 18-11-23
 */
define('kmms/workPlanMangement/workPlan/WorkPlanEdit',[
...
//                elStyle:{overflowY:'scroll',height:'400px'}
        ...
        ATTRS : {
            id : {value : 'workPlanEditDialog'},
            elAttrs : {value: {id:"workPlanEdit"}},
            title:{value:'编辑'},
            width:{value:610},
            height:{value:240},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('workPlanEditForm'),delData=_self.get('delData');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
