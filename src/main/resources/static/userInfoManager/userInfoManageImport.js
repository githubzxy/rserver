 ...
 * 导入施工维修信息表单
 */
define('kmms/userInfoManager/userInfoManageImport',[
										'bui/overlay',
										'bui/mask',
	...
	var userInfoManageImport = Overlay.Dialog.extend({
		//初始化弹框控件
...
//        		}
		...
		ATTRS : {//定义弹框属性
			elAttrs : {value: {id:"UserInfoManageImportDlog"}},
			title : {value : '导入人员信息表'},
			width : {value : 617},
//			collectionName:{},
			height : {value : 170},
			...
			success : {
				value : function(){
					...
					var importForm=_self.getChild('UserInfoManageImport',true);
					if(!importForm.isValid()){
	                    ...
	                    xhr.open("POST", "/kmms/userInfoManageAction/Import");
	                    xhr.send(formData);
