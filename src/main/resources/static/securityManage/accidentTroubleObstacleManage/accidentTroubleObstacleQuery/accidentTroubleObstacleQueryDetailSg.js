 ...
 * @date 19-2-27
 */
define('kmms/securityManage/accidentTroubleObstacleManage/accidentTroubleObstacleQuery/accidentTroubleObstacleQueryDetailSg',
		[
		 	'bui/common',
	...
	var AccidentTroubleObstacleQueryDetailSg = BUI.Overlay.Dialog.extend({
...
//                }
			...
			var form = new FormContainer({
				id : 'accidentTroubleObstacleQueryDetailSgShow',
				colNum : colNum,
		...
		ATTRS : {
			id : {value : 'accidentTroubleObstacleQueryDetailSgDialog'},
...
//            downloadUrl:{value:'/kmms/commonAction/download?path='},
	...
	return AccidentTroubleObstacleQueryDetailSg;
});