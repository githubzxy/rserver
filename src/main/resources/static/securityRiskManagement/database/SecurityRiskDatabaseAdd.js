 ...
 * @date 18-11-23
 */
define('kmms/securityRiskManagement/database/SecurityRiskDatabaseAdd',['bui/common',
    ...
    var SecurityRiskDatabaseAdd = BUI.Overlay.Dialog.extend({
        ...
        _initFormContainer : function(){
            ...
            var form = new FormContainer({
                id : 'securityRiskDatabaseAddForm',
                colNum : colNum,
...
//                elStyle:{overflowY:'scroll',height:'400px'}
        ...
        ATTRS : {
            id : {value : 'securityRiskDatabaseAddDialog'},
            elAttrs : {value: {id:"securityRiskDatabaseAdd"}},
            title:{value:'新增'},
            width:{value:610},
            height:{value:240},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('securityRiskDatabaseAddForm');
	        		//验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
    ...
    return SecurityRiskDatabaseAdd;
});