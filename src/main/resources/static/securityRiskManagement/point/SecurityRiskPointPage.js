 ...
 * @date 18-11-22
 */
define('kmms/securityRiskManagement/point/SecurityRiskPointPage',[
	'bui/common','bui/data','bui/grid',
    'common/grid/SearchGridContainer',
    'bui/calendar',
    'common/org/OrganizationPicker',
    'common/data/PostLoad',
    'kmms/securityRiskManagement/point/SecurityRiskPointAdd',
    'kmms/securityRiskManagement/point/SecurityRiskPointEdit',
    'kmms/securityRiskManagement/point/SecurityRiskPointInfo'
    ],function (r) {
    var BUI = r('bui/common'),
	    ...
	    SecurityRiskPointAdd = r('kmms/securityRiskManagement/point/SecurityRiskPointAdd'),
	    SecurityRiskPointEdit = r('kmms/securityRiskManagement/point/SecurityRiskPointEdit'),
	    SecurityRiskPointInfo = r('kmms/securityRiskManagement/point/SecurityRiskPointInfo'),
    ...
    var SecurityRiskPointPage = BUI.Component.Controller.extend(
        {
            ...
            bindUI:function(){
                ...
                $('.addBtn').on('click',function(e){
                    var addDialog = new SecurityRiskPointAdd({
                ...
                table.on('cellclick',function(ev){
                    ...
                    if(target.hasClass('infoBtn')){
                        var infoDialog = new SecurityRiskPointInfo({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                            shiftId:docId
                        });
                    ...
                    if(target.hasClass('editBtn')){
                        var editDialog = new SecurityRiskPointEdit({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                            shiftId:docId
                        });
        ...
        },
        {
            ATTRS : {
                 ...
                 * 存储表名(安全风险项点表名)
                 */
                collectionName : {value:'securityRiskPoint'}
            }
        });
