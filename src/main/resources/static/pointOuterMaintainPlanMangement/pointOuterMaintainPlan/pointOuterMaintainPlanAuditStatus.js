 ...
 * 审核状态模块
 */
define('kmms/pointOuterMaintainPlanMangement/pointOuterMaintainPlan/pointOuterMaintainPlanAuditStatus',[
	...
	var PointOuterMaintainPlanInfo = BUI.Overlay.Dialog.extend({
		...
		_initFormContainer : function(){
			...
			var form = new FormContainer({
				id : 'pointOuterMaintainPlanInfoShow',
				colNum : colNum,
...
//                elStyle:{overflowY:'scroll',height:'400px'}
		...
		ATTRS : {
			id : {value : 'pointOuterMaintainPlanAuditStatusDialog'},
	...
	return PointOuterMaintainPlanInfo;
});