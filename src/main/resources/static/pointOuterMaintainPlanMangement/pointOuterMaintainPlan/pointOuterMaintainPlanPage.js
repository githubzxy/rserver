 ...
 * @date 18-11-26
 */
define('kmms/pointOuterMaintainPlanMangement/pointOuterMaintainPlan/pointOuterMaintainPlanPage',[
	'bui/common','bui/data','bui/grid',
    'common/grid/SearchGridContainer',
    'bui/calendar',
    'common/org/OrganizationPicker',
    'common/data/PostLoad',
    'kmms/pointOuterMaintainPlanMangement/pointOuterMaintainPlan/pointOuterMaintainPlanAdd',
    'kmms/pointOuterMaintainPlanMangement/pointOuterMaintainPlan/pointOuterMaintainPlanEdit',
    'kmms/pointOuterMaintainPlanMangement/pointOuterMaintainPlan/pointOuterMaintainPlanAuditStatus',
    'kmms/pointOuterMaintainPlanMangement/pointOuterMaintainPlan/pointOuterMaintainPlanInfo'
    ],function (r) {
    var BUI = r('bui/common'),
	    ...
	    PointOuterMaintainPlanAdd = r('kmms/pointOuterMaintainPlanMangement/pointOuterMaintainPlan/pointOuterMaintainPlanAdd'),
	    PointOuterMaintainPlanEdit = r('kmms/pointOuterMaintainPlanMangement/pointOuterMaintainPlan/pointOuterMaintainPlanEdit'),
	    PointOuterMaintainPlanInfo = r('kmms/pointOuterMaintainPlanMangement/pointOuterMaintainPlan/pointOuterMaintainPlanInfo'),
	    PointOuterMaintainPlanAuditStatus = r('kmms/pointOuterMaintainPlanMangement/pointOuterMaintainPlan/pointOuterMaintainPlanAuditStatus'),
        SearchGridContainer = r('common/grid/SearchGridContainer');

    var PointOuterMaintainPlanPage = BUI.Component.Controller.extend(
        {
            ...
            bindUI:function(){
                ...
                $(".auditBtn").on('click',function () {
            	   ...
            	   var auditDialog = new PointOuterMaintainPlanAuditStatus({
                ...
                $('.addBtn').on('click',function(e){
                    var addDialog = new PointOuterMaintainPlanAdd({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                ...
                table.on('cellclick',function(ev){
                    ...
                    if(target.hasClass('infoBtn')){
                        var infoDialog = new PointOuterMaintainPlanInfo({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                            shiftId:docId
                        });
                    ...
                    if(target.hasClass('editBtn')){
                        var editDialog = new PointOuterMaintainPlanEdit({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                            shiftId:docId
                        });
...
//                    autoLoad : true ,
        ...
        },
        {
            ATTRS : {
                 ...
                 * 存储表名
                 */
                collectionName : {value:'pointOuterMaintainPlan'}
            }
        });
    return PointOuterMaintainPlanPage;
});