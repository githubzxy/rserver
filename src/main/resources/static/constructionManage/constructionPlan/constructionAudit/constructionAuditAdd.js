 ...
 * @date 19-2-21
 */
define('kmms/constructionManage/constructionPlan/constructionAudit/constructionAuditAdd',
	[
	 	'bui/common',
	 	'bui/form',
	 	'bui/calendar',
    ...
    var ConstructionAuditAdd = BUI.Overlay.Dialog.extend({
...
//                elStyle:{overflowY:'scroll',height:'400px'}
        ...
        ATTRS : {
            id : {value : 'constructionAuditAddDialog'},
            elAttrs : {value: {id:"constructionAuditAdd"}},
            title:{value:'审核'},
            width:{value:500},
            height:{value:300},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('constructionAuditAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
...
//                    formData.append('orgName',_self.get('orgName'));
                    ...
                    xhr.open("POST", "/zuul/kmms/constructAuditAction/updateDoc");
                    xhr.send(formData);
