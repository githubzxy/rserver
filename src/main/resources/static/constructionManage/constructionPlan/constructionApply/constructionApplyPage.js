 ...
 * @date 19-2-20
 */
define('kmms/constructionManage/constructionPlan/constructionApply/constructionApplyPage',[
	'bui/common','bui/data','bui/grid',
    'common/grid/SearchGridContainer',
    'bui/calendar',
    'common/org/OrganizationPicker',
    'common/data/PostLoad',
    'kmms/constructionManage/constructionPlan/constructionApply/constructionApplyAdd',
    'kmms/constructionManage/constructionPlan/constructionApply/constructionApplyEdit',
    'kmms/constructionManage/constructionPlan/constructionApply/constructionApplyInfo',
    ],function (r) {
    var BUI = r('bui/common'),
        ...
        ConstructionApplyAdd = r('kmms/constructionManage/constructionPlan/constructionApply/constructionApplyAdd'),
        ConstructionApplyEdit = r('kmms/constructionManage/constructionPlan/constructionApply/constructionApplyEdit'),
        ConstructionApplyInfo = r('kmms/constructionManage/constructionPlan/constructionApply/constructionApplyInfo'),
        SearchGridContainer = r('common/grid/SearchGridContainer');

    var ConstructionPlan = BUI.Component.Controller.extend(
        {
...
//    			});
                ...
                $('.addBtn').on('click',function(e){
                    var addDialog = new ConstructionApplyAdd({
                ...
                table.on('cellclick',function(ev){
                    ...
                    if(target.hasClass('infoBtn')){
                        var infoDialog = new ConstructionApplyInfo({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                            shiftId:docId
                        });
                    ...
                    if(target.hasClass('editBtn')){
                        var editDialog = new ConstructionApplyEdit({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                            userName:_self.get('userName'),
                            orgId:_self.get('orgId'),
            ...
            _initStore:function () {
                ...
                var store = new Data.Store({
                    url : "/kmms/constructApplyAction/findByUserId.cn",
                    autoLoad : true ,
                    pageSize : 10,
                    proxy : {
                        method : 'post',
