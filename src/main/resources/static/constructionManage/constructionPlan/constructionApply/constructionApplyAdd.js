 ...
 * @date 19-2-20
 */
define('kmms/constructionManage/constructionPlan/constructionApply/constructionApplyAdd',['bui/common','common/form/FormContainer',
    'bui/form','common/uploader/UpdateUploader','common/data/PostLoad',],function(r){
    var BUI = r('bui/common'),
        FormContainer= r('common/form/FormContainer'),
        PostLoad = r('common/data/PostLoad'),
        UpdateUploader = r('common/uploader/UpdateUploader');
    var ConstructionApplyAdd = BUI.Overlay.Dialog.extend({
        ...
        renderUI : function(){
        	var _self=this;
        	_self._initUploader();
        	 $('#formContainer #depart').val(_self.get('userName'));
        },
        bindUI : function(){
            var _self = this;
            //定义按键
...
//                        'value="uploadfile">'
                    ...
                    redStarFlag : true,
                    itemColspan : 2,
                    item : '<input type="text" name="depart" id="depart"  readonly />'
                },{
                    label : '附件：',
                    itemColspan : 2,
...
//                elStyle:{overflowY:'scroll',height:'400px'}
        ...
        ATTRS : {
            id : {value : 'constructionApplyAddDialog'},
            elAttrs : {value: {id:"constructionApplyAdd"}},
            title:{value:'新增'},
            width:{value:610},
            height:{value:265},
            contextPath : {},
            ...
            successApply:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('constructionApplyAddForm');
                    //获取上传文件
                    ...
                    xhr.open("POST", "/zuul/kmms/constructApplyAction/addDoc");
                    xhr.send(formData);
...
//                    }
	        		var pl = new PostLoad({
        				url : '/zuul/kmms/constructApplyAction/addDoc',
        				el : _self.get('el'),
        				loadMsg : '上传中...'
        			}); 
