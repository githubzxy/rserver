 ...
 * 施工方案查询详情模块
 */
define('kmms/constructionManage/constructionPlan/constructionQuery/constructionQueryInfo',['bui/common','common/form/FormContainer',
	'common/uploader/ViewUploader','common/data/PostLoad'],function(r){
	var BUI = r('bui/common'),
		ViewUploader = r('common/uploader/ViewUploader'),
		FormContainer= r('common/form/FormContainer');
	var ConstructionQueryInfo = BUI.Overlay.Dialog.extend({
...
//                elStyle:{overflowY:'scroll',height:'400px'}
		...
		ATTRS : {
			id : {value : 'constructionQueryInfoDialog'},
			title:{value:'详情'},
			width:{value:610},
            height:{value:450},
