 ...
 * @date 19-1-22
 */
define('kmms/constructionManage/pointInnerMaintainPlan/skylightMaintenanceSkillAuditAdd',
	[
	 	'bui/common',
	 	'bui/form',
	 	'bui/calendar',
    ...
    var SkylightMaintenanceSkillAuditAdd = BUI.Overlay.Dialog.extend({
...
//		    $('#formContainer #backOrgId').val(_self.get('rootOrgId'));
        ...
        _initSelect: function(){
			...
			$("#formContainer #skillAuditResult").append("<option  value='1'>审核通过</option>");
...
//                	redStarFlag : true,
                	itemColspan : 2,
                	item : '<textarea name="skillAuditRemark" id="skillAuditRemark" style="width:99.5%;height:165px" /></textarea>'
                }
            ];
            var form = new FormContainer({
                id : 'skylightMaintenanceSkillAuditAddForm',
                colNum : colNum,
...
//                elStyle:{overflowY:'scroll',height:'400px'}
        ...
        ATTRS : {
            id : {value : 'skylightMaintenanceSkillAuditAddDialog'},
            elAttrs : {value: {id:"skylightMaintenanceSkillAuditAdd"}},
            title:{value:'审核'},
            width:{value:620},
            height:{value:320},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('skylightMaintenanceSkillAuditAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/skylightMaintenanceSkillAuditAction/updateDoc");
                    xhr.send(formData);
    ...
    return SkylightMaintenanceSkillAuditAdd;
});