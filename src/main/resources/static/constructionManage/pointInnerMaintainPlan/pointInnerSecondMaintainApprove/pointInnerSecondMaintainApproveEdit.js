 ...
 * @date 19-5-7
 */
define('kmms/constructionManage/pointInnerMaintainPlan/pointInnerSecondMaintainApprove/pointInnerSecondMaintainApproveEdit',
	[
	 	'bui/common',
	 	'bui/form',
		'bui/calendar',
    ...
    var PointInnerSecondMaintainApplyEdit = BUI.Overlay.Dialog.extend({
...
//        },
        ...
        _initFormContainer : function(){
            ...
            var form = new FormContainer({
                id : 'pointInnerSecondMaintainApplyEditForm',
                colNum : colNum,
...
//                elStyle:{overflowY:'scroll',height:'400px'}
        ...
        ATTRS : {
            id:{value : 'pointInnerSecondMaintainApplyEditDialog'},
            elAttrs:{value: {id:"pointInnerSecondMaintainApplyEdit"}},
            title:{value:'修改'},
            width:{value:600},
            height:{value:270},
            ...
            apply:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('pointInnerSecondMaintainApplyEditForm');
                    //获取上传文件
    ...
    return PointInnerSecondMaintainApplyEdit;
});