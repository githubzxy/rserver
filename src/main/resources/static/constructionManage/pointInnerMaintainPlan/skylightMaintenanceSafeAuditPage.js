 ...
 * @date 19-1-22
 */
define('kmms/constructionManage/pointInnerMaintainPlan/skylightMaintenanceSafeAuditPage',
	[
	 	'bui/common',
	 	'bui/data',
	 	'bui/grid',
	 	...
	 	'kmms/constructionManage/pointInnerMaintainPlan/skylightMaintenanceSafeAuditAdd',
    ...
    var BUI = r('bui/common'),
    	...
    	skylightMaintenanceSafeAuditAdd = r('kmms/constructionManage/pointInnerMaintainPlan/skylightMaintenanceSafeAuditAdd'),
    ...
    var SkylightMaintenanceSafeAuditPage = BUI.Component.Controller.extend(
        {
...
//    				$("#selectType").val("");
                ...
                table.on('cellclick',function(ev){
                    ...
                    if(target.hasClass('auditBtn')){
                        var editDialog = new skylightMaintenanceSafeAuditAdd({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
            ...
            _initStore:function () {
                ...
                var store = new Data.Store({
                    url : "/kmms/skylightMaintenanceSafeAuditAction/findAll.cn",
                    autoLoad : true ,
                    pageSize : 20,
                    proxy : {
                        method : 'post',
...
//                    permissionStore : _self._initPermissionStore()
    ...
    return SkylightMaintenanceSafeAuditPage;
});