 ...
 * @date 19-1-22
 */
define('kmms/constructionManage/pointInnerMaintainPlan/skylightMaintenanceApprovePage',
	[
	 	'bui/common',
	 	'bui/data',
	 	'bui/grid',
	 	...
	 	'kmms/constructionManage/pointInnerMaintainPlan/skylightMaintenanceApproveAdd',
    ...
    var BUI = r('bui/common'),
    	...
    	skylightMaintenanceApproveAdd = r('kmms/constructionManage/pointInnerMaintainPlan/skylightMaintenanceApproveAdd'),
    	skylightMaintenanceApplyDetail = r('kmms/constructionManage/pointInnerMaintainPlan/skylightMaintenanceApplyDetail');
    var SkylightMaintenanceApprovePage = BUI.Component.Controller.extend(
        {
...
//    				$("#selectType").val("");
                ...
                table.on('cellclick',function(ev){
                    ...
                    if(target.hasClass('auditBtn')){
                        var editDialog = new skylightMaintenanceApproveAdd({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
...
//        	  			}
                ...
                var columns = [
                	{
                        ...
                        renderer:function (value) {
                        	var button = '';
                        	if(value=='5'){
                        		button += '<span  class="grid-command auditBtn">审批</span>';
                        	} 
            ...
            _initStore:function () {
                ...
                var store = new Data.Store({
                    url : "/kmms/skylightMaintenanceApproveAction/findAll.cn",
                    autoLoad : true ,
                    pageSize : 20,
                    proxy : {
                        method : 'post',
...
//                    permissionStore : _self._initPermissionStore()
    ...
    return SkylightMaintenanceApprovePage;
});