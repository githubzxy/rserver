 ...
 * @date 19-1-22
 */
define('kmms/constructionManage/pointInnerMaintainPlan/communicationNetwork/communicationNetworkDispatchAuditPage',
	[
	 	'bui/common',
	 	'bui/data',
	 	'bui/grid',
	 	...
	 	'kmms/constructionManage/pointInnerMaintainPlan/communicationNetwork/communicationNetworkDispatchAuditAdd',
    ...
    var BUI = r('bui/common'),
    	...
    	communicationNetworkDispatchAuditAdd = r('kmms/constructionManage/pointInnerMaintainPlan/communicationNetwork/communicationNetworkDispatchAuditAdd'),
    ...
    var communicationNetworkDispatchAuditPage = BUI.Component.Controller.extend(
        {
...
//    				$("#selectType").val("");
                ...
                table.on('cellclick',function(ev){
                    ...
                    if(target.hasClass('auditBtn')){
                        var editDialog = new communicationNetworkDispatchAuditAdd({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
            ...
            _initStore:function () {
                ...
                var store = new Data.Store({
                    url : "/kmms/communicationNetworkDispatchAuditAction/findAll.cn",
                    autoLoad : true ,
                    pageSize : 20,
                    proxy : {
                        method : 'post',
...
//                    permissionStore : _self._initPermissionStore()
    ...
    return communicationNetworkDispatchAuditPage;
});