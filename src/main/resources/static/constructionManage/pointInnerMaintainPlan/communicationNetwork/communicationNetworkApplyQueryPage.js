    ...
    var communicationNetworkApplyQueryPage = BUI.Component.Controller.extend(
        {
            ...
            renderUI:function(){
                ...
                _self._initDate();
                _self._initOrganizationPicker();//                _self._initOrganizationPicker();
            },
            bindUI:function(){
