 ...
 * @date 19-1-22
 */
define('kmms/constructionManage/pointInnerMaintainPlan/communicationNetwork/communicationNetworkSafeAuditPage',
	[
	 	'bui/common',
	 	'bui/data',
	 	'bui/grid',
	 	...
	 	'kmms/constructionManage/pointInnerMaintainPlan/communicationNetwork/communicationNetworkSafeAuditAdd',
    ...
    var BUI = r('bui/common'),
    	...
    	communicationNetworkSafeAuditAdd = r('kmms/constructionManage/pointInnerMaintainPlan/communicationNetwork/communicationNetworkSafeAuditAdd'),
    ...
    var communicationNetworkSafeAuditPage = BUI.Component.Controller.extend(
        {
...
//    				$("#selectType").val("");
                ...
                table.on('cellclick',function(ev){
                    ...
                    if(target.hasClass('auditBtn')){
                        var editDialog = new communicationNetworkSafeAuditAdd({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
            ...
            _initStore:function () {
                ...
                var store = new Data.Store({
                    url : "/kmms/communicationNetworkSafeAuditAction/findAll.cn",
                    autoLoad : true ,
                    pageSize : 20,
                    proxy : {
                        method : 'post',
...
//                    permissionStore : _self._initPermissionStore()
    ...
    return communicationNetworkSafeAuditPage;
});