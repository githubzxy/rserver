 ...
 * @date 19-1-21
 */
define('kmms/constructionManage/pointInnerMaintainPlan/communicationNetwork/communicationNetworkApplyPage',
	[
	 	'bui/common',
	 	'bui/data',
	 	'bui/grid',
	 	...
	 	'kmms/constructionManage/pointInnerMaintainPlan/communicationNetwork/communicationNetworkApplyAdd',
	 	'kmms/constructionManage/pointInnerMaintainPlan/communicationNetwork/communicationNetworkApplyEdit',
	 	'kmms/constructionManage/pointInnerMaintainPlan/communicationNetwork/communicationNetworkApplyDetail',
	 	'kmms/constructionManage/pointInnerMaintainPlan/communicationNetwork/communicationNetworkRestApplyEdit',
	 	'kmms/constructionManage/pointInnerMaintainPlan/communicationNetwork/communicationNetworkApplyExecute'
	],function (r) {
    var BUI = r('bui/common'),
    	...
    	communicationNetworkApplyAdd = r('kmms/constructionManage/pointInnerMaintainPlan/communicationNetwork/communicationNetworkApplyAdd'),
    	communicationNetworkApplyEdit = r('kmms/constructionManage/pointInnerMaintainPlan/communicationNetwork/communicationNetworkApplyEdit'),
    	...
    	communicationNetworkRestApplyEdit = r('kmms/constructionManage/pointInnerMaintainPlan/communicationNetwork/communicationNetworkRestApplyEdit'),
    	communicationNetworkApplyExecute = r('kmms/constructionManage/pointInnerMaintainPlan/communicationNetwork/communicationNetworkApplyExecute');
    var communicationNetworkApplyPage = BUI.Component.Controller.extend(
        {
...
//    				$("#selectType").val("");
                   ...
                   if(!id){
                	   ...
                	   BUI.Message.Confirm('确认要删除吗？',function(){
	                       var postLoad = new PostLoad({
	                           url : '/kmms/communicationNetworkApplyAction/removeDoc.cn',
	                           el : _self.get('el'),
	                           loadMsg : '删除中...'
	                       });
                ...
                $('.addBtn').on('click',function(e){
                    var addDialog = new communicationNetworkApplyAdd({
                ...
                table.on('cellclick',function(ev){
                    ...
                    if(target.hasClass('editBtn')){
                        var editDialog = new communicationNetworkApplyEdit({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                            shiftId:docId
                        });
                    ...
                    if(target.hasClass('editAuditBtn')){
                    	var editDialog = new communicationNetworkRestApplyEdit({
                    		collectionName:_self.get('collectionName'),
                    		userId:_self.get('userId'),
                    		shiftId:docId
                    	});
                    ...
                    if(target.hasClass('executeBtn')){
                    	var editDialog = new communicationNetworkApplyExecute({
                    		collectionName:_self.get('collectionName'),
                    		userId:_self.get('userId'),
                    		shiftId:docId
                    	});
                    ...
                    if(target.hasClass('exportBtn')){
              		  var postLoad = new PostLoad({
            				url : '/kmms/communicationNetworkApplyAction/exportApplyFrom.cn',
            				ajaxOptions : {
            ...
            _initStore:function () {
                ...
                var store = new Data.Store({
                    url : "/kmms/communicationNetworkApplyAction/findAll.cn",
                    autoLoad : true ,
                    pageSize : 20,
                    proxy : {
                        method : 'post',
...
//                    permissionStore : _self._initPermissionStore()
    ...
    return communicationNetworkApplyPage;
});