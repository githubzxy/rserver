 ...
 * @date 
 */
define('kmms/constructionManage/pointInnerMaintainPlan/communicationNetwork/communicationNetworkApplyAdd',
	[
	 	'bui/common',
	 	'bui/form',
	 	'bui/calendar',
    ...
    var communicationNetworkApplyAdd = BUI.Overlay.Dialog.extend({
...
//        },
        ...
        _initFormContainer : function(){
            ...
            var childs = [
            	{
                    ...
                    label : '类型：',
                    itemColspan : 2,
                    item : '<input type="text" name="type" id="type" value="跨局通信网" style="width:99.5%" readOnly/>'
                },{
					label: '附件：',
					itemColspan: 2,
            ...
            var form = new FormContainer({
                id : 'communicationNetworkApplyAddForm',
                colNum : colNum,
        ...
        ATTRS : {
            ...
            successApply:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('communicationNetworkApplyAddForm');
                    //获取上传文件
	        		...
	        		data.flowState="1";
	        		 ...
	        		 var pl = new PostLoad({
	        				url : '/zuul/kmms/communicationNetworkApplyAction/addDoc',
	        				el : _self.get('el'),
	        				loadMsg : '上传中...'
	        			}); 
...
//                    xhr.open("POST", "/zuul/kmms/communicationNetworkApplyAction/addDoc");
//                    xhr.send(formData);
...
//                    }
    ...
    return communicationNetworkApplyAdd;
});