 ...
 * @date 18-11-21
 */
define('kmms/dayToJobManagement/inspectionSuperiors/inspectionSuperiorsEdit',['bui/common','common/form/FormContainer',
   'bui/form',],function(r){
    var BUI = r('bui/common'),
        FormContainer= r('common/form/FormContainer');
    var inspectionSuperiorsEdit = BUI.Overlay.Dialog.extend({
        ...
        _getShowData : function(){
            ...
            $.ajax({
                url:'/kmms/inspectionSuperiorsAction/findById',
        ...
        ATTRS : {
            ...
            success:{
                value : function(){
                    ...
                    xhr.open("POST", "/kmms/inspectionSuperiorsAction/updateDoc");
                    xhr.send(formData);
    ...
    return inspectionSuperiorsEdit;
});