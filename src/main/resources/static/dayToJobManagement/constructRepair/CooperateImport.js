 ...
 * 导入施工配合信息表单
 */
define('kmms/dayToJobManagement/constructRepair/CooperateImport',[
										'bui/overlay',
										'bui/uploader',
										'bui/mask',
	...
	var CooperateImport = Overlay.Dialog.extend({
		//初始化弹框控件
			...
			success : {
				value : function(){
					...
					if(_self.fileValidate($('#importFile'))){
						// 设置Ation,提交路径
						$('#formContainer').attr('action','/kmms/constructRepairAction/phImport');
						// 设置method,提交方式
