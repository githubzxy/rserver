 ...
 * @date 19-1-18
 */
define('kmms/dayToJobManagement/remainInfo/remainTroubleEdit',
	[
	 	'bui/common',
	 	'bui/form',
	 	'bui/calendar',
    ...
    var RemainTroubleEdit = BUI.Overlay.Dialog.extend({
...
//                }
        ...
        ATTRS : {
            id : {value : 'remainTroubleEditDialog'},
            elAttrs : {value: {id:"remainTroubleEdit"}},
            title:{value:'修改故障情况'},
            width:{value:750},
            height:{value:540},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('remainTroubleEditForm');
                    //获取上传文件
                    ...
                    xhr.open("POST", "/zuul/kmms/remainInfoAction/updateTroubleDoc");
                    xhr.send(formData);
