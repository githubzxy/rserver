 ...
 * @date 19-3-24
 */
define('kmms/dayToJobManagement/remainInfo/remainInfoDetailYh',
		[
		 	'bui/common',
	...
	var RemainInfoDetailYh = BUI.Overlay.Dialog.extend({
		...
		_initSelect: function(){
			...
			$("#formContainer #lost").append("<option  value='0'>否</otion>");
...
//    				item: '<div name="viewUploadfile" id="viewUploadfile" style="height:100px;overflow-y:auto"></div>'
		...
		ATTRS : {
			id : {value : 'remainInfoDetailYhDialog'},
			title:{value:'详情'},
            width:{value:620},
            height:{value:540},
