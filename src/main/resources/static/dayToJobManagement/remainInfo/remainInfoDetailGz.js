 ...
 * @date 19-1-18
 */
define('kmms/dayToJobManagement/remainInfo/remainInfoDetailGz',
		[
		 	'bui/common',
	...
	var RemainInfoDetailGz = BUI.Overlay.Dialog.extend({
...
//                }
		...
		ATTRS : {
			id : {value : 'rremainInfoDetailGzDialog'},
			title:{value:'详情'},
            width:{value:620},
            height:{value:540},
