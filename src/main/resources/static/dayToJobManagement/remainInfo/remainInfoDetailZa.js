 ...
 * @date 19-1-18
 */
define('kmms/dayToJobManagement/remainInfo/remainInfoDetailZa',
		[
		 	'bui/common',
	...
	var RemainInfoDetailZa = BUI.Overlay.Dialog.extend({
...
//                }
		...
		ATTRS : {
			id : {value : 'remainInfoDetailZaDialog'},
			title:{value:'详情'},
            width:{value:620},
            height:{value:540},
