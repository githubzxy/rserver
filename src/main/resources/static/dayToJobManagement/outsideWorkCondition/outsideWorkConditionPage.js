 ...
 * @date 18-11-21
 */
define('kmms/dayToJobManagement/outsideWorkCondition/outsideWorkConditionPage',['bui/common','bui/data','bui/grid',
    'common/grid/SearchGridContainer','kmms/dayToJobManagement/outsideWorkCondition/outsideWorkConditionAdd','bui/calendar',
    'kmms/dayToJobManagement/outsideWorkCondition/outsideWorkConditionEdit','kmms/dayToJobManagement/outsideWorkCondition/outsideWorkConditionInfo','common/data/PostLoad'],function (r) {
    var BUI = r('bui/common'),
        Data = r('bui/data'),
        Grid = r('bui/grid'),
        Calendar = r('bui/calendar'),
        PostLoad = r('common/data/PostLoad'),
        outsideWorkConditionAdd = r('kmms/dayToJobManagement/outsideWorkCondition/outsideWorkConditionAdd'),
        outsideWorkConditionEdit = r('kmms/dayToJobManagement/outsideWorkCondition/outsideWorkConditionEdit'),
        outsideWorkConditionInfo = r('kmms/dayToJobManagement/outsideWorkCondition/outsideWorkConditionInfo'),
        SearchGridContainer = r('common/grid/SearchGridContainer');

    var outsideWorkConditionPage = BUI.Component.Controller.extend(
        {
...
//	                           url : '/kmms/outsideWorkConditionAction/removeDoc.cn',
//	                           el : _self.get('el'),
//	                           loadMsg : '删除中...'
//	                       });
...
//                });
                ...
                $('.addBtn').on('click',function(e){
                    var addDialog = new outsideWorkConditionAdd({
                ...
                table.on('cellclick',function(ev){
                    ...
                    if(target.hasClass('infoBtn')){
                        var infoDialog = new outsideWorkConditionInfo({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                            shiftId:docId
                        });
          	  ...
          	  if(target.hasClass('delBtn')){
                    ...
                    if(target.hasClass('editBtn')){
                        var editDialog = new outsideWorkConditionEdit({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                            shiftId:docId
                        });
            ...
            _initSearchForm:function(){
                return {
                    items : [
                        ...
                        {label : '点外作业情况',item : '<input type="text" name="noticeContent" id="noticeContent" style="width: 175px;"  />'}
...
//                        	}
            ...
            _initStore:function () {
                ...
                var store = new Data.Store({
                    url : "/kmms/outsideWorkConditionAction/findAll.cn",
                    autoLoad : true ,
                    pageSize : 10,
                    proxy : {
                        method : 'post',
...
//                        }
        ...
        },
        {
            ATTRS : {
                 ...
                 * 存储表名
                 */
                collectionName : {value:'outsideWorkCondition'}
            }
        });
    return outsideWorkConditionPage;
});