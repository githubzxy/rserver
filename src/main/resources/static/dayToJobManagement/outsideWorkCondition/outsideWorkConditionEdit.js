 ...
 * @date 18-11-21
 */
define('kmms/dayToJobManagement/outsideWorkCondition/outsideWorkConditionEdit',['bui/common','common/form/FormContainer',
   'bui/form',],function(r){
    var BUI = r('bui/common'),
        FormContainer= r('common/form/FormContainer');
    var outsideWorkConditionEdit = BUI.Overlay.Dialog.extend({
        ...
        _getShowData : function(){
            ...
            $.ajax({
                url:'/kmms/outsideWorkConditionAction/findById',
        ...
        ATTRS : {
            ...
            success:{
                value : function(){
                    ...
                    xhr.open("POST", "/kmms/outsideWorkConditionAction/updateDoc");
                    xhr.send(formData);
    ...
    return outsideWorkConditionEdit;
});