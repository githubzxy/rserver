 ...
 * @date 18-11-21
 */
define('kmms/dayToJobManagement/outsideWorkCondition/outsideWorkConditionAdd',['bui/common','common/form/FormContainer',
    'bui/form','bui/calendar','common/data/PostLoad',],function(r){
    var BUI = r('bui/common'),
        Calendar = r('bui/calendar'),
        PostLoad = r('common/data/PostLoad'),
        FormContainer= r('common/form/FormContainer');
    var outsideWorkConditionAdd = BUI.Overlay.Dialog.extend({
        ...
        _initDate: function () {
            ...
            var postLoad = new PostLoad({
                url : '/kmms/outsideWorkConditionAction/getSystemDate',
                el : _self.get('el'),
                loadMsg : '加载中...'
            });
...
//                    formData.append('userId',_self.get('userId'));
                    ...
                    xhr.open("POST", "/kmms/outsideWorkConditionAction/addDoc");
                    xhr.send(formData);
    ...
    return outsideWorkConditionAdd;
});