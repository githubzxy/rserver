 ...
 *点外作业情况详情模块
 */
define('kmms/dayToJobManagement/outsideWorkCondition/outsideWorkConditionInfo',['bui/common','common/form/FormContainer',
	'common/data/PostLoad'],function(r){
	var BUI = r('bui/common'),
		FormContainer= r('common/form/FormContainer');
	var outsideWorkConditionInfo = BUI.Overlay.Dialog.extend({
	...
	return outsideWorkConditionInfo;
});