 ...
 * @date 18-11-21
 */
define('kmms/dayToJobManagement/duanSafetyNotification/duanSafetyNotificationPage',['bui/common','bui/data','bui/grid',
    'common/grid/SearchGridContainer','kmms/dayToJobManagement/duanSafetyNotification/duanSafetyNotificationAdd','bui/calendar',
    'kmms/dayToJobManagement/duanSafetyNotification/duanSafetyNotificationEdit','kmms/dayToJobManagement/duanSafetyNotification/duanSafetyNotificationInfo','common/data/PostLoad'],function (r) {
    var BUI = r('bui/common'),
        Data = r('bui/data'),
        Grid = r('bui/grid'),
        Calendar = r('bui/calendar'),
        PostLoad = r('common/data/PostLoad'),
    	duanSafetyNotificationAdd = r('kmms/dayToJobManagement/duanSafetyNotification/duanSafetyNotificationAdd'),
    	duanSafetyNotificationEdit = r('kmms/dayToJobManagement/duanSafetyNotification/duanSafetyNotificationEdit'),
    	duanSafetyNotificationInfo = r('kmms/dayToJobManagement/duanSafetyNotification/duanSafetyNotificationInfo'),
        SearchGridContainer = r('common/grid/SearchGridContainer');

    var duanSafetyNotificationPage = BUI.Component.Controller.extend(
        {
...
//                });
                ...
                $('.addBtn').on('click',function(e){
                    var addDialog = new duanSafetyNotificationAdd({
                ...
                table.on('cellclick',function(ev){
                    ...
                    if(target.hasClass('infoBtn')){
                        var infoDialog = new duanSafetyNotificationInfo({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                            shiftId:docId
                        });
            	  ...
            	  if(target.hasClass('delBtn')){
                    ...
                    if(target.hasClass('editBtn')){
                        var editDialog = new duanSafetyNotificationEdit({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                            shiftId:docId
                        });
            ...
            _initStore:function () {
                ...
                var store = new Data.Store({
                    url : "/kmms/duanSafetyNotificationAction/findAll.cn",
                    autoLoad : true ,
                    pageSize : 10,
                    proxy : {
                        method : 'post',
...
//                        }
        ...
        },
        {
            ATTRS : {
                 ...
                 * 存储表名
                 */
                collectionName : {value:'duanSafetyNotification'}
            }
        });
    return duanSafetyNotificationPage;
});