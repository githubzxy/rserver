 ...
 * @date 19-1-18
 */
define('kmms/dayToJobManagement/otherProductionInfo/otherProductionInfoDetailGz',
		[
		 	'bui/common',
	...
	var OtherProductionInfoDetailGz = BUI.Overlay.Dialog.extend({
          		...
          		success:function(result){
					...
					if(data){
            		    ...
            		    if(data.troubleUploadFileArr) {
            				_self._initViewUploader(data.troubleUploadFileArr);
            			}
                    }
          		}
			});
...
//					item: '<div name="viewUploadfile" id="viewUploadfile" style="height:100px;overflow-y:auto"></div>'
			...
			var form = new FormContainer({
				id : 'otherProductionInfoDetailGzShow',
				colNum : colNum,
		...
		ATTRS : {
			id : {value : 'otherProductionInfoDetailGzDialog'},
			title:{value:'详情'},
            width:{value:620},
            height:{value:540},
	...
	return OtherProductionInfoDetailGz;
});