 ...
 * @date 19-1-18
 */
define('kmms/dayToJobManagement/otherProductionInfo/otherProductionAccidentEdit',
	[
	 	'bui/common',
	 	'bui/form',
	 	'bui/calendar',
    ...
    var OtherProductionAccidentEdit = BUI.Overlay.Dialog.extend({
...
//                    item : '<select name="accidentDetailLevel" id="accidentDetailLevel" style="width:99.5%" data-rules="{required:true}"/></select>'
            ...
            var form = new FormContainer({
                id : 'otherProductionAccidentEditForm',
                colNum : colNum,
...
//                elStyle:{overflowY:'scroll',height:'400px'}
        ...
        ATTRS : {
            id : {value : 'otherProductionAccidentEditDialog'},
            elAttrs : {value: {id:"otherProductionAccidentEdit"}},
            title:{value:'修改事故情况'},
            width:{value:620},
            height:{value:540},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('otherProductionAccidentEditForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
    ...
    return OtherProductionAccidentEdit;
});