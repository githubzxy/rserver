 ...
 * @date 19-1-18
 */
define('kmms/dayToJobManagement/otherProductionInfo/otherProductionInfoDetailSg',
		[
		 	'bui/common',
	...
	var OtherProductionInfoDetailSg = BUI.Overlay.Dialog.extend({
...
//					item: '<div name="viewUploadfile" id="viewUploadfile" style="height:100px;overflow-y:auto"></div>'
			...
			var form = new FormContainer({
				id : 'otherProductionInfoDetailSgShow',
				colNum : colNum,
		...
		ATTRS : {
			id : {value : 'otherProductionInfoDetailSgDialog'},
			title:{value:'详情'},
            width:{value:620},
            height:{value:540},
	...
	return OtherProductionInfoDetailSg;
});