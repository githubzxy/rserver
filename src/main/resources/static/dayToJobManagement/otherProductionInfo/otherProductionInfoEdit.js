 ...
 * @date 19-1-18
 */
define('kmms/dayToJobManagement/otherProductionInfo/otherProductionInfoEdit',
	[
	 	'bui/common',
	 	'bui/form',
		'bui/calendar',
    ...
    var OtherProductionInfoEdit = BUI.Overlay.Dialog.extend({
...
//                }
            ...
            var form = new FormContainer({
                id : 'otherProductionInfoEditForm',
                colNum : colNum,
...
//                elStyle:{overflowY:'scroll',height:'400px'}
        ...
        ATTRS : {
            id : {value : 'otherProductionInfoEditDialog'},
            elAttrs : {value: {id:"otherProductionInfoEdit"}},
            title:{value:'修改'},
            width:{value:620},
            height:{value:360},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('otherProductionInfoEditForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    formData.append('projectType',"other");//标识该保存的数据是在网管信息模块中使用
                    formData.append('id',_self.get('shiftId'));
                    var xhr = new XMLHttpRequest();
                    xhr.open("POST", "/zuul/kmms/otherProductionInfoAction/updateDoc");
                    xhr.send(formData);
    ...
    return OtherProductionInfoEdit;
});