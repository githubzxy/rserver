 ...
 * @date 19-3-22
 */
define('kmms/dayToJobManagement/otherProductionInfo/otherProductionSecurityEdit',
	[
	 	'bui/common',
	 	'bui/form',
	 	'bui/calendar',
    ...
    var OtherProductionSecurityEdit = BUI.Overlay.Dialog.extend({
...
//                    formData.append('orgName',_self.get('orgName'));
    ...
    return OtherProductionSecurityEdit;
});