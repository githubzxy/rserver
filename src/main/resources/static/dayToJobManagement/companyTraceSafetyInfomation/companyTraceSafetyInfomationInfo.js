 ...
 * 重点工作完成情况详情模块
 */
define('kmms/dayToJobManagement/companyTraceSafetyInfomation/companyTraceSafetyInfomationInfo',['bui/common','common/form/FormContainer',
	'common/data/PostLoad'],function(r){
	var BUI = r('bui/common'),
		FormContainer= r('common/form/FormContainer');
	var companyTraceSafetyInfomationInfo = BUI.Overlay.Dialog.extend({
	...
	return companyTraceSafetyInfomationInfo;
});