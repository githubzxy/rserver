 ...
 * @date 18-11-21
 */
define('kmms/dayToJobManagement/companyTraceSafetyInfomation/companyTraceSafetyInfomationAdd',['bui/common','common/form/FormContainer',
    'bui/form','bui/calendar','common/data/PostLoad',],function(r){
    var BUI = r('bui/common'),
        Calendar = r('bui/calendar'),
        PostLoad = r('common/data/PostLoad'),
        FormContainer= r('common/form/FormContainer');
    var companyTraceSafetyInfomationAdd = BUI.Overlay.Dialog.extend({
        ...
        _initDate: function () {
            ...
            var postLoad = new PostLoad({
                url : '/kmms/companyTraceSafetyInfomationAction/getSystemDate',
                el : _self.get('el'),
                loadMsg : '加载中...'
            });
...
//                    formData.append('userId',_self.get('userId'));
                    ...
                    xhr.open("POST", "/kmms/companyTraceSafetyInfomationAction/addDoc");
                    xhr.send(formData);
    ...
    return companyTraceSafetyInfomationAdd;
});