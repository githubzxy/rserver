 ...
 * @date 18-11-21
 */
define('kmms/dayToJobManagement/companyTraceSafetyInfomation/companyTraceSafetyInfomationPage',['bui/common','bui/data','bui/grid',
    'common/grid/SearchGridContainer','kmms/dayToJobManagement/companyTraceSafetyInfomation/companyTraceSafetyInfomationAdd','bui/calendar',
    'kmms/dayToJobManagement/companyTraceSafetyInfomation/companyTraceSafetyInfomationEdit','kmms/dayToJobManagement/companyTraceSafetyInfomation/companyTraceSafetyInfomationInfo','common/data/PostLoad'],function (r) {
    var BUI = r('bui/common'),
        Data = r('bui/data'),
        Grid = r('bui/grid'),
        Calendar = r('bui/calendar'),
        PostLoad = r('common/data/PostLoad'),
        companyTraceSafetyInfomationAdd = r('kmms/dayToJobManagement/companyTraceSafetyInfomation/companyTraceSafetyInfomationAdd'),
        companyTraceSafetyInfomationEdit = r('kmms/dayToJobManagement/companyTraceSafetyInfomation/companyTraceSafetyInfomationEdit'),
        companyTraceSafetyInfomationInfo = r('kmms/dayToJobManagement/companyTraceSafetyInfomation/companyTraceSafetyInfomationInfo'),
        SearchGridContainer = r('common/grid/SearchGridContainer');

    var companyTraceSafetyInfomationPage = BUI.Component.Controller.extend(
        {
...
//	                           url : '/kmms/companyTraceSafetyInfomationAction/removeDoc.cn',
//	                           el : _self.get('el'),
//	                           loadMsg : '删除中...'
//	                       });
...
//                });
                ...
                $('.addBtn').on('click',function(e){
                    var addDialog = new companyTraceSafetyInfomationAdd({
                ...
                table.on('cellclick',function(ev){
                    ...
                    if(target.hasClass('infoBtn')){
                        var infoDialog = new companyTraceSafetyInfomationInfo({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                            shiftId:docId
                        });
                    ...
                    if(target.hasClass('editBtn')){
                        var editDialog = new companyTraceSafetyInfomationEdit({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                            shiftId:docId
                        });
            ...
            _initSearchForm:function(){
                return {
                    items : [
                        ...
                        {label : '内容及处理情况',item : '<input type="text" name="noticeContent" id="noticeContent" style="width: 175px;"  />'}
                    ]};
            },
            /**
             * 初始化时间查询
...
//                        	}
            ...
            _initStore:function () {
                ...
                var store = new Data.Store({
                    url : "/kmms/companyTraceSafetyInfomationAction/findAll.cn",
                    autoLoad : true ,
                    pageSize : 10,
                    proxy : {
                        method : 'post',
...
//                        }
        ...
        },
        {
            ATTRS : {
                 ...
                 * 存储表名
                 */
                collectionName : {value:'companyTraceSafetyInfomation'}
            }
        });
    return companyTraceSafetyInfomationPage;
});