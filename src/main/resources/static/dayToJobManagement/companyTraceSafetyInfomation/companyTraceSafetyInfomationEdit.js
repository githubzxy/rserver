 ...
 * @date 18-11-21
 */
define('kmms/dayToJobManagement/companyTraceSafetyInfomation/companyTraceSafetyInfomationEdit',['bui/common','common/form/FormContainer',
   'bui/form',],function(r){
    var BUI = r('bui/common'),
        FormContainer= r('common/form/FormContainer');
    var companyTraceSafetyInfomationEdit = BUI.Overlay.Dialog.extend({
        ...
        _getShowData : function(){
            ...
            $.ajax({
                url:'/kmms/companyTraceSafetyInfomationAction/findById',
        ...
        ATTRS : {
            ...
            success:{
                value : function(){
                    ...
                    xhr.open("POST", "/kmms/companyTraceSafetyInfomationAction/updateDoc");
                    xhr.send(formData);
    ...
    return companyTraceSafetyInfomationEdit;
});