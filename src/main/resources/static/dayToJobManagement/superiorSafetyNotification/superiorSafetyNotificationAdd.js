 ...
 * @date 18-11-21
 */
define('kmms/dayToJobManagement/superiorSafetyNotification/superiorSafetyNotificationAdd',['bui/common','common/form/FormContainer',
    ...
    var superiorSafetyNotificationAdd = BUI.Overlay.Dialog.extend({
        ...
        _initDate: function () {
            ...
            var postLoad = new PostLoad({
                url : '/kmms/superiorSafetyNotificationAction/getSystemDate',
                el : _self.get('el'),
                loadMsg : '加载中...'
            });
...
//                    formData.append('userId',_self.get('userId'));
                    ...
                    xhr.open("POST", "/kmms/superiorSafetyNotificationAction/addDoc");
                    xhr.send(formData);
    ...
    return superiorSafetyNotificationAdd;
});