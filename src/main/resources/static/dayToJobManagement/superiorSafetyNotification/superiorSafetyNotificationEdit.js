 ...
 * @date 18-11-21
 */
define('kmms/dayToJobManagement/superiorSafetyNotification/superiorSafetyNotificationEdit',['bui/common','common/form/FormContainer',
   'bui/form','common/org/OrganizationPicker',],function(r){
    var BUI = r('bui/common'),
    	OrganizationPicker = r('common/org/OrganizationPicker'),
        FormContainer= r('common/form/FormContainer');
    var superiorSafetyNotificationEdit = BUI.Overlay.Dialog.extend({
        ...
        _getShowData : function(){
            ...
            $.ajax({
                url:'/kmms/superiorSafetyNotificationAction/findById',
        ...
        ATTRS : {
            ...
            success:{
                value : function(){
                    ...
                    xhr.open("POST", "/kmms/superiorSafetyNotificationAction/updateDoc");
                    xhr.send(formData);
    ...
    return superiorSafetyNotificationEdit;
});