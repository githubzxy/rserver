 ...
 * 段发安全问题通知书情况详情
 */
define('kmms/dayToJobManagement/duanSafetyNotification/duanSafetyNotificationInfo',['bui/common','common/form/FormContainer',
	'common/data/PostLoad'],function(r){
	var BUI = r('bui/common'),
		FormContainer= r('common/form/FormContainer');
	var duanSafetyNotificationInfo = BUI.Overlay.Dialog.extend({
	...
	return duanSafetyNotificationInfo;
});