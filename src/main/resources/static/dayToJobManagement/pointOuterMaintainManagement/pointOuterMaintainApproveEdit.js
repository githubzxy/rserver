 ...
 * @date 19-1-21
 */
define('kmms/dayToJobManagement/pointOuterMaintainManagement/pointOuterMaintainApproveEdit',
	[
	 	'bui/common',
	 	'bui/form',
		'bui/calendar',
    ...
    var pointOuterMaintainApproveEdit = BUI.Overlay.Dialog.extend({
...
//        	$('#formContainer #lineName').val(lineName);
...
//				},
            ...
            var form = new FormContainer({
                id : 'pointOuterMaintainApproveEditForm',
                colNum : colNum,
        ...
        ATTRS : {
            id : {value : 'pointOuterMaintainApproveEditDialog'},
            elAttrs : {value: {id:"pointOuterMaintainApproveEdit"}},
            title:{value:'修改'},
            width:{value:650},
            height:{value:500},
            ...
            success:{
            	value : function(){
            		var _self = this;
            		var formAdd = _self.getChild('pointOuterMaintainApproveEditForm');
            		//获取上传文件
            		...
            		xhr.open("POST", "/zuul/kmms/pointOuterMaintainApproveAction/updateContent");
            		xhr.send(formData);
    ...
    return pointOuterMaintainApproveEdit;
});