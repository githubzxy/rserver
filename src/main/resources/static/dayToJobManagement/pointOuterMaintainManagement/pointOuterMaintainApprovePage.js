 ...
 * @date 19-1-22
 */
define('kmms/dayToJobManagement/pointOuterMaintainManagement/pointOuterMaintainApprovePage',
	[
	 	'bui/common',
	 	'bui/data',
	 	'bui/grid',
	 	...
	 	'kmms/dayToJobManagement/pointOuterMaintainManagement/pointOuterMaintainApproveAdd',
	 	'kmms/dayToJobManagement/pointOuterMaintainManagement/pointOuterMaintainApplyDetail',
	 	'kmms/dayToJobManagement/pointOuterMaintainManagement/pointOuterMaintainApproveEdit',
	],function (r) {
    var BUI = r('bui/common'),
    	...
    	pointOuterMaintainApproveAdd = r('kmms/dayToJobManagement/pointOuterMaintainManagement/pointOuterMaintainApproveAdd'),
    	pointOuterMaintainApplyDetail = r('kmms/dayToJobManagement/pointOuterMaintainManagement/pointOuterMaintainApplyDetail'),
    	pointOuterMaintainApproveEdit = r('kmms/dayToJobManagement/pointOuterMaintainManagement/pointOuterMaintainApproveEdit');
                ...
                table.on('cellclick',function(ev){
            	  ...
            	  var Day3 = _self._replacepos(Day2,7,7,'月');
                    ...
                    if(target.hasClass('editBtn')){
                        var editDialog = new pointOuterMaintainApproveEdit({
                            collectionName:_self.get('collectionName'),
                            shiftId:docId
                        });
                        editDialog.show();
                    ...
                    if(target.hasClass('approveBtn')){
                        var editDialog = new pointOuterMaintainApproveAdd({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
...
//            		multipleSelect: true,//多选
            ...
            _initFlowState: function () {
    			...
    			$("#flowState").append("<option value='3'>待审批</option>");
...
//                        	button += '<span  class="grid-command editBtn">修改</span>';
            ...
            _initStore:function () {
                ...
                var store = new Data.Store({
                    url : "/kmms/pointOuterMaintainApproveAction/findAll.cn",
                    autoLoad : true ,
                    pageSize : 20,
                    proxy : {
                        method : 'post',
