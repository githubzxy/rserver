 ...
 * @date 19-1-21
 */
define('kmms/dayToJobManagement/pointOuterMaintainManagement/pointOuterMaintainAuditEdit',
	[
	 	'bui/common',
	 	'bui/form',
		'bui/calendar',
    ...
    var pointOuterMaintainAuditEdit = BUI.Overlay.Dialog.extend({
...
//        			}
//        			$('#formContainer #station').val(station);
//        		}
//        	});
//        },
...
//				},
				{
				    label : '作业内容及范围：',
				    itemColspan : 2,
				    item : '<textarea name="workContentRange" id="workContentRange" style="width:99.5%;height:50px"/></textarea>'
				},
				{
					label : '作业组织情况：',
					itemColspan : 2,
					item : '<textarea name="workOrgCondition" id="workOrgCondition" style="width:99.5%;height:50px"/></textarea>'
				},
				{
					label : '现场防护措施：',
					itemColspan : 2,
					item : '<textarea name="localeDefendMeasure" id="localeDefendMeasure" style="width:99.5%;height:50px" placeholder="填写驻站防护，工地防护、拦车防护的设置情况"/></textarea>'
				},
				{
					label : '相关要求：',
					itemColspan : 2,
					item : '<textarea name="relevantDemand" id="relevantDemand" style="width:99.5%;height:50px" placeholder="结合作业特点，填写相关安全风险、卡控措施和质量技术要求"/></textarea>'
				},
//				{
//					label : '作业机械料具准备及携带情况：',
//					itemColspan : 2,
...
//				},
            ...
            var form = new FormContainer({
                id : 'pointOuterMaintainAuditEditForm',
                colNum : colNum,
        ...
        ATTRS : {
            id : {value : 'pointOuterMaintainAuditEditDialog'},
            elAttrs : {value: {id:"pointOuterMaintainAuditEdit"}},
            title:{value:'修改'},
            width:{value:650},
            height:{value:500},
            ...
            success:{
            	value : function(){
            		var _self = this;
            		var formAdd = _self.getChild('pointOuterMaintainAuditEditForm');
            		//获取上传文件
            		...
            		xhr.open("POST", "/zuul/kmms/pointOuterMaintainAuditAction/updateContent");
            		xhr.send(formData);
    ...
    return pointOuterMaintainAuditEdit;
});