 ...
 * @date 19-1-17
 */
define('kmms/dayToJobManagement/networkManageInfo/networkManageTroubleAdd',
	[
	 	'bui/common',
	 	'bui/form',
	 	'bui/calendar',
    ...
    var NetworkManageTroubleAdd = BUI.Overlay.Dialog.extend({
...
//					item : '<select name="troubleLineName" id="troubleLineName" style="width:99.5%" data-rules="{required:true}"/></select>'
            ...
            var form = new FormContainer({
                id : 'networkManageTroubleAddForm',
                colNum : colNum,
        ...
        ATTRS : {
            id : {value : 'networkManageTroubleAddDialog'},
            elAttrs : {value: {id:"networkManageTroubleAdd"}},
            title:{value:'新增故障情况'},
            width:{value:750},
            height:{value:540},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('networkManageTroubleAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
...
//                    formData.append('orgName',_self.get('orgName'));
    ...
    return NetworkManageTroubleAdd;
});