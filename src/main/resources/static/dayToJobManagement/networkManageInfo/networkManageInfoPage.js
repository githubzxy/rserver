...
//            			$("#deviceType").html(html);
            ...
            _initSearchForm:function(){
                return {
                    items : [
                        {label : '信息后果',item : '<select type="text" name="infoResult" id="infoResult" style="width: 210px;"><option value="" >请选择</option></select>'},
                        {label : '类型',item : '<select type="text" id="type" name="type" style="width: 210px;"><option value="" >请选择</option></select>'},
                        ...
                        {label : '内容及处理情况',item : '<input type="text" name="detail" id="detail"  style="width: 185px;" />'},
