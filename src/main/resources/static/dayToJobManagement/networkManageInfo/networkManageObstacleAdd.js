 ...
 * @date 19-1-17
 */
define('kmms/dayToJobManagement/networkManageInfo/networkManageObstacleAdd',
	[
	 	'bui/common',
	 	'bui/form',
	 	'bui/calendar',
    ...
    var NetworkManageObstacleAdd = BUI.Overlay.Dialog.extend({
...
//                },
            ...
            var form = new FormContainer({
                id : 'networkManageObstacleAddForm',
                colNum : colNum,
        ...
        ATTRS : {
            id : {value : 'networkManageObstacleAddDialog'},
            elAttrs : {value: {id:"networkManageObstacleAdd"}},
            title:{value:'新增障碍情况'},
            width:{value:750},
            height:{value:540},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('networkManageObstacleAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
...
//                    formData.append('orgName',_self.get('orgName'));
    ...
    return NetworkManageObstacleAdd;
});