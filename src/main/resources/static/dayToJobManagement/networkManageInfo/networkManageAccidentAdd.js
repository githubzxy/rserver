 ...
 * @date 19-1-17
 */
define('kmms/dayToJobManagement/networkManageInfo/networkManageAccidentAdd',
	[
	 	'bui/common',
	 	'bui/form',
	 	'bui/calendar',
    ...
    var NetworkManageAccidentAdd = BUI.Overlay.Dialog.extend({
...
//                    item : '<select name="accidentDetailLevel" id="accidentDetailLevel" style="width:99.5%" data-rules="{required:true}"/></select>'
            ...
            var form = new FormContainer({
                id : 'networkManageAccidentAddForm',
                colNum : colNum,
...
//                elStyle:{overflowY:'scroll',height:'400px'}
        ...
        ATTRS : {
            id : {value : 'networkManageAccidentAddDialog'},
            elAttrs : {value: {id:"networkManageAccidentAdd"}},
            title:{value:'新增事故情况'},
            width:{value:620},
            height:{value:540},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('networkManageAccidentAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    formData.append('accidentUploadFileArr',JSON.stringify(uploadFileArr));
...
//                    formData.append('orgName',_self.get('orgName'));
    ...
    return NetworkManageAccidentAdd;
});