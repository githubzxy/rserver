 ...
 * @date 19-1-17
 */
define('kmms/dayToJobManagement/networkManageInfo/networkManageInfoDetailGz',
		[
		 	'bui/common',
	...
	var NetworkManageInfoDetailGz = BUI.Overlay.Dialog.extend({
...
//					item: '<div name="viewUploadfile" id="viewUploadfile" style="height:100px;overflow-y:auto"></div>'
			...
			var form = new FormContainer({
				id : 'networkManageInfoDetailGzShow',
				colNum : colNum,
		...
		ATTRS : {
			id : {value : 'networkManageInfoDetailGzDialog'},
...
//            downloadUrl:{value:'/kmms/commonAction/download?path='},
	...
	return NetworkManageInfoDetailGz;
});