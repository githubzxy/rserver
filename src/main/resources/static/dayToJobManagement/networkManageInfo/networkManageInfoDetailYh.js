 ...
 * @date 19-3-22
 */
define('kmms/dayToJobManagement/networkManageInfo/networkManageInfoDetailYh',
		[
		 	'bui/common',
	...
	var NetworkManageInfoDetailYh = BUI.Overlay.Dialog.extend({
...
//					item: '<div name="viewUploadfile" id="viewUploadfile" style="height:100px;overflow-y:auto"></div>'
			...
			var form = new FormContainer({
				id : 'networkManageInfoDetailYhShow',
				colNum : colNum,
		...
		ATTRS : {
			id : {value : 'networkManageInfoDetailYhDialog'},
...
//            downloadUrl:{value:'/kmms/commonAction/download?path='},
	...
	return NetworkManageInfoDetailYh;
});