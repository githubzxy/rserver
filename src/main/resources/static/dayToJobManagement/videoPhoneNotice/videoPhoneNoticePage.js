 ...
 * @date 18-11-21
 */
define('kmms/dayToJobManagement/videoPhoneNotice/videoPhoneNoticePage',['bui/common','bui/data','bui/grid',
    'common/grid/SearchGridContainer','kmms/dayToJobManagement/videoPhoneNotice/videoPhoneNoticeAdd','bui/calendar','common/org/OrganizationPicker',
    'kmms/dayToJobManagement/videoPhoneNotice/videoPhoneNoticeEdit','kmms/dayToJobManagement/videoPhoneNotice/videoPhoneNoticeInfo','common/data/PostLoad'],function (r) {
    var BUI = r('bui/common'),
        ...
        videoPhoneNoticeAdd = r('kmms/dayToJobManagement/videoPhoneNotice/videoPhoneNoticeAdd'),
        videoPhoneNoticeEdit = r('kmms/dayToJobManagement/videoPhoneNotice/videoPhoneNoticeEdit'),
        videoPhoneNoticeInfo = r('kmms/dayToJobManagement/videoPhoneNotice/videoPhoneNoticeInfo'),
        SearchGridContainer = r('common/grid/SearchGridContainer');

    var videoPhoneNoticePage = BUI.Component.Controller.extend(
        {
...
//	                           url : '/kmms/videoPhoneAction/removeDoc.cn',
//	                           el : _self.get('el'),
//	                           loadMsg : '删除中...'
//	                       });
...
//                });
                ...
                $('.addBtn').on('click',function(e){
                    var addDialog = new videoPhoneNoticeAdd({
                ...
                table.on('cellclick',function(ev){
                    ...
                    if(target.hasClass('infoBtn')){
                        var infoDialog = new videoPhoneNoticeInfo({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                            shiftId:docId
                        });
                    ...
                    if(target.hasClass('editBtn')){
                        var editDialog = new videoPhoneNoticeEdit({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                            shiftId:docId
                        });
            ...
            _initSearchForm:function(){
                return {
                    items : [
                        ...
                        {
                        	label : '内容及处理情况',
                        	item : '<input type="text" name="noticeContent" id="noticeContent" style="width: 185px;"/>'
                        }
...
//                        	}
            ...
            _initStore:function () {
                ...
                var store = new Data.Store({
                    url : "/kmms/videoPhoneAction/findAll.cn",
                    autoLoad : true ,
                    pageSize : 10,
                    proxy : {
                        method : 'post',
...
//                        }
        ...
        },
        {
            ATTRS : {
                 ...
                 * 存储表名
                 */
                collectionName : {value:'videoPhoneNotice'}
            }
        });
    return videoPhoneNoticePage;
});