 ...
 * @date 18-11-22
 */
define('kmms/integratedManagement/Attendance/attendancePage',['bui/common','bui/data','bui/grid',
    'common/grid/SearchGridContainer','kmms/integratedManagement/Attendance/attendanceAdd','bui/calendar','common/org/OrganizationPicker',
    'kmms/integratedManagement/Attendance/attendanceEdit','kmms/integratedManagement/Attendance/attendanceInfo','common/data/PostLoad'],function (r) {
    ...
    var AttendancePage = BUI.Component.Controller.extend(
        {
              ...
              //重写重置按钮的点击事件
                ...
                table.on('cellclick',function(ev){
                    ...
                    if(target.hasClass('infoBtn')){
                        var infoDialog = new attendanceInfo({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                            shiftId:docId
                        });
                    ...
                    if(target.hasClass('editBtn')){
                        var editDialog = new attendanceEdit({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                            shiftId:docId
                        });
        ...
        },
        {
            ATTRS : {
                 ...
                 * 存储表名
                 */
                collectionName : {value:'attendance'}
            }
        });
