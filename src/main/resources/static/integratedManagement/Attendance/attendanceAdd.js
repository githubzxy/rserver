 ...
 * @date 18-11-21
 */
define('kmms/integratedManagement/Attendance/attendanceAdd',['bui/common','common/form/FormContainer',
    'bui/form','common/org/OrganizationPicker',],function(r){
    var BUI = r('bui/common'),
    	OrganizationPicker = r('common/org/OrganizationPicker'),
        FormContainer= r('common/form/FormContainer');
    var AttendanceAdd = BUI.Overlay.Dialog.extend({
            ...
            var childs = [
                {
                    ...
                    label : '附件：',
                    itemColspan : 2,
                    item : '<input name="uploadfile" id="uploadfile" style="height:70px;overflow-y :auto" type="file" accept=".doc,.docx,.xls,.xlsx,.ppt,.pptx" multiple/>'
                }
            ];
            var form = new FormContainer({
                id : 'attendanceAddForm',
                colNum : colNum,
...
//                elStyle:{overflowY:'scroll',height:'400px'}
        ...
        ATTRS : {
            id : {value : 'attendanceAddDialog'},
            elAttrs : {value: {id:"attendanceAdd"}},
            title:{value:'新增'},
            width:{value:610},
            height:{value:240},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('attendanceAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
