 ...
 * @date 18-11-21
 */
define('kmms/integratedManagement/Announcement/announcementAdd',['bui/common','common/form/FormContainer',
    'bui/form','common/org/OrganizationPicker',],function(r){
    var BUI = r('bui/common'),
    	OrganizationPicker = r('common/org/OrganizationPicker'),
        FormContainer= r('common/form/FormContainer');
    var AnnouncementAdd = BUI.Overlay.Dialog.extend({
...
//                elStyle:{overflowY:'scroll',height:'400px'}
        ...
        ATTRS : {
            id : {value : 'announcementAddDialog'},
            elAttrs : {value: {id:"announcementAdd"}},
            title:{value:'新增'},
            width:{value:610},
            height:{value:240},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('announcementAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
