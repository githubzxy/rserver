 ...
 * @date 18-11-22
 */
define('kmms/integratedManagement/Announcement/announcementPage',['bui/common','bui/data','bui/grid',
    'common/grid/SearchGridContainer','kmms/integratedManagement/Announcement/announcementAdd','bui/calendar','common/org/OrganizationPicker',
    'kmms/integratedManagement/Announcement/announcementEdit','kmms/integratedManagement/Announcement/announcementInfo','common/data/PostLoad'],function (r) {
    var BUI = r('bui/common'),
	    ...
	    announcementAdd = r('kmms/integratedManagement/Announcement/announcementAdd'),
	    announcementEdit = r('kmms/integratedManagement/Announcement/announcementEdit'),
	    announcementInfo = r('kmms/integratedManagement/Announcement/announcementInfo'),
        SearchGridContainer = r('common/grid/SearchGridContainer');

    var Announcement = BUI.Component.Controller.extend(
        {
            ...
            bindUI:function(){
              ...
              //重写重置按钮的点击事件
                ...
                $('.addBtn').on('click',function(e){
                    var addDialog = new announcementAdd({
                ...
                table.on('cellclick',function(ev){
                    ...
                    if(target.hasClass('infoBtn')){
                        var infoDialog = new announcementInfo({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                            shiftId:docId
                        });
                    ...
                    if(target.hasClass('editBtn')){
                        var editDialog = new announcementEdit({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                            shiftId:docId
                        });
        ...
        },
        {
            ATTRS : {
                 ...
                 * 存储表名
                 */
                collectionName : {value:'announcement'}
            }
        });
    return Announcement;
});