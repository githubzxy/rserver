 ...
 * @date 18-11-23
 */
define('kmms/pointInnerMaintainPlanMangement/pointInnerMaintainPlan/PointInnerMaintainPlanEdit',[
	'bui/common','common/form/FormContainer',
   'bui/form','common/org/OrganizationPicker'],function(r){
    var BUI = r('bui/common'),
    	OrganizationPicker = r('common/org/OrganizationPicker'),
        FormContainer= r('common/form/FormContainer');
    var PointInnerMaintainPlanEdit = BUI.Overlay.Dialog.extend({
        ...
        _initFormContainer : function(){
            ...
            var form = new FormContainer({
                id : 'pointInnerMaintainPlanEditForm',
                colNum : colNum,
...
//                elStyle:{overflowY:'scroll',height:'400px'}
        ...
        ATTRS : {
            id : {value : 'pointInnerMaintainPlanEditDialog'},
            elAttrs : {value: {id:"pointInnerMaintainPlanEdit"}},
            title:{value:'编辑'},
            width:{value:610},
            height:{value:240},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('pointInnerMaintainPlanEditForm'),delData=_self.get('delData');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/workPlanAction/updateDoc");
                    xhr.send(formData);
    ...
    return PointInnerMaintainPlanEdit;
});