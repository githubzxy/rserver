 ...
 * @date 18-11-21
 */
define('kmms/dailyShift/duan/dailyShiftForDuanPage',['bui/common','bui/data','bui/grid',
    'common/grid/SearchGridContainer','kmms/dailyShift/duan/dailyShiftForDuanAdd','bui/calendar','common/org/OrganizationPicker',
    'kmms/dailyShift/duan/dailyShiftForDuanEdit','kmms/dailyShift/duan/dailyShiftForDuanInfo','common/data/PostLoad'],function (r) {
    var BUI = r('bui/common'),
        ...
        dailyShiftForDuanAdd = r('kmms/dailyShift/duan/dailyShiftForDuanAdd'),
        dailyShiftForDuanEdit = r('kmms/dailyShift/duan/dailyShiftForDuanEdit'),
        dailyShiftForDuanInfo = r('kmms/dailyShift/duan/dailyShiftForDuanInfo'),
        SearchGridContainer = r('common/grid/SearchGridContainer');

    var dailyShiftForDuanPage = BUI.Component.Controller.extend(
        {
            ...
            bindUI:function(){
                ...
                $('.addBtn').on('click',function(e){
                    var addDialog = new dailyShiftForDuanAdd({
                ...
                table.on('cellclick',function(ev){
                    ...
                    if(target.hasClass('infoBtn')){
                        var infoDialog = new dailyShiftForDuanInfo({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                            shiftId:docId
                        });
                    ...
                    if(target.hasClass('editBtn')){
                        var editDialog = new dailyShiftForDuanEdit({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                            shiftId:docId
                        });
        ...
        },
        {
            ATTRS : {
                 ...
                 * 存储表名
                 */
                collectionName : {value:'dailyShiftForDuan'}
            }
        });
    return dailyShiftForDuanPage;
});