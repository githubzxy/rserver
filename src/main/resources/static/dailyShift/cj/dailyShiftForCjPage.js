 ...
 * @date 18-11-21
 */
define('kmms/dailyShift/cj/dailyShiftForCjPage',['bui/common','bui/data','bui/grid',
    'common/grid/SearchGridContainer','kmms/dailyShift/cj/dailyShiftForCjAdd','bui/calendar','common/org/OrganizationPicker',
    'kmms/dailyShift/cj/dailyShiftForCjEdit','kmms/dailyShift/cj/dailyShiftForCjInfo','common/data/PostLoad'],function (r) {
    var BUI = r('bui/common'),
        ...
        dailyShiftForCjAdd = r('kmms/dailyShift/cj/dailyShiftForCjAdd'),
        dailyShiftForCjEdit = r('kmms/dailyShift/cj/dailyShiftForCjEdit'),
        dailyShiftForCjInfo = r('kmms/dailyShift/cj/dailyShiftForCjInfo'),
        SearchGridContainer = r('common/grid/SearchGridContainer');

    var dailyShiftForCjPage = BUI.Component.Controller.extend(
        {
            ...
            bindUI:function(){
              ...
              //重写重置按钮的点击事件
                ...
                $('.addBtn').on('click',function(e){
                    var addDialog = new dailyShiftForCjAdd({
                ...
                table.on('cellclick',function(ev){
                    ...
                    if(target.hasClass('infoBtn')){
                        var infoDialog = new dailyShiftForCjInfo({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                            shiftId:docId
                        });
                    ...
                    if(target.hasClass('editBtn')){
                        var editDialog = new dailyShiftForCjEdit({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                            shiftId:docId
                        });
        ...
        },
        {
            ATTRS : {
                 ...
                 * 存储表名
                 */
                collectionName : {value:'dailyShiftForCj'}
            }
        });
    return dailyShiftForCjPage;
});