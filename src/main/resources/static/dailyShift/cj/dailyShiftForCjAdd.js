 ...
 * @date 18-11-21
 */
define('kmms/dailyShift/cj/dailyShiftForCjAdd',['bui/common','common/form/FormContainer',
            ...
            var childs = [
                {
                    ...
                    label : '施工配合信息：',
                    itemColspan : 2,
                    item : '<input name="construction" id="construction" style="height:70px;overflow-y :auto" type="file" multiple accept=".doc,.docx,.xls,.xlsx,.ppt,.pptx"/>'
                },{
                    label : '上级部门检查情况：',
                    itemColspan : 2,
                    item : '<input name="check" id="check" style="height:70px;overflow-y :auto" type="file" multiple accept=".doc,.docx,.xls,.xlsx,.ppt,.pptx"/>'
                },{
                    label : '干部值班情况：',
                    itemColspan : 2,
                    item : '<input name="duty" id="duty" style="height:70px;overflow-y :auto"  type="file" multiple accept=".doc,.docx,.xls,.xlsx,.ppt,.pptx"/>'
                }
            ];
...
//                elStyle:{overflowY:'scroll',height:'400px'}
        ...
        ATTRS : {
            id : {value : 'cjShiftAddDialog'},
            elAttrs : {value: {id:"cjShiftAdd"}},
            title:{value:'新增交班'},
            width:{value:610},
            height:{value:400},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('CjAdd');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
