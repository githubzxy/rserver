 ...
 * @date 18-11-21
 */
define('kmms/workAssortProtocolManagement/workAssortProtocol/workAssortProtocolAdd',['bui/common','common/form/FormContainer',
    'bui/form','common/org/OrganizationPicker',],function(r){
    var BUI = r('bui/common'),
    	OrganizationPicker = r('common/org/OrganizationPicker'),
        FormContainer= r('common/form/FormContainer');
    var WorkAssortProtocolAdd = BUI.Overlay.Dialog.extend({
...
//                elStyle:{overflowY:'scroll',height:'400px'}
        ...
        ATTRS : {
            id : {value : 'workAssortProtocolAddDialog'},
            elAttrs : {value: {id:"workAssortProtocolAdd"}},
            title:{value:'新增'},
            width:{value:610},
            height:{value:240},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('workAssortProtocolAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
