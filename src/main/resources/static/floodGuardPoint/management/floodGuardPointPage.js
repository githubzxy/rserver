 ...
 * @date 18-11-22
 */
define('kmms/floodGuardPoint/management/floodGuardPointPage',['bui/common','bui/data','bui/grid',
    'common/grid/SearchGridContainer','kmms/floodGuardPoint/management/floodGuardPointAdd','bui/calendar','common/org/OrganizationPicker',
    'kmms/floodGuardPoint/management/floodGuardPointEdit','kmms/floodGuardPoint/management/floodGuardPointInfo','common/data/PostLoad'],function (r) {
    var BUI = r('bui/common'),
    	...
    	floodGuardPointAdd = r('kmms/floodGuardPoint/management/floodGuardPointAdd'),
    	floodGuardPointEdit = r('kmms/floodGuardPoint/management/floodGuardPointEdit'),
    	floodGuardPointInfo = r('kmms/floodGuardPoint/management/floodGuardPointInfo'),
...
//                    permissionStore : _self._initPermissionStore()
        ...
        },
        {
            ATTRS : {
                 ...
                 * 存储表名
                 */
                collectionName : {value:'floodGuardPointManagement'}
            }
        });
