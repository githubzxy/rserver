 ...
 * 导入施工维修信息表单
 */
define('kmms/emergencyManage/floodGuardPoint/floodGuardPointManage/floodGuardPointImport',[
										'bui/overlay',
										'bui/mask',
	...
	var FloodGuardPointImport = Overlay.Dialog.extend({
		//初始化弹框控件
...
//        		}
		...
		ATTRS : {//定义弹框属性
			elAttrs : {value: {id:"FloodGuardPointImport"}},
			title : {value : '导入防洪信息表'},
			width : {value : 617},
//			collectionName:{},
			height : {value : 190},
			...
			success : {
				value : function(){
					...
					var importForm=_self.getChild('FloodGuardPointImport',true);
