 ...
 * 类名称：PointOuterMaintainApplyImpl   
 * 类描述:  查询点外维修指定状态数据的数量统计
 * 创建人：zhouxingyu
 * 创建时间：2019年5月23日 上午11:08:03
 * 修改人：zhouxingyu 
 * 修改时间：2019年5月23日 上午11:08:03   
 *
 */
@Service("pointOuterMaintainApply")
public class PointOuterMaintainApplyImpl implements TodoCountCommonService{
	...
	public Long getTodoCount(String userId) {
		...
		criteria.andOperator(Criteria.where("orgId").is(orgId));
