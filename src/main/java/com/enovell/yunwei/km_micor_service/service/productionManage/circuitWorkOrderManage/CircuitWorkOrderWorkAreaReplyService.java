...
public interface CircuitWorkOrderWorkAreaReplyService {
     ...
     * @return
     */
	void addReplyDocument(Document newDocument, String circuitDistributeWorkOrderReply, Document document, String circuitDistributeWorkOrder);
