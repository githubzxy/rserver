...
public interface CommonPageService {
     ...
     * @return 数据对象列表
     */
    List<Document> findAllDocument(String collectionName, String name, Date startUploadDate,Date endUploadDate,String orgId, int start, int limit,String auditStatus);
     ...
     * @return 条数
     */
    long findAllDocumentCount(String collectionName, String name, Date startUploadDate,Date endUploadDate,String orgId,String auditStatus);
    /**
     * 新增数据
     * @param doc 数据对象
     * @param collectionName 表名
