 ...
 * @date 19-1-18
 */
@Service("remainInfoService")
public class RemainInfoServiceImpl implements RemainInfoService {
...
//    }
    ...
    @Override
    public List<Document> findAllDocument(String collectionName,  String userId, String currentDay,String infoResult,String type, String startUploadDate, String endUploadDate, int start, int limit,String detail, String system, String systemType) {
        List<Document> results = new ArrayList<>();
        try(MongoClient mc = new MongoClient(mongoHost,mongoPort)){
            MongoDatabase md = mc.getDatabase(mongoDatabase);
            Bson filter = getFilter(userId, currentDay, infoResult, type,startUploadDate,endUploadDate,detail,system,systemType);
    ...
    @Override
    public long findAllDocumentCount(String collectionName, String userId, String currentDay,String infoResult,String type, String startUploadDate, String endUploadDate,String detail, String system, String systemType) {
        try(MongoClient mc = new MongoClient(mongoHost,mongoPort)) {
            MongoDatabase md = mc.getDatabase(mongoDatabase);
            Bson filter = getFilter(userId, currentDay,  infoResult, type,startUploadDate, endUploadDate,detail,system,systemType);
     ...
     * @return 查询条件
     */
    private Bson getFilter(String userId, String currentDay,String infoResult,String type, String startUploadDate, String endUploadDate,String detail, String system, String systemType) {
        ...
        filter = Filters.and(filter,Filters.eq("lost","1"));//表示查询的是遗留条件为否的
        return filter;
    }
