...
public interface DeviceRecordLedgerService {
	/**
     * 新增数据
     * @param doc 数据对象
     ...
     * @return 数据对象列表
     */
    List<Document> findAllDocument(String collectionName,  String userId , String location,String deviceName ,int start, int limit);
    /**
     * 分页查询数量
     * @param collectionName 表名
     * @param name   数据名称
     ...
     * @return 条数
     */
    long findAllDocumentCount(String collectionName, String userId,String location,String deviceName);
