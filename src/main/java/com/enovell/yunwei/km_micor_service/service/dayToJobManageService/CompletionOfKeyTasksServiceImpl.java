...
@Service("completionOfKeyTasksService")
public class CompletionOfKeyTasksServiceImpl implements CompletionOfKeyTasksService{
	...
	@Override
	 public List<Document> findAllDocument(String collectionName,  String userId, String currentDay, String startUploadDate, String endUploadDate, int start, int limit) {
		 List<Document> results = new ArrayList<>();
	        try(MongoClient mc = new MongoClient(mongoHost,mongoPort)){
	            MongoDatabase md = mc.getDatabase(mongoDatabase);
	            Bson filter = getFilter(userId, currentDay,startUploadDate,endUploadDate);
	...
	@Override
   public long findAllDocumentCount(String collectionName,  String userId, String currentDay, String startUploadDate, String endUploadDate) {
		 try(MongoClient mc = new MongoClient(mongoHost,mongoPort)) {
	            MongoDatabase md = mc.getDatabase(mongoDatabase);
	            Bson filter = getFilter(userId, currentDay, startUploadDate, endUploadDate);
     ...
     * @return 查询条件
     */
	 private Bson getFilter(String userId, String currentDay, String startUploadDate, String endUploadDate) {
