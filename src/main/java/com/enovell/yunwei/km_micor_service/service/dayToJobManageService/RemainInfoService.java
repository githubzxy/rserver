 ...
 * @date 19-1-18
 */
public interface RemainInfoService {
...
//    long findAllDocumentCount(String collectionName, String userId, String currentDay, Date startUploadDate,Date endUploadDate);
    long findAllDocumentCount(String collectionName, String userId, String currentDay,String infoResult,String type, String startUploadDate,String endUploadDate, String detail, String system, String systemType);
...
//    List<Document> findAllDocument(String collectionName,  String userId, String currentDay, Date startUploadDate,Date endUploadDate, int start, int limit);
    List<Document> findAllDocument(String collectionName,  String userId, String currentDay,String infoResult,String type, String startUploadDate,String endUploadDate, int start, int limit, String detail, String system, String systemType);
