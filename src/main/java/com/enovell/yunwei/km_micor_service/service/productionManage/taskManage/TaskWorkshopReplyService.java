...
public interface TaskWorkshopReplyService {
     ...
     * @return
     */
    void addReplyDocument(Document newDocument,String IssueTaskOfWorkShopReply, Document document,String IssueTaskOfWorkShop);
