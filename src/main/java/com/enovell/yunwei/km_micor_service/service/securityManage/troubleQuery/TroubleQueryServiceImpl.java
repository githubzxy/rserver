...
public class TroubleQueryServiceImpl implements TroubleQueryService {
	...
	@Override
	public long findAllDocumentCount(String collectionName , String startDate, String endDate,String obligationDepart,String troubleLineName,String troubleFixDuty,String troubleGeneral) {
		try(MongoClient mc = new MongoClient(mongoHost,mongoPort)) {
            MongoDatabase md = mc.getDatabase(mongoDatabase);
            Bson filter = getFilter(startDate,endDate,obligationDepart,troubleLineName,troubleFixDuty,troubleGeneral);
            return  md.getCollection(collectionName).count(filter);
        }
	}

	@Override
	public List<Document> findAllDocument(String collectionName , String startDate, String endDate,String obligationDepart,String troubleLineName,String troubleFixDuty,String troubleGeneral, int start, int limit) {
	...
	private Bson getFilter( String startDate, String endDate,String obligationDepart,String troubleLineName,String troubleFixDuty,String troubleGeneral) {
...
//		}
		...
		if(StringUtils.isNotBlank(troubleFixDuty)) {
			filters=Filters.and(filters,Filters.regex("troubleFixDuty",troubleFixDuty));
		}
