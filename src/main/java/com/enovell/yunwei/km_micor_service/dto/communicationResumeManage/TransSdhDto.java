...
public class TransSdhDto implements Serializable {
	private static final long serialVersionUID = -1598722940355644885L;
	...
	public String toString() {
		return "TransSdhDto [workshop=" + workshop + ", workArea=" + workArea + ", combinationClass=" + combinationClass
				+ ", deviceClass=" + deviceClass + ", deviceCode=" + deviceCode + ", deviceName=" + deviceName
				+ ", deviceId=" + deviceId + ", systemName=" + systemName + ", site_station_line=" + site_station_line
				...
				+ ", roadCapacity=" + roadCapacity + ", assetRatio=" + assetRatio + ", productionDate=" + productionDate
				+ ", useDate=" + useDate + ", deviceOperationStatus=" + deviceOperationStatus + ", stopDate=" + stopDate
				+ ", scrapDate=" + scrapDate + ", fixedAssetsCode=" + fixedAssetsCode + ", remark=" + remark + "]";
	}
}