...
public class TransOtherDto implements Serializable {
	private static final long serialVersionUID = -6418636640265800747L;
		...
		public String toString() {
			return "TransOtherDto [workshop=" + workshop + ", workArea=" + workArea + ", combinationClass="
					+ combinationClass + ", deviceClass=" + deviceClass + ", deviceCode=" + deviceCode + ", deviceName="
					+ deviceName + ", site_station_line=" + site_station_line + ", site_station_name="
					+ site_station_name + ", site_station_place=" + site_station_place + ", site_range_line="
					+ site_range_line + ", site_range_post=" + site_range_post + ", site_range_place="
					+ site_range_place + ", site_other_line=" + site_other_line + ", site_other_place="
					+ site_other_place + ", site_machineRoomCode=" + site_machineRoomCode + ", assetOwnership="
					+ assetOwnership + ", ownershipUnitName=" + ownershipUnitName + ", ownershipUnitCode="
					+ ownershipUnitCode + ", maintainBody=" + maintainBody + ", maintainUnitName=" + maintainUnitName
					+ ", maintainUnitCode=" + maintainUnitCode + ", accessType=" + accessType + ", manufacturers="
					+ manufacturers + ", deviceType=" + deviceType + ", useUnit=" + useUnit + ", totalCapacity="
					+ totalCapacity + ", roadCapacity=" + roadCapacity + ", assetRatio=" + assetRatio
					+ ", capacityUnit=" + capacityUnit + ", productionDate=" + productionDate + ", useDate=" + useDate
