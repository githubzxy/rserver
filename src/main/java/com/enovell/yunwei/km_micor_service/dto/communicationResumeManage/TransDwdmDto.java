...
public class TransDwdmDto implements Serializable {
	private static final long serialVersionUID = -5451723129753082741L;
	...
	public void setConfigChannel(String configChannel) {
	...
	public String toString() {
		return "TransDwdmDto [workshop=" + workshop + ", workArea=" + workArea + ", combinationClass="
				+ combinationClass + ", deviceClass=" + deviceClass + ", systemName=" + systemName + ", deviceCode="
				+ deviceCode + ", deviceName=" + deviceName + ", deviceId=" + deviceId + ", site_station_line="
				+ site_station_line + ", site_station_name=" + site_station_name + ", site_station_place="
				+ site_station_place + ", site_range_line=" + site_range_line + ", site_range_post=" + site_range_post
				...
				+ ", ownershipUnitCode=" + ownershipUnitCode + ", maintainBody=" + maintainBody + ", maintainUnitName="
				+ maintainUnitName + ", maintainUnitCode=" + maintainUnitCode + ", manufacturers=" + manufacturers
				+ ", deviceType=" + deviceType + ", useUnit=" + useUnit + ", totalCapacity=" + totalCapacity
				+ ", roadCapacity=" + roadCapacity + ", configChannel=" + configChannel + ", assetRatio=" + assetRatio
