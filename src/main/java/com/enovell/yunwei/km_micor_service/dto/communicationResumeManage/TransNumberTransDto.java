...
public class TransNumberTransDto implements Serializable {
	private static final long serialVersionUID = -5451723129752082741L;
		...
		public String toString() {
			return "TransNumberTransDto [workshop=" + workshop + ", workArea=" + workArea + ", combinationClass="
					...
					+ ", maintainUnitCode=" + maintainUnitCode + ", manufacturers=" + manufacturers + ", deviceType="
					+ deviceType + ", useUnit=" + useUnit + ", totalCapacity=" + totalCapacity + ", roadCapacity="
					+ roadCapacity + ", assetRatio=" + assetRatio + ", productionDate=" + productionDate + ", useDate="
					+ useDate + ", deviceOperationStatus=" + deviceOperationStatus + ", stopDate=" + stopDate
