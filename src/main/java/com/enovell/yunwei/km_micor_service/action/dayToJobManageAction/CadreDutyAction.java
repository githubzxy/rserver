...
import com.enovell.yunwei.km_micor_service.service.dayToJobManageService.CadreDutyService;
import com.enovell.yunwei.km_micor_service.util.JsonUtil;

@RestController
@RequestMapping("/cadreDutyAction")
public class CadreDutyAction {
	@Resource(name = "cadreDutyService")
    private CadreDutyService service;
    ...
    public ResultMsg addDoc(@RequestParam(name = "noticeDateStr") String noticeDateStr,
                            @RequestParam(name = "dutyLeader") String dutyLeader,
                            @RequestParam(name = "dutyCadre") String dutyCadre,
                            @RequestParam(name = "collectionName") String collectionName,
//                            @RequestParam(name = "userId") String userId,
                            HttpServletRequest request) {
        Document document = new Document();
        document.put("noticeDateStr", noticeDateStr);
        document.put("dutyLeader", dutyLeader);
        document.put("dutyCadre", dutyCadre);
...
//        document.put("orgName", orgSelectName);
    ...
    public GridDto<Document> findAll(@RequestParam String collectionName,
        ...
        result.setResults(service.findAllDocumentCount(collectionName, userId, currentDay, startUploadDate, endUploadDate));
        result.setRows(service.findAllDocument(collectionName, userId, currentDay, startUploadDate, endUploadDate, start, limit));
        return result;
    }
    /**
     * 删除数据
    ...
    public ResultMsg updateDoc( @RequestParam("id") String id,
        ...
        doc.put("dutyLeader", dutyLeader);
        doc.put("dutyCadre", dutyCadre);
