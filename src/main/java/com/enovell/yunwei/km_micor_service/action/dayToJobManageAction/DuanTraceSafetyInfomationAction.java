...
import com.enovell.yunwei.km_micor_service.service.dayToJobManageService.DuanTraceSafetyInfomationService;
import com.enovell.yunwei.km_micor_service.util.JsonUtil;

@RestController
@RequestMapping("/duanTraceSafetyInfomationAction")
public class DuanTraceSafetyInfomationAction {
	@Resource(name = "duanTraceSafetyInfomationService")
    private DuanTraceSafetyInfomationService service;
