...
import com.enovell.yunwei.km_micor_service.service.dayToJobManageService.VideoPhoneNoticeService;
import com.enovell.yunwei.km_micor_service.util.JsonUtil;

@RestController
@RequestMapping("/videoPhoneAction")
public class VideoPhoneNoticeAction {
	@Resource(name = "videoPhoneNoticeService")
    private VideoPhoneNoticeService service;
...
//        document.put("orgName", orgSelectName);
    ...
    public GridDto<Document> findAll(@RequestParam String collectionName,
        ...
        result.setRows(service.findAllDocument(collectionName, userId, currentDay, startUploadDate, endUploadDate, start, limit,noticeContent));
        return result;
    }
    /**
     * 删除数据
