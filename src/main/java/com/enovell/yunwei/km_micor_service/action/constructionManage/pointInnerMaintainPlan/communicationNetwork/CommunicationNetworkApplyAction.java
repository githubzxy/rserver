...
import com.enovell.yunwei.km_micor_service.service.constructionManage.pointInnerMaintainPlan.communicationNetwork.CommunicationNetworkApplyService;
 ...
 * 类名称：CommunicationNetworkApplyAction   
 * 类描述:  点内维修网管
 * 创建人：zhouxingyu
 * 创建时间：2019年7月8日 上午10:09:27
 * 修改人：zhouxingyu 
 * 修改时间：2019年7月8日 上午10:09:27   
 *
 */
@RestController
@RequestMapping("/communicationNetworkApplyAction")
public class CommunicationNetworkApplyAction {
	@Resource(name = "communicationNetworkApplyService")
    private CommunicationNetworkApplyService service;
...
//        return ResultMsg.getSuccess("删除成功");
	...
	@ResponseBody
	public ResultMsg txdWriteBusiWord(@RequestBody CommunicationNetworkApplyDto dto,HttpServletRequest request) {
