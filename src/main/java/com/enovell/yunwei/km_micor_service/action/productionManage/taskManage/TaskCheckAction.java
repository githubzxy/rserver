...
import com.enovell.yunwei.km_micor_service.service.productionManage.taskManage.TaskCheckService;

@RestController
@RequestMapping("/taskCheckAction")
public class TaskCheckAction {
	@Resource(name = "taskCheckService")
    private TaskCheckService service;
    ...
    public GridDto<Document> findAll(@RequestParam String collectionName,
        ...
        result.setResults(service.findAllDocumentCount(collectionName, userId, currentDay, taskName, systemType, flowState, startUploadDate, endUploadDate));
        result.setRows(service.findAllDocument(collectionName, userId, currentDay, taskName, systemType, flowState, startUploadDate, endUploadDate, start, limit));
        return result;
    }
    /**
     * 审核信息更新
    ...
    public ResultMsg updateCheckDoc( 
    	...
    	Document res = service.updateDocument(document, collectionName, IssueTaskOfWorkShop, flowState);
