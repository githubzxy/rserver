...
import com.enovell.yunwei.km_micor_service.service.productionManage.circuitWorkOrderManage.CircuitWorkOrderWorkAreaReplyService;

@RestController
@RequestMapping("/circuitWorkOrderWorkAreaReplyAction")
public class CircuitWorkOrderWorkAreaReplyAction {
	@Resource(name = "circuitWorkOrderWorkAreaReplyService")
    private CircuitWorkOrderWorkAreaReplyService service;
    ...
    public GridDto<Document> findAll(@RequestParam String collectionName,
        ...
        result.setResults(service.findAllDocumentCount(collectionName,docId,executiveOrgId, orgId, currentDay, workOrderName, systemType, flowState, startUploadDate, endUploadDate));
        result.setRows(service.findAllDocument(collectionName,docId,executiveOrgId, orgId, currentDay, workOrderName, systemType, flowState, startUploadDate, endUploadDate, start, limit));
        return result;
    }
...
//    		@RequestParam(name = "collectionName") String collectionName,
    		@RequestParam(name = "circuitDistributeWorkOrderReply") String circuitDistributeWorkOrderReply,
    		@RequestParam(name = "circuitDistributeWorkOrder") String circuitDistributeWorkOrder,
    	...
    	Document document = service.findDocumentById(id,distributeOrgId,circuitDistributeWorkOrder);
    	...
    	service.addReplyDocument(newDocument, circuitDistributeWorkOrderReply, document, circuitDistributeWorkOrder);
