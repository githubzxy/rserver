...
import com.enovell.yunwei.km_micor_service.service.dayToJobManageService.InspectionSuperiorsService;
import com.enovell.yunwei.km_micor_service.util.JsonUtil;

@RestController
@RequestMapping("/inspectionSuperiorsAction")
public class InspectionSuperiorsAction {
	@Resource(name = "inspectionSuperiorsService")
    private InspectionSuperiorsService service;
