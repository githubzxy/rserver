...
import com.enovell.yunwei.km_micor_service.service.dayToJobManageService.CompletionOfKeyTasksService;
import com.enovell.yunwei.km_micor_service.util.JsonUtil;

@RestController
@RequestMapping("/completionOfKeyTasksAction")
public class CompletionOfKeyTasksAction {
	@Resource(name = "completionOfKeyTasksService")
    private CompletionOfKeyTasksService service;
    ...
    public ResultMsg addDoc(@RequestParam(name = "noticeDateStr") String noticeDateStr,
    						@RequestParam(name = "workProgram") String workProgram,
...
//                            @RequestParam(name = "userId") String userId,
        ...
        document.put("workProgram", workProgram);
    ...
    public ResultMsg updateDoc( @RequestParam("id") String id,
        ...
        doc.put("workProgram", workProgram);
