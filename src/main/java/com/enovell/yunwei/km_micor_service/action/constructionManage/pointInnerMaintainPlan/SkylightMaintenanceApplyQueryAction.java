...
import com.enovell.yunwei.km_micor_service.service.constructionManage.pointInnerMaintainPlan.SkylightMaintenanceApplyQueryService;

@RestController
@RequestMapping("/skylightMaintenanceApplyQueryAction")
public class SkylightMaintenanceApplyQueryAction {
	@Resource(name = "skylightMaintenanceApplyQueryService")
    private SkylightMaintenanceApplyQueryService service;
