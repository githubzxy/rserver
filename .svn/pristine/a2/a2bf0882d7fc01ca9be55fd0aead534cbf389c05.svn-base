package com.enovell.yunwei.km_micor_service.action.emergencyManage.exerciseScheme;
 ...
 */
@RestController
@RequestMapping("/exerciseSchemeAction")
public class ExerciseSchemeAction {

	@Resource(name = "exerciseSchemeService")
	private ExerciseSchemeService service;
	/**
	 * 
	...
	public ResultMsg addTechnicalInfo(HttpServletRequest request,
		...
		document.put("createUser", createUser);
	...
	public GridDto<Document> getAllTechnicalInfoInfos(
		...
		result.setResults(service.findAllDocumentCount(collectionName,depart,createStartDate, createEndDate,currentDay,userId));
		result.setRows(service.findAllDocument(collectionName,depart,createStartDate, createEndDate, start, limit,currentDay,userId));
		return result;
	}
