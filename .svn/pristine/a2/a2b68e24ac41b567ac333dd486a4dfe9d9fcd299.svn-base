 ...
 * @date 19-6-19
 */
define('kmms/technicalManagement/communicationResumeManage/dispatch/stationAdd',
		   ['bui/common',
    ...
    var stationAdd = BUI.Overlay.Dialog.extend({
        ...
        ATTRS : {
            id : {value : 'stationDialog'},
            elAttrs : {value: {id:"stationAdd"}},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('stationAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/dispatchAction/station/addDoc");
                    xhr.send(formData);
