 ...
 * @date 19-06-17
 */
define('kmms/technicalManagement/communicationResumeManage/wireless/handAdd',
		   ['bui/common',
    ...
    var IrontowerAdd = BUI.Overlay.Dialog.extend({
        ...
        ATTRS : {
            id : {value : 'handDialog'},
            elAttrs : {value: {id:"handAdd"}},
            title:{value:'新增手持设备-06'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('handAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/wirelessAction/addDocHand");
                    xhr.send(formData);
