...
/**   
 * 文件名：YearMonthWorkShopDto.java    
 * @author quyy  
 * 日期：2017年9月20日 上午9:49:02      
 *   
 */
...
/**      
 * 项目名称：RINMS2MAIN
 * 类名称：YearMonthWorkShopDto   
 * 类描述: 年月报表（车间dto）
 * 创建人：quyy 
 * 创建时间：2017年9月20日 上午9:49:02 
 *    
 */

public class YearMonthWorkShopDto implements Serializable{
	...
	private List<YearMonthWorkShopDto> children;
	...
	public List<YearMonthWorkShopDto> getChildren() {
		return children;
	}

	public void setChildren(List<YearMonthWorkShopDto> children) {
		this.children = children;
	}

	@Override
	public String toString() {
		return "YearMonthWorkShopDto [id=" + id + ", name=" + name + ", year=" + year + ", orgId=" + orgId
				+ ", orgName=" + orgName + ", status=" + status + ", reportTime=" + reportTime + ", failReason="
				+ failReason + ", exist=" + exist + ", attachPath8_1=" + attachPath8_1 + ", attachName8_1="
				+ attachName8_1 + ", attachPathExecute8_1=" + attachPathExecute8_1 + ", attachPath8_2=" + attachPath8_2
				+ ", attachName8_2=" + attachName8_2 + ", attachPathExecute8_2=" + attachPathExecute8_2
				+ ", attachPath8_3=" + attachPath8_3 + ", attachName8_3=" + attachName8_3 + ", attachPathExecute8_3="
				+ attachPathExecute8_3 + ", attachPath8_4=" + attachPath8_4 + ", attachName8_4=" + attachName8_4
				+ ", attachPathExecute8_4=" + attachPathExecute8_4 + ", isdept=" + isdept + ", children=" + children
				+ "]";
	}
