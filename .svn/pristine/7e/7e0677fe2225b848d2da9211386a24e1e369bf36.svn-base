 ...
 * @date 18-11-23
 */
define('kmms/pointOuterMaintainPlanMangement/pointOuterMaintainPlan/pointOuterMaintainPlanAdd',['bui/common','common/form/FormContainer',
    'bui/form','common/org/OrganizationPicker'],function(r){
    var BUI = r('bui/common'),
    	OrganizationPicker = r('common/org/OrganizationPicker'),
        FormContainer= r('common/form/FormContainer');
    var PointOuterMaintainPlanAdd = BUI.Overlay.Dialog.extend({
        ...
        _initFormContainer : function(){
            ...
            var form = new FormContainer({
                id : 'pointOuterMaintainPlanAddForm',
                colNum : colNum,
...
//                elStyle:{overflowY:'scroll',height:'400px'}
        ...
        ATTRS : {
            id : {value : 'pointOuterMaintainPlanAddDialog'},
            elAttrs : {value: {id:"pointOuterMaintainPlanAdd"}},
            title:{value:'新增'},
            width:{value:610},
            height:{value:240},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('pointOuterMaintainPlanAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
    ...
    return PointOuterMaintainPlanAdd;
});