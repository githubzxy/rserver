 ...
 */
@RestController
@RequestMapping("/conferenceAction")
public class ConferenceAction {
	...
	public ResultMsg addDoc(
			...
			@RequestParam(name = "portConfQuantity") String portConfQuantity, 
			@RequestParam(name = "portUseQuantity") String portUseQuantity, 
			@RequestParam(name = "portInQuantity") String portInQuantity, 
		...
		document.put("publicType", "conference_mcu");
		...
		document.put("portConfQuantity", portConfQuantity); 
		document.put("portUseQuantity", portUseQuantity); 
		document.put("portInQuantity", portInQuantity); 
	...
	public ResultMsg addDocOfother(
		...
		document.put("creatDateStr", creatDateStr);
		document.put("publicType", "conference_other");
		document.put("source", "0");//此字段用于判断是否为导入的表格中的数据
		document.put("workshop", workshop);
		document.put("workArea", workArea);
		document.put("combinationClass", combinationClass);
