 ...
 * @date 19-1-21
 */
define('kmms/constructionManage/pointInnerMaintainPlan/communicationNetwork/communicationNetworkSkillAuditEdit',
	[
	 	'bui/common',
	 	'bui/form',
		'bui/calendar',
...
//                }
            ...
            success:{
            	value : function(){
	        		...
	        		data.id=_self.get('shiftId');
	        		var pl = new PostLoad({
        				url : '/zuul/kmms/communicationNetworkSkillAuditAction/editDoc',
        				el : _self.get('el'),
        				loadMsg : '上传中...'
        			}); 
        			pl.load(data, function(e){
