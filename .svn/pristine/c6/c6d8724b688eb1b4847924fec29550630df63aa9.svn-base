 ...
 * @date 2019-6-17
 */
define('kmms/technicalManagement/communicationResumeManage/data/routerAdd',
		   ['bui/common',
    ...
    var RouterAdd = BUI.Overlay.Dialog.extend({
        ...
        ATTRS : {
            id : {value : 'routerDialog'},
            elAttrs : {value: {id:"routerAdd"}},
            title:{value:'新增路由器-01'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('routerAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/dataAction/addDocRouter");
                    xhr.send(formData);
