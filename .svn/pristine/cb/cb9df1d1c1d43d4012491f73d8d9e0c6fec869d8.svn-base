...
import com.enovell.yunwei.km_micor_service.service.productionManage.taskManage.TaskApproveService;

@RestController
@RequestMapping("/taskApproveAction")
public class TaskApproveAction {
	@Resource(name = "taskApproveService")
    private TaskApproveService service;
