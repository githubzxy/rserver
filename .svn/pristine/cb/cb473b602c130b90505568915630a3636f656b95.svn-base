 ...
 * @date 19-6-19
 */
define('kmms/technicalManagement/communicationResumeManage/wired/wiredInfo',['bui/common',
	...
	var wiredInfo = BUI.Overlay.Dialog.extend({
