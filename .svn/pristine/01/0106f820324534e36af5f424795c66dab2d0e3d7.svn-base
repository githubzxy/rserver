 ...
 * @date 19-2-27
 */
define('kmms/securityManage/accidentTroubleObstacleManage/accidentTroubleObstacleQuery/accidentTroubleObstacleQueryDetailZa',
		[
		 	'bui/common',
	...
	var AccidentTroubleObstacleQueryDetailZa = BUI.Overlay.Dialog.extend({
...
//				},	
			...
			var form = new FormContainer({
				id : 'accidentTroubleObstacleQueryDetailZaShow',
				colNum : colNum,
		...
		ATTRS : {
			id : {value : 'accidentTroubleObstacleQueryDetailZaDialog'},
			title:{value:'详情'},
            width:{value:650},
            height:{value:500},
	...
	return AccidentTroubleObstacleQueryDetailZa;
});