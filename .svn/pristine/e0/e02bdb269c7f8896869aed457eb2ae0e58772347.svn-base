 ...
 * 详情模块
 */
define('kmms/technicalManagement/communicationResumeManage/wireless/radioInfo',['bui/common',
	...
	var radioInfo = BUI.Overlay.Dialog.extend({
		            ...
		            var childs = [
		            	{
                            ...
                            label : '制式：',
                            itemColspan : 1,
                            item : '<input type="text" name="phaseAlternatingLine" id="phaseAlternatingLine" style="width:98.5%" readOnly/>'
                        },{
                            label : '四频组序号：',
                            itemColspan : 1,
                            item : '<input type="text" name="quadNumber" id="quadNumber" style="width:99%" readOnly/>'
                        },{
                            label : '大三角：',
                            itemColspan : 1,
                            item : '<input type="text" name="grandTrine" id="grandTrine" style="width:99%" readOnly/>'
                        },{
                            label : '车次号校验：',
                            itemColspan : 1,
                            item : '<input type="text" name="trainNumberCheck" id="trainNumberCheck" style="width:99%" readOnly/>'
                        },{
                            label : '调度命令传送：',
                            itemColspan : 1,
                            item : '<input type="text" name="dispatchCommand" id="dispatchCommand" style="width:98.5%" readOnly/>'
                        },{
		                    label : '设备厂家：',
		                    itemColspan : 1,
