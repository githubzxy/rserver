 ...
 * @date 18-11-22
 */
define('kmms/securityRiskManagement/database/SecurityRiskDatabasePage',[
	'bui/common','bui/data','bui/grid',
    'common/grid/SearchGridContainer',
    'bui/calendar',
    'common/org/OrganizationPicker',
    'common/data/PostLoad',
    'kmms/securityRiskManagement/database/SecurityRiskDatabaseAdd',
    'kmms/securityRiskManagement/database/SecurityRiskDatabaseEdit',
    'kmms/securityRiskManagement/database/SecurityRiskDatabaseInfo'
    ],function (r) {
    var BUI = r('bui/common'),
    	...
    	SecurityRiskDatabaseAdd = r('kmms/securityRiskManagement/database/SecurityRiskDatabaseAdd'),
    	SecurityRiskDatabaseEdit = r('kmms/securityRiskManagement/database/SecurityRiskDatabaseEdit'),
    	SecurityRiskDatabaseInfo = r('kmms/securityRiskManagement/database/SecurityRiskDatabaseInfo'),
        SearchGridContainer = r('common/grid/SearchGridContainer');

    var SecurityRiskDatabasePage = BUI.Component.Controller.extend(
        {
            ...
            bindUI:function(){
                ...
                $('.addBtn').on('click',function(e){
                    var addDialog = new SecurityRiskDatabaseAdd({
                ...
                table.on('cellclick',function(ev){
                    ...
                    if(target.hasClass('infoBtn')){
                        var infoDialog = new SecurityRiskDatabaseInfo({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                            shiftId:docId
                        });
                    ...
                    if(target.hasClass('editBtn')){
                        var editDialog = new SecurityRiskDatabaseEdit({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                            shiftId:docId
                        });
        ...
        },
        {
            ATTRS : {
                 ...
                 * 存储表名(安全风险数据库表名)
                 */
                collectionName : {value:'securityRiskDatabase'}
            }
        });
    return SecurityRiskDatabasePage;
});