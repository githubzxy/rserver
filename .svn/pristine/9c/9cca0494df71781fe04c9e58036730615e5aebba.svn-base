 ...
 * @date 19-1-21
 */
define('kmms/dayToJobManagement/pointOuterMaintainManagement/pointOuterMaintainApplyEdit',
	[
	 	'bui/common',
	 	'bui/form',
		'bui/calendar',
    ...
    var PointOuterMaintainApplyEdit = BUI.Overlay.Dialog.extend({
...
//				},
            ...
            var form = new FormContainer({
                id : 'pointOuterMaintainApplyEditForm',
                colNum : colNum,
        ...
        ATTRS : {
            id : {value : 'pointOuterMaintainApplyEditDialog'},
            elAttrs : {value: {id:"pointOuterMaintainApplyEdit"}},
            title:{value:'修改'},
            width:{value:650},
            height:{value:500},
            ...
            successApply:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('pointOuterMaintainApplyEditForm');
                    //获取上传文件
    ...
    return PointOuterMaintainApplyEdit;
});