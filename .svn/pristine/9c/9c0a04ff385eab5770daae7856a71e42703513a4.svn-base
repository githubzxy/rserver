 ...
 * 详情模块
 */
define('kmms/technicalManagement/communicationResumeManage/wireless/mobileInfo',['bui/common',
				...
				url:'/kmms/wirelessAction/findById',
          		...
          		success:function(res){
					...
					if(data){
						...
						$("#formContainer #site_vehicleType").val(data.site_vehicleType);
						$("#formContainer #site_vehicleCode").val(data.site_vehicleCode);
						$("#formContainer #site_vehicleNumber").val(data.site_vehicleNumber);
		            ...
		            var childs = [
		            	{
							...
							label : '安装位置-车型：',
							itemColspan : 1,
							item : '<input type="text" name="site_vehicleType" id="site_vehicleType" style="width:99%" readOnly/>'
						},{
							label : '安装位置-车型代码\\车辆型号代码：',
							itemColspan : 1,
							item : '<input type="text" name="site_vehicleCode" id="site_vehicleCode" style="width:99%" readOnly/>'
						},{
							label : '安装位置-机车号\\车辆号：',
							itemColspan : 1,
							item : '<input type="text" name="site_vehicleNumber" id="site_vehicleNumber" style="width:99%" readOnly/>'
						},{
		                    label : '资产归属：',
		                    itemColspan : 1,
