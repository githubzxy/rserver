 ...
 * 重点工作完成情况详情模块
 */
define('kmms/dayToJobManagement/completionOfKeyTasks/completionOfKeyTasksInfo',['bui/common','common/form/FormContainer',
	'common/uploader/ViewUploader','common/data/PostLoad'],function(r){
	var BUI = r('bui/common'),
		Uploader = r('common/uploader/ViewUploader'),
		FormContainer= r('common/form/FormContainer');
	var completionOfKeyTasksInfo = BUI.Overlay.Dialog.extend({
		...
		_getShowData : function(){
			...
			$.ajax({
				url:'/kmms/completionOfKeyTasksAction/findById',
          		...
          		success:function(res){
					...
					if(data){
						 $("#formContainer #noticeDateStr").val(data.noticeDateStr);
	                        $("#formContainer #workProgram").val(data.workProgram);
            ...
            var childs = [
                          {
                              ...
                              label : '工作项目：',
                              itemColspan : 1,
                              item : '<input type="text" name="workProgram" id="workProgram" style="border:none;width:98%;height:100%;"  readonly="readonly"/>'
                          },{
                              label : '完成情况：',
                              itemColspan : 2,
	...
	return completionOfKeyTasksInfo;
});