...
import com.enovell.yunwei.km_micor_service.service.dayToJobManageService.OutsideWorkConditionService;
import com.enovell.yunwei.km_micor_service.util.JsonUtil;

@RestController
@RequestMapping("/outsideWorkConditionAction")
public class OutsideWorkConditionAction {
	@Resource(name = "outsideWorkConditionService")
    private OutsideWorkConditionService service;
