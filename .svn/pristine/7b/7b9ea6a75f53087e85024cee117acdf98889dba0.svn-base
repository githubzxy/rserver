 ...
 * @date 19-3-5
 */
define('kmms/productionManage/circuitWorkOrderManage/circuitWorkOrderApprove/circuitWorkOrderApproveAdd',
		[
		 	'bui/common',
		 	'bui/form',
		 	'bui/select',
    ...
    var CircuitWorkOrderApproveAdd = BUI.Overlay.Dialog.extend({
        ...
        _getShowData : function(){
            ...
            $.ajax({
                url:'/kmms/circuitWorkOrderApproveAction/findById',
        ...
        _initFormContainer : function(){
            ...
            var form = new FormContainer({
                id : 'circuitWorkOrderApproveAddForm',
                colNum : colNum,
...
//                elStyle:{overflowY:'scroll',height:'400px'}
        ...
        ATTRS : {
            id:{value : 'circuitWorkOrderApproveAddDialog'},
            elAttrs:{value: {id:"circuitWorkOrderApproveAdd"}},
            title:{value:'审批'},
            width:{value:650},
            height:{value:560},
            ...
            pass:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('circuitWorkOrderApproveAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
	        		...
	        		var pl = new PostLoad({
        				url : '/zuul/kmms/circuitWorkOrderApproveAction/updateApproveDoc',
        				el : _self.get('el'),
        				loadMsg : '上传中...'
        			}); 
    ...
    return CircuitWorkOrderApproveAdd;
});