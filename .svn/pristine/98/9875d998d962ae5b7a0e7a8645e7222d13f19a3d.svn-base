 ...
 * 维修方案申请详情模块
 */
define('kmms/maintainManage/maintainPlan/maintainApply/maintainApplyInfo',['bui/common','common/form/FormContainer',
	'common/uploader/ViewUploader','common/data/PostLoad'],function(r){
	var BUI = r('bui/common'),
		ViewUploader = r('common/uploader/ViewUploader'),
		FormContainer= r('common/form/FormContainer');
	var maintainApplyInfo = BUI.Overlay.Dialog.extend({
...
//                elStyle:{overflowY:'scroll',height:'400px'}
		...
		ATTRS : {
			id : {value : 'maintainRepairInfoDialog'},
			title:{value:'详情'},
			width:{value:610},
            height:{value:450},
