 ...
 * @date 19-6-19
 */
define('kmms/technicalManagement/communicationResumeManage/dispatch/stationEdit',['bui/common',
	'common/form/FormContainer',
    'bui/form',
    ],function(r){
    var BUI = r('bui/common'),
        FormContainer= r('common/form/FormContainer');
    var stationEdit = BUI.Overlay.Dialog.extend({
...
//        },
            ...
            $.ajax({
                ...
                success:function(res){
                    ...
                    if(data){
                    	...
                    	$("#formContainer #numberSwitchboar").val(data.numberSwitchboar);
            ...
            var childs = [
            	 {
                     label : '所属交换机序号：',
                     itemColspan : 2,
                     item : '<input type="text" name="numberSwitchboar" style="width:98%" id="numberSwitchboar" data-rules="{required:true}"></input>'
                 },
            	{
                    label : '车间：',
                    redStarFlag : true,
        ...
        ATTRS : {
            id : {value : 'stationEditDialog'},
            elAttrs : {value: {id:"stationPointEdit"}},
            title:{value:'调度操作台-06'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('stationEditForm'),delData=_self.get('delData');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/dispatchAction/station/updateDoc");
                    xhr.send(formData);
