 ...
 * @date 18-11-21
 */
define('kmms/dayToJobManagement/superiorSafetyNotification/superiorSafetyNotificationPage',['bui/common','bui/data','bui/grid',
    'common/grid/SearchGridContainer','kmms/dayToJobManagement/superiorSafetyNotification/superiorSafetyNotificationAdd','bui/calendar','common/org/OrganizationPicker',
    'kmms/dayToJobManagement/superiorSafetyNotification/superiorSafetyNotificationEdit','kmms/dayToJobManagement/superiorSafetyNotification/superiorSafetyNotificationInfo','common/data/PostLoad'],function (r) {
    var BUI = r('bui/common'),
    	...
    	superiorSafetyNotificationAdd = r('kmms/dayToJobManagement/superiorSafetyNotification/superiorSafetyNotificationAdd'),
    	superiorSafetyNotificationEdit = r('kmms/dayToJobManagement/superiorSafetyNotification/superiorSafetyNotificationEdit'),
    	superiorSafetyNotificationInfo = r('kmms/dayToJobManagement/superiorSafetyNotification/superiorSafetyNotificationInfo'),
        SearchGridContainer = r('common/grid/SearchGridContainer');

    var superiorSafetyNotificationPage = BUI.Component.Controller.extend(
        {
...
//	                           url : '/kmms/superiorSafetyNotificationAction/removeDoc.cn',
//	                           el : _self.get('el'),
//	                           loadMsg : '删除中...'
//	                       });
...
//                });
                ...
                $('.addBtn').on('click',function(e){
                    var addDialog = new superiorSafetyNotificationAdd({
                ...
                table.on('cellclick',function(ev){
                    ...
                    if(target.hasClass('infoBtn')){
                        var infoDialog = new superiorSafetyNotificationInfo({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                            shiftId:docId
                        });
                    ...
                    if(target.hasClass('editBtn')){
                        var editDialog = new superiorSafetyNotificationEdit({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                            shiftId:docId
                        });
...
//                        	}
            ...
            _initStore:function () {
                ...
                var store = new Data.Store({
                    url : "/kmms/superiorSafetyNotificationAction/findAll.cn",
                    autoLoad : true ,
                    pageSize : 10,
                    proxy : {
                        method : 'post',
...
//                        }
        ...
        },
        {
            ATTRS : {
                 ...
                 * 存储表名
                 */
                collectionName : {value:'superiorSafetyNotification'}
            }
        });
    return superiorSafetyNotificationPage;
});