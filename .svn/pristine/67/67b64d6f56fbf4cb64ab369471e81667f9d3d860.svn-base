 ...
 * @date 19-6-19
 */
define('kmms/technicalManagement/communicationResumeManage/dispatch/dutyEdit',['bui/common',
	'common/form/FormContainer',
    'bui/form',
    ],function(r){
    var BUI = r('bui/common'),
        FormContainer= r('common/form/FormContainer');
    var dutyEdit = BUI.Overlay.Dialog.extend({
...
//        },
                ...
                success:function(res){
                    ...
                    if(data){
                    	_self._getWorkshops(data.workshop);
                    	 $("#formContainer #numbeDigital").val(data.numbeDigital);
                    	 $("#formContainer #numberDispatch").val(data.numberDispatch);
        ...
        ATTRS : {
            id : {value : 'dutyEditDialog'},
            elAttrs : {value: {id:"dutyPointEdit"}},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('dutyEditForm'),delData=_self.get('delData');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/dispatchAction/duty/updateDoc");
                    xhr.send(formData);
