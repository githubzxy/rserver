 ...
 * @date 18-11-21
 */
define('kmms/technicalManagement/communicationResumeManage/data/otherEdit',['bui/common',
...
//        },
            ...
            var childs = [
                {
                    ...
                    label : '容量单位：',
                    itemColspan : 1,
                    item : '<input type="text" name="capacityUnit" id="capacityUnit" style="width:99%"/>'
                },{
                    label : '容量：',
                    itemColspan : 1,
                    ...
                    label : '接入类型：',
                    itemColspan : 1,
                    item : '<input type="text" name="accessType" id="accessType" style="width:99%" />'
                },{
                    label : '固资编号：',
                    itemColspan : 1,
                    item : '<input type="text" name="fixedAssetsCode" id="fixedAssetsCode" style="width:98.5%" />'
                },{
                    label : '备注：',
                    itemColspan : 2,
                    item : '<textarea name="remark" id="remark" style="width:99%;height:50px"/></textarea>'
                }
            ];
        ...
        ATTRS : {
            id : {value : 'otherEditDialog'},
            elAttrs : {value: {id:"otherPointEdit"}},
            title:{value:'编辑其它设备-03'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('otherEditForm'),delData=_self.get('delData');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/dataAction/updateDocOther");
                    xhr.send(formData);
