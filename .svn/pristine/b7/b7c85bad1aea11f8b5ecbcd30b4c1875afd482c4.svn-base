 ...
 * 详情模块
 */
define('kmms/technicalManagement/communicationResumeManage/video/videoInfo',['bui/common',
	...
	var videoInfo = BUI.Overlay.Dialog.extend({
