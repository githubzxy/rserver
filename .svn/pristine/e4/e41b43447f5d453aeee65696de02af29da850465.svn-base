 ...
 * @date 19-2-20
 */
define('kmms/maintainManage/maintainPlan/maintainQuery/maintainQueryPage',[
	'bui/common','bui/data','bui/grid',
    'common/grid/SearchGridContainer',
    'bui/calendar',
    'common/data/PostLoad',
    'kmms/maintainManage/maintainPlan/maintainQuery/maintainQueryInfo',
    ],function (r) {
    var BUI = r('bui/common'),
    	...
    	maintainQueryInfo = r('kmms/maintainManage/maintainPlan/maintainQuery/maintainQueryInfo'),
        SearchGridContainer = r('common/grid/SearchGridContainer');

    var maintainQueryPage = BUI.Component.Controller.extend(
        {
            ...
            bindUI:function(){
                ...
                table.on('cellclick',function(ev){
                    ...
                    if(target.hasClass('infoBtn')){
                        var infoDialog = new maintainQueryInfo({
            ...
            _initStore:function () {
                ...
                var store = new Data.Store({
                    url : "/kmms/maintainQueryAction/findAll.cn",
                    autoLoad : true ,
                    pageSize : 10,
                    proxy : {
                        method : 'post',
