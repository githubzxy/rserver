 ...
 * @date 18-11-23
 */
define('kmms/maintenanceRecord/maintenanceRecord/MaintenanceRecordEdit',[
	'bui/common','common/form/FormContainer',
   'bui/form','common/org/OrganizationPicker','bui/calendar'],function(r){
    var BUI = r('bui/common'),
    	Calendar = r('bui/calendar'),
    	OrganizationPicker = r('common/org/OrganizationPicker'),
        FormContainer= r('common/form/FormContainer');
    var MaintenanceRecordEdit = BUI.Overlay.Dialog.extend({
...
//                elStyle:{overflowY:'scroll',height:'400px'}
        ...
        ATTRS : {
            id : {value : 'maintenanceRecordEditDialog'},
            elAttrs : {value: {id:"maintenanceRecordEdit"}},
            title:{value:'编辑'},
            width:{value:610},
            height:{value:270},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('maintenanceRecordEditForm'),delData=_self.get('delData');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/maintenanceRecordAction/updateDoc");
                    xhr.send(formData);
