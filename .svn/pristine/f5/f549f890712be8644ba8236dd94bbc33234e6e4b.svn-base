 ...
 * @date 18-11-23
 */
define('kmms/securityRiskManagement/database/SecurityRiskDatabaseEdit',[
	'bui/common','common/form/FormContainer','common/org/OrganizationPicker',
   'bui/form'],function(r){
    var BUI = r('bui/common'),
    	OrganizationPicker = r('common/org/OrganizationPicker'),
        FormContainer= r('common/form/FormContainer');
    var SecurityRiskDatabaseEdit = BUI.Overlay.Dialog.extend({
        ...
        _initFormContainer : function(){
            ...
            var form = new FormContainer({
                id : 'securityRiskDatabaseEditForm',
                colNum : colNum,
...
//                elStyle:{overflowY:'scroll',height:'400px'}
        ...
        ATTRS : {
            id : {value : 'securityRiskDatabaseEditDialog'},
            elAttrs : {value: {id:"securityRiskDatabaseEdit"}},
            title:{value:'编辑'},
            width:{value:610},
            height:{value:240},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('securityRiskDatabaseEditForm'),delData=_self.get('delData');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
    ...
    return SecurityRiskDatabaseEdit;
});