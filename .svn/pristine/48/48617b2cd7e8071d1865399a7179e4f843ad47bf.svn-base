...
import com.enovell.yunwei.km_micor_service.util.communicationResumeManage.ReadDispatchTrunk;
 ...
 * 类名称：Trunk   
 * 类描述: 调度通信系统-干线调度导入excel实现 
 * 创建人：zhouxingyu
 * 创建时间：2019年6月19日 下午4:30:04
 * 修改人：zhouxingyu 
 * 修改时间：2019年6月19日 下午4:30:04   
 *
 */
@Service("trunk")
public class Trunk implements DispatchService{
	...
	@Override
	 public ResultMsg importDispatchTrunk(String publicType, MultipartFile file, String userId, String orgId) {
	    	ReadDispatchTrunk readExcel =new ReadDispatchTrunk();
	    	List<DispatchTrunkDto> fdpList = readExcel.getExcelInfo(file);
...
//		    	 //删除数据库中来源为上一次导入的数据
		 ...
		 * @return 
		 */
		public Map<String,Object> checkNullRow(List<DispatchTrunkDto> fdpList) {
		...
		public Map<String,Object> checkWorkshopAndWorkArea(List<DispatchTrunkDto> fdpList) {
			 Map<String, Object> map = new HashMap<String, Object>();
	        //获取所有车间
