...
public class PointInnerSecondMaintainApproveServiceImpl implements  PointInnerSecondMaintainApproveService{
	...
	@Override
	public long findAllDocumentCount(String collectionName, String orgId, String currentDay, String constructionProject, String flowState, String startUploadDate, String endUploadDate,String submitOrgName) {
		 try(MongoClient mc = new MongoClient(mongoHost,mongoPort)) {
	            MongoDatabase md = mc.getDatabase(mongoDatabase);
	            Bson filter = getFilter(orgId, currentDay, constructionProject, flowState, startUploadDate, endUploadDate,submitOrgName);
	            return  md.getCollection(collectionName).count(filter);
	        }
	}

	@Override
	public List<Document> findAllDocument(String collectionName, String orgId, String currentDay, String constructionProject, String flowState, String startUploadDate, String endUploadDate, String submitOrgName,int start, int limit) {
	 ...
	 * @return 查询条件 Bson
	 */
    private Bson getFilter(String orgId, String currentDay, String constructionProject, String flowState, String startUploadDate, String endUploadDate,String submitOrgName) {
        ...
        if(StringUtils.isNotBlank(submitOrgName)){
        	filter = Filters.and(filter,Filters.eq("submitOrgName",submitOrgName));
        }
