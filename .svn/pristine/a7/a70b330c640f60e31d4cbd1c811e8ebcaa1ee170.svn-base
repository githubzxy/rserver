...
public class CommonPageServiceImpl implements CommonPageService {
    ...
    @Override
    public List<Document> findAllDocument(String collectionName, String name, Date startUploadDate, Date endUploadDate,String orgId, int start, int limit,String auditStatus) {
        List<Document> results = new ArrayList<>();
        try(MongoClient mc = new MongoClient(mongoHost,mongoPort)){
            MongoDatabase md = mc.getDatabase(mongoDatabase);
            Bson filter = getFilter(name,startUploadDate,endUploadDate,orgId,auditStatus);
    ...
    @Override
    public long findAllDocumentCount(String collectionName, String name, Date startUploadDate, Date endUploadDate,String orgId,String auditStatus) {
        try(MongoClient mc = new MongoClient(mongoHost,mongoPort)) {
            MongoDatabase md = mc.getDatabase(mongoDatabase);
            Bson filter = getFilter(name, startUploadDate, endUploadDate,orgId,auditStatus);
