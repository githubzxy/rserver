 ...
 * @date 19-6-19
 */
define('kmms/technicalManagement/communicationResumeManage/conference/mcuInfo',['bui/common',
	...
	var mcuInfo = BUI.Overlay.Dialog.extend({
		            ...
		            var childs = [
		            	{
		                    ...
		                    redStarFlag : true,
		                    itemColspan : 1,
		                    item : '<input type="text" name="capacity" id="capacity" style="width:99%" readOnly/>'
		                },
		                {
		                    label : '设备厂家：',
		                    itemColspan : 1,
		                    ...
		                    redStarFlag : true,
		                    itemColspan : 1,
		                    item : '<input type="text" name="portConfQuantity" id="deviceOperationStatus" style="width:98.5%" readOnly/>'
		                },{
		                    label : 'MCU端口使用数量：',
		                    redStarFlag : true,
		                    itemColspan : 1,
		                    item : '<input type="text" name="portUseQuantity" id="deviceOperationStatus" style="width:98.5%" readOnly/>'
		                },{
		                    label : '接入会议终端数量：',
		                    redStarFlag : true,
		                    itemColspan : 1,
		                    item : '<input type="text" name="portInQuantity" id="deviceOperationStatus" style="width:98.5%" readOnly/>'
		                },
		                {
		                    label : '固资编号：',
		                    itemColspan : 2,
