 ...
 * @date 19-1-21
 */
define('kmms/constructionManage/pointInnerMaintainPlan/skylightMaintenanceRestApplyEdit',
	[
	 	'bui/common',
	 	'bui/form',
		'bui/calendar',
    ...
    var SkylightMaintenanceRestApplyEdit = BUI.Overlay.Dialog.extend({
...
//                    xhr.open("POST", "/zuul/kmms/skylightMaintenanceApplyAction/updateDoc");
//                    xhr.send(formData);
...
//            		}
    ...
    return SkylightMaintenanceRestApplyEdit;
});