 ...
 * 维修方案查询详情模块
 */
define('kmms/maintainManage/maintainPlan/maintainQuery/maintainQueryInfo',['bui/common','common/form/FormContainer',
	'common/uploader/ViewUploader','common/data/PostLoad'],function(r){
	var BUI = r('bui/common'),
		ViewUploader = r('common/uploader/ViewUploader'),
		FormContainer= r('common/form/FormContainer');
	var maintainQueryInfo = BUI.Overlay.Dialog.extend({
...
//                elStyle:{overflowY:'scroll',height:'400px'}
		...
		ATTRS : {
			id : {value : 'maintainQueryInfoDialog'},
			title:{value:'详情'},
			width:{value:610},
            height:{value:450},
