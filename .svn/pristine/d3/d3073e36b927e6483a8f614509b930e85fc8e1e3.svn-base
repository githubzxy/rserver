 ...
 * @date 19-1-22
 */
define('kmms/constructionManage/pointInnerMaintainPlan/skylightMaintenanceSkillAuditPage',
	[
	 	'bui/common',
	 	'bui/data',
	 	'bui/grid',
	 	...
	 	'kmms/constructionManage/pointInnerMaintainPlan/skylightMaintenanceSkillAuditAdd',
    ...
    var BUI = r('bui/common'),
    	...
    	skylightMaintenanceSkillAuditAdd = r('kmms/constructionManage/pointInnerMaintainPlan/skylightMaintenanceSkillAuditAdd'),
    ...
    var SkylightMaintenanceSkillAuditPage = BUI.Component.Controller.extend(
        {
...
//    				$("#selectType").val("");
                ...
                table.on('cellclick',function(ev){
                    ...
                    if(target.hasClass('auditBtn')){
                        var editDialog = new skylightMaintenanceSkillAuditAdd({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
            ...
            _initStore:function () {
                ...
                var store = new Data.Store({
                    url : "/kmms/skylightMaintenanceSkillAuditAction/findAll.cn",
                    autoLoad : true ,
                    pageSize : 20,
                    proxy : {
                        method : 'post',
...
//                    permissionStore : _self._initPermissionStore()
    ...
    return SkylightMaintenanceSkillAuditPage;
});