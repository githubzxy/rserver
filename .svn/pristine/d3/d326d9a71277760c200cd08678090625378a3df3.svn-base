 ...
 * @date 19-1-22
 */
define('kmms/constructionManage/pointInnerMaintainPlan/communicationNetwork/communicationNetworkSkillAuditPage',
	[
	 	'bui/common',
	 	'bui/data',
	 	'bui/grid',
	 	...
	 	'kmms/constructionManage/pointInnerMaintainPlan/communicationNetwork/communicationNetworkSkillAuditAdd',
	 	'kmms/constructionManage/pointInnerMaintainPlan/communicationNetwork/communicationNetworkSkillAuditEdit',
    ...
    var BUI = r('bui/common'),
    	...
    	communicationNetworkSkillAuditAdd = r('kmms/constructionManage/pointInnerMaintainPlan/communicationNetwork/communicationNetworkSkillAuditAdd'),
    	communicationNetworkSkillAuditEdit = r('kmms/constructionManage/pointInnerMaintainPlan/communicationNetwork/communicationNetworkSkillAuditEdit'),
    ...
    var communicationNetworkSkillAuditPage = BUI.Component.Controller.extend(
        {
...
//    				$("#selectType").val("");
                ...
                table.on('cellclick',function(ev){
                    ...
                    if(target.hasClass('editBtn')){
                        var editDialog = new communicationNetworkSkillAuditEdit({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                            shiftId:docId
                        });
                    ...
                    if(target.hasClass('auditBtn')){
                        var editDialog = new communicationNetworkSkillAuditAdd({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                ...
                var columns = [
                	{
                        ...
                        renderer:function (value) {
                        	var button = '';
                        	if(value=='1'){
                        		button = '<span  class="grid-command auditBtn">复核</span>'+
            ...
            _initStore:function () {
                ...
                var store = new Data.Store({
                    url : "/kmms/communicationNetworkSkillAuditAction/findAll.cn",
                    autoLoad : true ,
                    pageSize : 20,
                    proxy : {
                        method : 'post',
...
//                    permissionStore : _self._initPermissionStore()
    ...
    return communicationNetworkSkillAuditPage;
});