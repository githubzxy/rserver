 ...
 * 施工计划申请详情模块
 */
define('kmms/constructionManage/constructionPlan/constructionApply/constructionApplyInfo',['bui/common','common/form/FormContainer',
	'common/uploader/ViewUploader','common/data/PostLoad'],function(r){
	var BUI = r('bui/common'),
		ViewUploader = r('common/uploader/ViewUploader'),
		FormContainer= r('common/form/FormContainer');
	var ConstructionApplyInfo = BUI.Overlay.Dialog.extend({
