 ...
 * @date 19-2-20
 */
define('kmms/maintainManage/maintainPlan/maintainApply/maintainApplyEdit',[
   ...
   'bui/form'],function(r){
    ...
    var maintainApplyEdit = BUI.Overlay.Dialog.extend({
...
//                elStyle:{overflowY:'scroll',height:'400px'}
        ...
        ATTRS : {
            id : {value : 'maintainApplyEditDialog'},
            elAttrs : {value: {id:"maintainApplyEdit"}},
            title:{value:'编辑'},
            width:{value:610},
            height:{value:265},
            contextPath : {},
            ...
            successApply:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('maintainApplyEditForm'),delData=_self.get('delData');
                    //获取上传文件
	        		...
	        		var pl = new PostLoad({
        				url : '/zuul/kmms/maintainApplyAction/updateDoc',
        				el : _self.get('el'),
        				loadMsg : '上传中...'
        			}); 
...
//                    xhr.open("POST", "/zuul/kmms/maintainApplyAction/updateDoc");
//                    xhr.send(formData);
