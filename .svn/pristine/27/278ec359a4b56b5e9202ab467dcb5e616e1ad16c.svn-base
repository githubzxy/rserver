 ...
 * @date 19-4-3
 */
define('kmms/integratedManage/attendanceManage/attendanceManageCollectSum',
		[
			'bui/common',
			'bui/form',
			'bui/select',
    ...
    var attendanceManageCollectSum = BUI.Overlay.Dialog.extend({
...
//                },
        ...
        ATTRS : {
            ...
            elAttrs : {value : {id:"attendanceManageCollectSum"}},
            title:{value:'导出统计表'},
            width:{value:650},
            height:{value:135},
            contextPath : {},
            ...
            save:{
                value : function(){
                    ...
                    var pl = new PostLoad({
        				url : '/kmms/attendanceManageCollectQueryAction/sumCollectDoc',
        				el : _self.get('el'),
        				loadMsg : '导出中...'
        			}); 
    ...
    return attendanceManageCollectSum;
});