 ...
 * @date 18-11-21
 */
define('kmms/technicalManagement/communicationResumeManage/line/electricityAdd',
		   ['bui/common',
    ...
    var electricityAdd = BUI.Overlay.Dialog.extend({
        ...
        ATTRS : {
            id : {value : 'electricityDialog'},
            elAttrs : {value: {id:"electricityAdd"}},
            title:{value:'新增电缆属性'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('electricityAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/lineAction/electricityAddDoc");
                    xhr.send(formData);
