 ...
 * 详情模块
 */
define('kmms/technicalManagement/communicationResumeManage/wireless/wirelessInfo',['bui/common',
	...
	var wirelessInfo = BUI.Overlay.Dialog.extend({
				...
				url:'/kmms/wirelessAction/findById',
          		...
          		success:function(res){
					...
					if(data){
                        ...
                        $('#formContainer #useCapacity').val(data.useCapacity);
		            ...
		            var childs = [
		            	{
                            ...
                            label : '使用容量(GSM_R专用)：',
                            itemColspan : 1,
                            item : '<input type="text" name="useCapacity" id="useCapacity" style="width:99%" readOnly/>'
                        },{
                            label : '容量单位：',
                            itemColspan : 1,
