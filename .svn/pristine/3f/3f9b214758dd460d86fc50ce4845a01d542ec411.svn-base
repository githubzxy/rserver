 ...
 * @date 19-3-5
 */
define('kmms/productionManage/circuitWorkOrderManage/circuitWorkOrderApply/circuitWorkOrderApplyCheckEdit',
		[
		 	'bui/common',
		 	'bui/form',
		 	'bui/select',
    ...
    var CircuitWorkOrderApplyCheckEdit = BUI.Overlay.Dialog.extend({
...
//                	redStarFlag: true,
            ...
            var form = new FormContainer({
                id : 'circuitWorkOrderApplyCheckEditForm',
                colNum : colNum,
                formChildrens : childs,
                elStyle:{overflowY:'scroll',height:'290px'}
            });
        ...
        ATTRS : {
            id:{value : 'circuitWorkOrderApplyCheckEditDialog'},
            elAttrs:{value: {id:"circuitWorkOrderApplyCheckEdit"}},
            title:{value:'重发'},
            width:{value:650},
            height:{value:390},
            ...
            apply:{
                value : function(){
                    ...
                    var formAdd = _self.getChild('circuitWorkOrderApplyCheckEditForm');
                    //获取上传文件
	        		...
	        		if(uploadFileArr.length==0){
	        			Mask.maskElement('#circuitWorkOrderApplyCheckEdit');
	        			BUI.Message.Alert("请上传附件！",function(){
	        				Mask.unmaskElement('#circuitWorkOrderApplyCheckEdit');
	        			},'error');
	    	    	...
	    	    	if(checkedStatus){
	    	    		if(!data.receivePeople){
		        			...
		        			$("#circuitWorkOrderApplyCheckEdit .bui-message .bui-ext-close").css("display","none");
		        			return;
		        		}
	    	    	}
	        		...
	        		var pl = new PostLoad({
        				url : '/zuul/kmms/circuitWorkOrderApplyAction/remodifyDoc',
        				el : _self.get('el'),
        				loadMsg : '上传中...'
        			}); 
    ...
    return CircuitWorkOrderApplyCheckEdit;
});