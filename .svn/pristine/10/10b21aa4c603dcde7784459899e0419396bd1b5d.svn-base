...
public class WirelessRadioDto implements Serializable {


	private static final long serialVersionUID = -5332798113524670261L;
	...
	public String phaseAlternatingLine;
	public String quadNumber;
	public String grandTrine;
	public String trainNumberCheck;
	...
	public String getPhaseAlternatingLine() {
		return phaseAlternatingLine;
	}

	public void setPhaseAlternatingLine(String phaseAlternatingLine) {
		this.phaseAlternatingLine = phaseAlternatingLine;
	}
	...
	public String getGrandTrine() {
		return grandTrine;
	}

	public void setGrandTrine(String grandTrine) {
		this.grandTrine = grandTrine;
	}

	public String getTrainNumberCheck() {
		return trainNumberCheck;
	}

	public void setTrainNumberCheck(String trainNumberCheck) {
		this.trainNumberCheck = trainNumberCheck;
	}
	...
	public void setDispatchCommand(String dispatchCommand) {
	...
	public String toString() {
		return "WirelessRadioDto{" +
				...
				", phaseAlternatingLine='" + phaseAlternatingLine + '\'' +
				", quadNumber='" + quadNumber + '\'' +
				", grandTrine='" + grandTrine + '\'' +
				", trainNumberCheck='" + trainNumberCheck + '\'' +
