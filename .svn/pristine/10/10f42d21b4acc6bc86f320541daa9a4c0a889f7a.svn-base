 ...
 * @date 19-2-21
 */
define('kmms/constructionManage/constructionPlan/constructionApproved/constructionApprovedPage',
	[
	 	'bui/common',
	 	'bui/data',
	 	'bui/grid',
	 	...
	 	'kmms/constructionManage/constructionPlan/constructionApproved/constructionApprovedInfo',
	 	'kmms/constructionManage/constructionPlan/constructionApproved/constructionApprovedAdd',
	],function (r) {
    var BUI = r('bui/common'),
    	...
    	ConstructionApprovedInfo = r('kmms/constructionManage/constructionPlan/constructionApproved/constructionApprovedInfo'),
    	ConstructionApprovedAdd = r('kmms/constructionManage/constructionPlan/constructionApproved/constructionApprovedAdd');
    var ConstructionApprovedPage = BUI.Component.Controller.extend(
        {
            ...
            bindUI:function(){
                ...
                table.on('cellclick',function(ev){
                    ...
                    if(target.hasClass('infoBtn')){
                        var infoDialog = new ConstructionApprovedInfo({
                    ...
                    if(target.hasClass('auditBtn')){
                        var editDialog = new ConstructionApprovedAdd({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
            ...
            _initStore:function () {
                ...
                var store = new Data.Store({
                    url : "/kmms/constructApprovedAction/findAll.cn",
                    autoLoad : true ,
                    pageSize : 10,
                    proxy : {
                        method : 'post',
...
//                    permissionStore : _self._initPermissionStore()
        ...
        },
        {
            ATTRS : {
                ...
                collectionName : {value:'constructionPlan'}//存储表名
            }
        });
    return ConstructionApprovedPage;
});