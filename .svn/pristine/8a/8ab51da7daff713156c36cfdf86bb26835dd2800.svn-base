 ...
 * @date 19-6-19
 */
define('kmms/technicalManagement/communicationResumeManage/conference/mcuAdd',
		   ['bui/common',
    ...
    var mcuAdd = BUI.Overlay.Dialog.extend({
        ...
        ATTRS : {
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('mcuAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/conferenceAction/mcu/addDoc");
                    xhr.send(formData);
