 ...
 * 类名称：TaskWorkAreaReply   
 * 类描述:  查询临时任务的指定状态的数据的数量统计
 * 创建人：zhouxingyu
 * 创建时间：2019年5月23日 上午11:10:43
 * 修改人：zhouxingyu 
 * 修改时间：2019年5月23日 上午11:10:43   
 *
 */
@Service("taskWorkAreaReply")
public class TaskWorkAreaReply implements TodoCountCommonService{

	/**
     * 存储表名
     */
    private String COLLECTION_NAME = "IssueTaskOfWorkArea";
