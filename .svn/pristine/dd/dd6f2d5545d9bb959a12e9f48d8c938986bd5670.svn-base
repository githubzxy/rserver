 ...
 * 详情模块
 */
define('kmms/technicalManagement/communicationResumeManage/data/changerInfo',['bui/common',
			...
			var childs = [
				{
					...
					label : '报废日期：',
					itemColspan : 1,
					item : '<input type="text" readonly name="scrapDate" id="scrapDate" style="width:98.5%"/>'
				},{
					label : '应用层次：',
					itemColspan : 1,
					item : '<input type="text" name="applicationLevel" id="applicationLevel" style="width:99%" readOnly/>'
				},{
					label : '容量(端口数)：',
					itemColspan : 1,
