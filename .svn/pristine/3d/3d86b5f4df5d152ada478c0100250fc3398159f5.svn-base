 ...
 * @date 18-11-21
 */
define('kmms/dayToJobManagement/duanSafetyNotification/duanSafetyNotificationAdd',['bui/common','common/form/FormContainer',
    'bui/form','bui/calendar','common/data/PostLoad',],function(r){
    var BUI = r('bui/common'),
        Calendar = r('bui/calendar'),
        PostLoad = r('common/data/PostLoad'),
        FormContainer= r('common/form/FormContainer');
    var duanSafetyNotificationAdd = BUI.Overlay.Dialog.extend({
...
//                    formData.append('userId',_self.get('userId'));
                    ...
                    xhr.open("POST", "/kmms/duanSafetyNotificationAction/addDoc");
                    xhr.send(formData);
    ...
    return duanSafetyNotificationAdd;
});