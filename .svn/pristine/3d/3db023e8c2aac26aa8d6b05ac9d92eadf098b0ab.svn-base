 ...
 * @date 19-6-19
 */
define('kmms/technicalManagement/communicationResumeManage/trans/dwdmAdd',
		   ['bui/common',
    ...
    var DwdmAdd = BUI.Overlay.Dialog.extend({
        ...
        ATTRS : {
            id : {value : 'dwdmDialog'},
            elAttrs : {value: {id:"dwdmAdd"}},
            title:{value:'新增波分(DWDM)-01'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('dwdmAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/transAction/addDoc");
                    xhr.send(formData);
