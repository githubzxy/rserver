 ...
 * @date 18-11-21
 */
define('kmms/productionManage/overhaulRecord/overhaulRecordAdd',
		[
			'bui/common',
			'bui/form',
...
//                $("#machineRoom").empty();
                ...
                if(line){
                	_self._getMachineRoomsByLine(line);
                }else{
                	_self._getNullMachineRooms();
                }
