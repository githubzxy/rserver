 ...
 * @date 18-11-21
 */
define('kmms/dayToJobManagement/cadreDuty/cadreDutyAdd',['bui/common','common/form/FormContainer',
    'bui/form','bui/calendar','common/data/PostLoad',],function(r){
    var BUI = r('bui/common'),
        Calendar = r('bui/calendar'),
        PostLoad = r('common/data/PostLoad'),
        FormContainer= r('common/form/FormContainer');
    var cadreDutyAdd = BUI.Overlay.Dialog.extend({
        ...
        _initDate: function () {
            ...
            var postLoad = new PostLoad({
                url : '/kmms/duanSafetyNotificationAction/getSystemDate',
                el : _self.get('el'),
                loadMsg : '加载中...'
            });
...
//                    formData.append('userId',_self.get('userId'));
                    ...
                    xhr.open("POST", "/kmms/cadreDutyAction/addDoc");
                    xhr.send(formData);
