...
public class LineLineAndLightDto implements Serializable {
	private static final long serialVersionUID = -7149870893712868470L;
			...
			public String toString() {
				return "LineLineAndLightDto [workshop=" + workshop + ", workArea=" + workArea + ", combinationClass="
						...
						+ ", totalCapacity=" + totalCapacity + ", roadCapacity=" + roadCapacity + ", assetRatio="
