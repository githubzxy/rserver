 ...
 * @date 18-11-21
 */
define('kmms/technicalManagement/communicationResumeManage/line/lineAndLightEdit',['bui/common',
	'common/form/FormContainer',
    'bui/form',
    ],function(r){
    var BUI = r('bui/common'),
        FormContainer= r('common/form/FormContainer');
    var lineAndLightEdit = BUI.Overlay.Dialog.extend({
...
//        },
        ...
        ATTRS : {
            id : {value : 'lineAndLightEditDialog'},
            elAttrs : {value: {id:"lineAndLightPointEdit"}},
            title:{value:'编辑线缆与光缆配套(含电杆类)'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('lineAndLightEditForm'),delData=_self.get('delData');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/lineAction/lineAndLightUpdateDoc");
                    xhr.send(formData);
