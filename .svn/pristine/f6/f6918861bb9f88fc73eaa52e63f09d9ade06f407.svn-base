 ...
 * @date 18-11-21
 */
define('kmms/technicalManagement/communicationResumeManage/trans/numberTransAdd',
		   ['bui/common',
    ...
    var numberTransAdd = BUI.Overlay.Dialog.extend({
        ...
        ATTRS : {
            id : {value : 'numberTransDialog'},
            elAttrs : {value: {id:"numberTransAdd"}},
            title:{value:'新增准同步数字传输体系'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('numberTransAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/transAction/numberTransAddDoc");
                    xhr.send(formData);
