 ...
 * 详情模块
 */
define('kmms/technicalManagement/communicationResumeManage/trans/sdhInfo',['bui/common',
	...
	var sdhInfo = BUI.Overlay.Dialog.extend({
		            ...
		            var childs = [
		            	{
		                    ...
		                    label : '使用单位：',
		                    itemColspan : 1,
		                    item : '<input type="text" name="useUnit" id="useUnit" style="width:99%;height:60px;" readOnly />'
		                },{
		                    label : '总容量（折合622Mb/s个数）：',
		                    itemColspan : 1,
		                    item : '<input type="text" name="totalCapacity" id="totalCapacity" readOnly style="width:98.5%;height:60px;" />'
		                },{
		                    label : '路产容量（折合622Mb/s个数）：',
		                    itemColspan : 1,
		                    item : '<input type="text" name="roadCapacity" id="roadCapacity" readOnly style="width:99%;height:60px;" />'
		                },{
		                    label : '资产比例：',
		                    itemColspan : 1,
		                    item : '<input type="text" name="assetRatio" readOnly id="assetRatio" style="width:99%;height:60px;" />'
		                },{
		                    label : '出厂日期：',
		                    itemColspan : 1,
