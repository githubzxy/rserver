 ...
 * @date 19-1-21
 */
define('kmms/constructionManage/pointInnerMaintainPlan/skylightMaintenanceApplyQueryPage',
	[
	 	'bui/common',
	 	'bui/data',
	 	'bui/grid',
...
//    	skylightMaintenanceApplyExecute = r('kmms/constructionManage/pointInnerMaintainPlan/skylightMaintenanceApplyExecute');
    var SkylightMaintenanceApplyQueryPage = BUI.Component.Controller.extend(
        {
...
//    				$("#orgSelectId").val("");
            ...
            _initStore:function () {
                ...
                var store = new Data.Store({
                    url : "/kmms/skylightMaintenanceApplyQueryAction/findAll.cn",
                    autoLoad : true ,
                    pageSize : 20,
                    proxy : {
                        method : 'post',
...
//            	var _self = this;
    ...
    return SkylightMaintenanceApplyQueryPage;
});