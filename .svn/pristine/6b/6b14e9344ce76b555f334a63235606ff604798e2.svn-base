 ...
 * @date 18-11-21
 */
define('kmms/dayToJobManagement/duanTraceSafetyInfomation/duanTraceSafetyInfomationPage',['bui/common','bui/data','bui/grid',
    'common/grid/SearchGridContainer','kmms/dayToJobManagement/duanTraceSafetyInfomation/duanTraceSafetyInfomationAdd','bui/calendar',
    'kmms/dayToJobManagement/duanTraceSafetyInfomation/duanTraceSafetyInfomationEdit','kmms/dayToJobManagement/duanTraceSafetyInfomation/duanTraceSafetyInfomationInfo','common/data/PostLoad'],function (r) {
    var BUI = r('bui/common'),
        Data = r('bui/data'),
        Grid = r('bui/grid'),
        Calendar = r('bui/calendar'),
        PostLoad = r('common/data/PostLoad'),
        duanTraceSafetyInfomationAdd = r('kmms/dayToJobManagement/duanTraceSafetyInfomation/duanTraceSafetyInfomationAdd'),
        duanTraceSafetyInfomationEdit = r('kmms/dayToJobManagement/duanTraceSafetyInfomation/duanTraceSafetyInfomationEdit'),
        duanTraceSafetyInfomationInfo = r('kmms/dayToJobManagement/duanTraceSafetyInfomation/duanTraceSafetyInfomationInfo'),
        SearchGridContainer = r('common/grid/SearchGridContainer');

    var duanTraceSafetyInfomationPage = BUI.Component.Controller.extend(
        {
...
//	                           url : '/kmms/duanTraceSafetyInfomationAction/removeDoc.cn',
//	                           el : _self.get('el'),
//	                           loadMsg : '删除中...'
//	                       });
...
//                });
                ...
                $('.addBtn').on('click',function(e){
                    var addDialog = new duanTraceSafetyInfomationAdd({
                ...
                table.on('cellclick',function(ev){
                    ...
                    if(target.hasClass('infoBtn')){
                        var infoDialog = new duanTraceSafetyInfomationInfo({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                            shiftId:docId
                        });
          	  ...
          	  if(target.hasClass('delBtn')){
                    ...
                    if(target.hasClass('editBtn')){
                        var editDialog = new duanTraceSafetyInfomationEdit({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                            shiftId:docId
                        });
...
//                        	}
            ...
            _initStore:function () {
                ...
                var store = new Data.Store({
                    url : "/kmms/duanTraceSafetyInfomationAction/findAll.cn",
                    autoLoad : true ,
                    pageSize : 10,
                    proxy : {
                        method : 'post',
...
//                        }
        ...
        },
        {
            ATTRS : {
                 ...
                 * 存储表名
                 */
                collectionName : {value:'duanTraceSafetyInfomation'}
            }
        });
    return duanTraceSafetyInfomationPage;
});