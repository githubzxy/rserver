...
public class TaskWorkshopReplyAction {
    ...
    public ResultMsg replyDoc( 
    		...
    		@RequestParam(name = "IssueTaskOfWorkShopReply") String IssueTaskOfWorkShopReply,
    		@RequestParam(name = "IssueTaskOfWorkShop") String IssueTaskOfWorkShop,
    	...
    	Document document = service.findDocumentById(id,executiveOrgId,IssueTaskOfWorkShop);
    	...
    	service.addReplyDocument(newDocument, IssueTaskOfWorkShopReply, document, IssueTaskOfWorkShop);
