 ...
 * @date 19-1-22
 */
define('kmms/constructionManage/pointInnerMaintainPlan/skylightMaintenanceDispatchAuditPage',
	[
	 	'bui/common',
	 	'bui/data',
	 	'bui/grid',
	 	...
	 	'kmms/constructionManage/pointInnerMaintainPlan/skylightMaintenanceDispatchAuditAdd',
	 	'kmms/constructionManage/pointInnerMaintainPlan/skylightMaintenanceSkillAuditEdit',
    ...
    var BUI = r('bui/common'),
    	...
    	skylightMaintenanceDispatchAuditAdd = r('kmms/constructionManage/pointInnerMaintainPlan/skylightMaintenanceDispatchAuditAdd'),
    	skylightMaintenanceSkillAuditEdit = r('kmms/constructionManage/pointInnerMaintainPlan/skylightMaintenanceSkillAuditEdit'),
    	skylightMaintenanceApplyDetail = r('kmms/constructionManage/pointInnerMaintainPlan/skylightMaintenanceApplyDetail');
    var SkylightMaintenanceDispatchAuditPage = BUI.Component.Controller.extend(
        {
...
//    				$("#selectType").val("");
                ...
                table.on('cellclick',function(ev){
                    ...
                    if(target.hasClass('editBtn')){
                        var editDialog = new skylightMaintenanceSkillAuditEdit({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                            shiftId:docId
                        });
                    ...
                    if(target.hasClass('auditBtn')){
                        var editDialog = new skylightMaintenanceDispatchAuditAdd({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
            ...
            _initStore:function () {
                ...
                var store = new Data.Store({
                    url : "/kmms/skylightMaintenanceDispatchAuditAction/findAll.cn",
                    autoLoad : true ,
                    pageSize : 20,
                    proxy : {
                        method : 'post',
...
//                    permissionStore : _self._initPermissionStore()
    ...
    return SkylightMaintenanceDispatchAuditPage;
});