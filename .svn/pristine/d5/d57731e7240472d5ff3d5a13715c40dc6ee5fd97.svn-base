 ...
 * @date 19-06-17
 */
define('kmms/technicalManagement/communicationResumeManage/wireless/irontowerAdd',
		   ['bui/common',
    ...
    var IrontowerAdd = BUI.Overlay.Dialog.extend({
        ...
        ATTRS : {
            id : {value : 'irontowerDialog'},
            elAttrs : {value: {id:"irontowerAdd"}},
            title:{value:'新增铁塔-04'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('irontowerAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/wirelessAction/addDocIrontower");
                    xhr.send(formData);
