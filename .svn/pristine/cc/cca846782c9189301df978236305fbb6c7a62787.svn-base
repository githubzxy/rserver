...
//          _self.addChild(_self._initFormContainer());
        ...
        renderUI:function(){
			...
			$('.taskWorkshopReplyDetailDialogClass .bui-stdmod-body').attr("style","overflow-y:hidden;overflow-x:hidden;");
			$('.taskWorkshopReplyDetailDialogClass .bui-grid .bui-grid-body').attr("style","overflow-y:scroll;overflow-x:auto;height:300px;");
...
//			        },
		...
		_initGridData : function(){
			...
			var store = new Data.Store({
				url:'/kmms/taskWorkshopReplyAction/findIssueReplyAll',
				pageSize:10,
				params:{docId:_self.get('shiftId'),executiveOrgId:_self.get('executiveOrgId'),collectionName : "IssueTaskOfWorkShopReply"},
				proxy:{
					method:'post',
					dataType:'json'
				},
...
//                elStyle:{overflowY:'scroll',height:'260px'}
        ...
        ATTRS : {
            ...
            elCls : {value:'taskWorkshopReplyDetailDialogClass'},
            title:{value:'车间回复详情'},
            width:{value:800},
            height:{value:400},
