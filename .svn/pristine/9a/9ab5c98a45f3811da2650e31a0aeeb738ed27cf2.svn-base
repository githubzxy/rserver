 ...
 * @date 19-1-21
 */
define('kmms/constructionManage/pointInnerMaintainPlan/communicationNetwork/communicationNetworkApplyDetail',
		[
		 	'bui/common',
	...
	var communicationNetworkApplyDetail = BUI.Overlay.Dialog.extend({
		...
		_initFormContainer : function(){
			...
			var form = new FormContainer({
				id : 'communicationNetworkApplyDetailShow',
				colNum : colNum,
		...
		ATTRS : {
			id : {value : 'communicationNetworkApplyDetailDialog'},
			title:{value:'详情'},
            width:{value:650},
            height:{value:400},
	...
	return communicationNetworkApplyDetail;
});