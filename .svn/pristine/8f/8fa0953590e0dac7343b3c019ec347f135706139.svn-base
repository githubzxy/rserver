 ...
 * @date 19-06-17
 */
define('kmms/technicalManagement/communicationResumeManage/wireless/mobileEdit',['bui/common',
    ...
    var IrontowerEdit = BUI.Overlay.Dialog.extend({
        ...
        ATTRS : {
            id : {value : 'mobileEditDialog'},
            elAttrs : {value: {id:"mobilePointEdit"}},
            title:{value:'编辑移动设备-05'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('mobileEditForm'),delData=_self.get('delData');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/wirelessAction/updateDocMobile");
                    xhr.send(formData);
