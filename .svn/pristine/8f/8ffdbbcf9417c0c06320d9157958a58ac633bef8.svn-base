 ...
 * 详情模块
 */
define('kmms/technicalManagement/communicationResumeManage/line/pipelineInfo',['bui/common',
	...
	var pipelineInfo = BUI.Overlay.Dialog.extend({
