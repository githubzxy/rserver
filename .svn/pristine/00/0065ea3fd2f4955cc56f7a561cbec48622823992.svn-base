 ...
 * 详情模块
 */
define('kmms/securityRiskManagement/database/SecurityRiskDatabaseInfo',[
	...
	var SecurityRiskDatabaseInfo = BUI.Overlay.Dialog.extend({
		...
		_initFormContainer : function(){
			...
			var form = new FormContainer({
				id : 'securityRiskDatabaseInfoShow',
				colNum : colNum,
...
//                elStyle:{overflowY:'scroll',height:'400px'}
		...
		ATTRS : {
			id : {value : 'securityRiskDatabaseInfoDialog'},
	...
	return SecurityRiskDatabaseInfo;
});