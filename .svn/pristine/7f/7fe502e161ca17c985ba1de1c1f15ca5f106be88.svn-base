 ...
 * 详情模块
 */
define('kmms/technicalManagement/communicationResumeManage/trans/otherInfo',['bui/common',
		            ...
		            var childs = [
		            	{
		                    ...
		                    label : '接入类型：',
		                    itemColspan : 1,
		                    item : '<input type="text" name="accessType" id="accessType" style="width:98.5%" readOnly/>'
		                },{
		                    label : '设备厂家：',
		                    itemColspan : 1,
