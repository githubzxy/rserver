 ...
 * @date 18-11-21
 */
define('kmms/dayToJobManagement/duanSafetyNotification/duanSafetyNotificationEdit',['bui/common','common/form/FormContainer',
   'bui/form',],function(r){
    var BUI = r('bui/common'),
        FormContainer= r('common/form/FormContainer');
    var duanSafetyNotificationEdit = BUI.Overlay.Dialog.extend({
        ...
        ATTRS : {
            ...
            success:{
                value : function(){
                    ...
                    xhr.open("POST", "/kmms/duanSafetyNotificationAction/updateDoc");
                    xhr.send(formData);
    ...
    return duanSafetyNotificationEdit;
});