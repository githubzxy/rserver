 ...
 * @date 18-11-21
 */
define('kmms/dayToJobManagement/duanTraceSafetyInfomation/duanTraceSafetyInfomationAdd',['bui/common','common/form/FormContainer',
    'bui/form','bui/calendar','common/data/PostLoad',],function(r){
    var BUI = r('bui/common'),
        Calendar = r('bui/calendar'),
        PostLoad = r('common/data/PostLoad'),
        FormContainer= r('common/form/FormContainer');
    var duanTraceSafetyInfomationAdd = BUI.Overlay.Dialog.extend({
        ...
        _initDate: function () {
            ...
            var postLoad = new PostLoad({
                url : '/kmms/duanTraceSafetyInfomationAction/getSystemDate',
                el : _self.get('el'),
                loadMsg : '加载中...'
            });
...
//                    formData.append('userId',_self.get('userId'));
                    ...
                    xhr.open("POST", "/kmms/duanTraceSafetyInfomationAction/addDoc");
                    xhr.send(formData);
    ...
    return duanTraceSafetyInfomationAdd;
});