 ...
 * @date 18-11-23
 */
define('kmms/pointInnerMaintainPlanMangement/pointInnerMaintainPlan/PointInnerMaintainPlanAdd',['bui/common','common/form/FormContainer',
    'bui/form','common/org/OrganizationPicker'],function(r){
    var BUI = r('bui/common'),
    	OrganizationPicker = r('common/org/OrganizationPicker'),
        FormContainer= r('common/form/FormContainer');
    var PointInnerMaintainPlanAdd = BUI.Overlay.Dialog.extend({
        ...
        _initFormContainer : function(){
            ...
            var form = new FormContainer({
                id : 'pointInnerMaintainPlanAddForm',
                colNum : colNum,
...
//                elStyle:{overflowY:'scroll',height:'400px'}
        ...
        ATTRS : {
            id : {value : 'pointInnerMaintainPlanAddDialog'},
            elAttrs : {value: {id:"pointInnerMaintainPlanAdd"}},
            title:{value:'新增'},
            width:{value:610},
            height:{value:240},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('pointInnerMaintainPlanAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
    ...
    return PointInnerMaintainPlanAdd;
});