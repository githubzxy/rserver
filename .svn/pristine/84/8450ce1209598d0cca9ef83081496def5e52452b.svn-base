 ...
 * @date 19-3-5
 */
define('kmms/productionManage/circuitWorkOrderManage/circuitWorkOrderApply/circuitWorkOrderApplyApproveEdit',
		[
		 	'bui/common',
		 	'bui/form',
		 	'bui/select',
    ...
    var CircuitWorkOrderApplyApproveEdit = BUI.Overlay.Dialog.extend({
...
//                	redStarFlag: true,
            ...
            var form = new FormContainer({
                id : 'circuitWorkOrderApplyApproveEditForm',
                colNum : colNum,
        ...
        ATTRS : {
            id:{value : 'circuitWorkOrderApplyApproveEditDialog'},
            elAttrs:{value: {id:"circuitWorkOrderApplyApproveEdit"}},
            title:{value:'重发'},
            width:{value:650},
            height:{value:360},
            ...
            apply:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('circuitWorkOrderApplyApproveEditForm');
                    //获取上传文件
	        		...
	        		if(uploadFileArr.length==0){
	        			Mask.maskElement('#circuitWorkOrderApplyApproveEdit');
	        			BUI.Message.Alert("请上传附件！",function(){
	        				Mask.unmaskElement('#circuitWorkOrderApplyApproveEdit');
	        			},'error');
	    	    	...
	    	    	if(!data.receivePeople){
	        			...
	        			$("#circuitWorkOrderApplyApproveEdit .bui-message .bui-ext-close").css("display","none");
	        			return;
	        		}
    ...
    return CircuitWorkOrderApplyApproveEdit;
});