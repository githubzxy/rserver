 ...
 * @date 19-2-21
 */
define('kmms/constructionManage/constructionPlan/constructionApproved/constructionApprovedAdd',
	[
	 	'bui/common',
	 	'bui/form',
	 	'bui/calendar',
    ...
    var ConstructionApprovedAdd = BUI.Overlay.Dialog.extend({
...
//                	redStarFlag : true,
            ...
            var form = new FormContainer({
                id : 'constructionApprovedAddForm',
                colNum : colNum,
...
//                elStyle:{overflowY:'scroll',height:'400px'}
        ...
        ATTRS : {
            id : {value : 'constructionApprovedAddDialog'},
            elAttrs : {value: {id:"constructionApprovedAdd"}},
            title:{value:'审核'},
            width:{value:500},
            height:{value:300},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('constructionApprovedAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/constructApprovedAction/updateDoc");
                    xhr.send(formData);
    ...
    return ConstructionApprovedAdd;
});