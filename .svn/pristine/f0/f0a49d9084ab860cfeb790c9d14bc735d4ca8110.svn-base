 ...
 * @date 19-1-22
 */
define('kmms/constructionManage/pointInnerMaintainPlan/communicationNetwork/communicationNetworkApproveAdd',
	[
	 	'bui/common',
	 	'bui/form',
	 	'bui/calendar',
    ...
    var communicationNetworkApproveAdd = BUI.Overlay.Dialog.extend({
...
//            });
        ...
        _initSelect: function(){
			...
			$("#formContainer #approveResult").append("<option  value='1'>审核通过</option>");
...
//                }
            ...
            var form = new FormContainer({
                id : 'communicationNetworkApproveAddForm',
                colNum : colNum,
...
//                elStyle:{overflowY:'scroll',height:'400px'}
        ...
        ATTRS : {
            id : {value : 'communicationNetworkApproveDialog'},
            elAttrs : {value: {id:"communicationNetworkApproveAdd"}},
            title:{value:'审核'},
            width:{value:500},
            height:{value:300},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('communicationNetworkApproveAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/communicationNetworkApproveAction/updateDoc");
                    xhr.send(formData);
    ...
    return communicationNetworkApproveAdd;
});