...
@Service("communicationNetworkApproveService")
public class CommunicationNetworkApproveServiceImpl implements  CommunicationNetworkApproveService{
	...
	private Bson getFilter(String userId, String orgId, String currentDay,String project,String type,String startUploadDate, String endUploadDate,
        ...
        if(StringUtils.isNotBlank(userId)){
            filter = Filters.and(filter,Filters.eq("approverId",userId));
        }
