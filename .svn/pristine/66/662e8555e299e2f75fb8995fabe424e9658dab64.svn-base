...
public interface VideoPhoneNoticeService {
	/**
     * 新增数据
     * @param doc 数据对象
     ...
     * @return 数据对象列表
     */
    List<Document> findAllDocument(String collectionName,  String userId, String currentDay, String startUploadDate,String endUploadDate, int start, int limit, String noticeContent);
    /**
     * 分页查询数量
     * @param collectionName 表名
     * @param name   数据名称
