 ...
 * @date 19-1-22
 */
define('kmms/dayToJobManagement/pointOuterMaintainManagement/pointOuterMaintainApplyApproveEdit',
	[
	 	'bui/common',
	 	'bui/form',
		'bui/calendar',
    ...
    var PointOuterMaintainApplyApproveEdit = BUI.Overlay.Dialog.extend({
...
//				},
				...
				},
				{
					label : '段调度审批人：',
					itemColspan : 1,
					item : '<input type="text"  id="approver" style="width:99%" readonly/>'
				},
				{
					label : '审批日期：',
					itemColspan : 1,
					item : '<input type="text"  id="approveDate" style="width:99%" readonly/>'
				},
				{
					label : '段调度审批意见：',
					itemColspan : 2,
...
//                }
            ...
            var form = new FormContainer({
                id : 'pointOuterMaintainApplyApproveEditForm',
                colNum : colNum,
        ...
        ATTRS : {
            id : {value : 'pointOuterMaintainApplyApproveEditDialog'},
            elAttrs : {value: {id:"pointOuterMaintainApplyApproveEdit"}},
            title:{value:'修改'},
            width:{value:650},
            height:{value:500},
            ...
            successApply:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('pointOuterMaintainApplyApproveEditForm');
                    //获取上传文件
    ...
    return PointOuterMaintainApplyApproveEdit;
});