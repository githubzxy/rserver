 ...
 * 详情模块
 */
define('kmms/technicalManagement/communicationResumeManage/line/lightInfo',['bui/common',
	...
	var lightInfo = BUI.Overlay.Dialog.extend({
		            ...
		            var childs = [
		            	{
		                    ...
		                    redStarFlag : true,
		                    itemColspan : 1,
		                    item : '<input type="text" name="coreNumber" id="coreNumber" style="width:99%" readOnly/>'
		                },{
		                    label : '在用芯数：',
		                    redStarFlag : true,
		                    itemColspan : 1,
		                    item : '<input type="text" name="useCoreNumber" id="useCoreNumber" style="width:99%" readOnly/>'
		                },{
		                    label : '资产比例：',
		                    redStarFlag : true,
		                    itemColspan : 1,
		                    ...
		                    label : '中修日期：',
		                    itemColspan : 1,
		                    item : '<input type="text" class="calendar" readonly name="middleRepairDate" id="middleRepairDate" style="width:98.5%" readOnly/>'
		                },{
		                    label : '大修日期：',
		                    itemColspan : 1,
		                    item : '<input type="text" class="calendar" readonly name="largeRepairDate" id="largeRepairDate" style="width:98.5%" readOnly/>'
		                },{
		                    label : '设备运行状态：',
		                    redStarFlag : true,
		                    itemColspan : 1,
