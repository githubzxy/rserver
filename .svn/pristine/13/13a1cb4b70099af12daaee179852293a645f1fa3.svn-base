 ...
 * @date 19-3-4
 */
define('kmms/productionManage/circuitWorkOrderManage/circuitWorkOrderCheck/circuitWorkOrderCheckAdd',
		[
		 	'bui/common',
		 	'bui/form',
		 	'bui/select',
    ...
    var CircuitWorkOrderCheckAdd = BUI.Overlay.Dialog.extend({
        ...
        _getShowData : function(){
            ...
            $.ajax({
                url:'/kmms/circuitWorkOrderCheckAction/findById',
        ...
        _initFormContainer : function(){
            ...
            var form = new FormContainer({
                id : 'circuitWorkOrderCheckAddForm',
                colNum : colNum,
...
//                elStyle:{overflowY:'scroll',height:'400px'}
        ...
        ATTRS : {
            id:{value : 'circuitWorkOrderCheckAddDialog'},
            elAttrs:{value: {id:"circuitWorkOrderCheckAdd"}},
            title:{value:'审核'},
            width:{value:650},
            height:{value:460},
            ...
            pass:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('circuitWorkOrderCheckAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
	        		...
	        		var pl = new PostLoad({
        				url : '/zuul/kmms/circuitWorkOrderCheckAction/updateCheckDoc',
        				el : _self.get('el'),
        				loadMsg : '上传中...'
        			}); 
    ...
    return CircuitWorkOrderCheckAdd;
});