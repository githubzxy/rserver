 ...
 * @date 19-1-18
 */
define('kmms/dayToJobManagement/otherProductionInfo/otherProductionTroubleEdit',
	[
	 	'bui/common',
	 	'bui/form',
	 	'bui/calendar',
    ...
    var OtherProductionTroubleEdit = BUI.Overlay.Dialog.extend({
...
//						item : '<select name="troubleLineName" id="troubleLineName" style="width:99.5%" data-rules="{required:true}"/></select>'
            ...
            var form = new FormContainer({
                id : 'otherProductionTroubleEditForm',
                colNum : colNum,
        ...
        ATTRS : {
            id : {value : 'otherProductionTroubleEditDialog'},
            elAttrs : {value: {id:"otherProductionTroubleEdit"}},
            title:{value:'修改故障情况'},
            width:{value:750},
            height:{value:530},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('otherProductionTroubleEditForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
    ...
    return OtherProductionTroubleEdit;
});