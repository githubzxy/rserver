...
import com.enovell.yunwei.km_micor_service.service.dayToJobManageService.SuperiorSafetyNotificationService;
import com.enovell.yunwei.km_micor_service.util.JsonUtil;

@RestController
@RequestMapping("/superiorSafetyNotificationAction")
public class SuperiorSafetyNotificationAction {
	@Resource(name = "superiorSafetyNotificationService")
    private SuperiorSafetyNotificationService service;
