...
public class TatOtherDto implements Serializable {
	private static final long serialVersionUID = 7065135263618314393L;
	...
	public String capacityCallsNumber;
	...
	public String getCapacityCallsNumber() {
		return capacityCallsNumber;
	}
	public void setCapacityCallsNumber(String capacityCallsNumber) {
		this.capacityCallsNumber = capacityCallsNumber;
	}
	...
	public String toString() {
		return "TatOtherDto [workshop=" + workshop + ", workArea=" + workArea + ", combinationClass=" + combinationClass
				+ ", deviceClass=" + deviceClass + ", deviceCode=" + deviceCode + ", deviceName=" + deviceName
				+ ", site_station_line=" + site_station_line + ", site_station_name=" + site_station_name
				+ ", site_station_place=" + site_station_place + ", site_range_line=" + site_range_line
				+ ", site_range_post=" + site_range_post + ", site_range_place=" + site_range_place
				+ ", site_other_line=" + site_other_line + ", site_other_place=" + site_other_place
				+ ", site_machineRoomCode=" + site_machineRoomCode + ", assetOwnership=" + assetOwnership
				+ ", ownershipUnitName=" + ownershipUnitName + ", ownershipUnitCode=" + ownershipUnitCode
				+ ", maintainBody=" + maintainBody + ", maintainUnitName=" + maintainUnitName + ", maintainUnitCode="
				+ maintainUnitCode + ", capacityCallsNumber=" + capacityCallsNumber + ", capacityUnit=" + capacityUnit
				...
				+ deviceOperationStatus + ", stopDate=" + stopDate + ", scrapDate=" + scrapDate + ", fixedAssetsCode="
				+ fixedAssetsCode + ", remark=" + remark + "]";
	}
