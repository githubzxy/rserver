 ...
 * @date 18-11-21
 */
define('kmms/technicalManagement/communicationResumeManage/tat/spcEdit',['bui/common',
	'common/form/FormContainer',
    'bui/form',
    ],function(r){
    var BUI = r('bui/common'),
        FormContainer= r('common/form/FormContainer');
    var spcEdit = BUI.Overlay.Dialog.extend({
            ...
            var childs = [
            	{
                    ...
                    item : 
					       ...
					       '</th>'+
					       '<td style="width:30%">'+
						   '<input type="text" id="site_machineRoomCode" name="site_machineRoomCode"  style="width:97%;" data-rules="{required:true}" />'+
						   '</td>'+
						   '</tr>'+
					       '</tbody>'+
					       '</table>'
                    ...
                    redStarFlag : true,
                    itemColspan : 1,
                    item : '<input type="text" name="userLineConfigCapacity" id="userLineConfigCapacity" style="width:98.5%" data-rules="{required:true}"/>'
                },{
                    label : '实装用户数：',
                    redStarFlag : true,
                    itemColspan : 1,
                    item : '<input type="text" name="actualUserNumber" id="actualUserNumber" style="width:98.5%" data-rules="{required:true}"/>'
                },{
                    label : '中继线配置容量：',
                    redStarFlag : true,
                    itemColspan : 1,
                    item : '<input type="text" name="trunkConfigCapacity" id="trunkConfigCapacity" style="width:98.5%" data-rules="{required:true}"/>'
                },{
                    label : '中继线实际使用容量：',
                    redStarFlag : true,
                    itemColspan : 1,
                    item : '<input type="text" name="trunkActualCapacity" id="trunkActualCapacity" style="width:98.5%" data-rules="{required:true}"/>'
                },{
                    label : '远端用户模块(总容量)：',
                    redStarFlag : true,
                    itemColspan : 1,
                    item : '<input type="text" name="remoteUserModule_totalCapacity" id="remoteUserModule_totalCapacity" style="width:98.5%;height:60px" data-rules="{required:true}"/>'
                },{
                    label : '远端用户模块(实际使用容量)：',
                    redStarFlag : true,
                    itemColspan : 1,
                    item : '<input type="text" name="remoteUserModule_actuallCapacity" id="remoteUserModule_actuallCapacity" style="width:98.5%;height:60px" data-rules="{required:true}"/>'
                },{
                    label : '信令方式：',
                    redStarFlag : true,
                    itemColspan : 1,
                    item : '<input type="text" name="holdWithSignal" id="holdWithSignal" style="width:98.5%" data-rules="{required:true}"/>'
                },{
                    label : '固资编号：',
                    itemColspan : 1,
        ...
        ATTRS : {
            id : {value : 'spcEditDialog'},
            elAttrs : {value: {id:"spcPointEdit"}},
            title:{value:'编辑程控交换机'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('spcEditForm'),delData=_self.get('delData');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/tatAction/spcUpdateDoc");
                    xhr.send(formData);
