 ...
 * @date 18-11-21
 */
define('kmms/dailyShift/duan/dailyShiftForDuanEdit',['bui/common','common/form/FormContainer',
            ...
            var childs = [
                {
                    ...
                    label : '事故、故障、障碍：',
                    itemColspan : 2,
                    item : '<div id="accident" style="height:70px;overflow-y :auto"></div>'
                },{
                    label : '告警监测信息处理情况：',
                    itemColspan : 2,
                    item : '<div id="alarm" style="height:70px;overflow-y :auto"></div>'
                },{
                    label : '遗留信息处理情况：',
                    itemColspan : 2,
                    item : '<div id="handdown" style="height:70px;overflow-y :auto"></div>'
                },{
                    label : '停点施工、维修天窗及干部把关盯控情况：',
                    itemColspan : 2,
                    item : '<div id="stare" style="height:70px;overflow-y :auto"></div>'
                },{
                    label : '电视电话会议、电报、紧急通知处理情况：',
                    itemColspan : 2,
                    item : '<div id="tel" style="height:70px;overflow-y :auto"></div>'
                },{
                    label : '施工配合信息：',
                    itemColspan : 2,
                    item : '<div id="construction" style="height:70px;overflow-y :auto"></div>'
                },{
                    label : '重点工作完成情况：',
                    itemColspan : 2,
//                    item : '<div nameid="keytask" style="height:70px;overflow-y :auto"></div>'
                    item : '<div id="keytask" style="height:70px;overflow-y :auto"></div>'
                },{
                    label : '上级、段安全问题通知书情况：',
                    itemColspan : 2,
                    item : '<div id="security" style="height:70px;overflow-y :auto"></div>'
                },{
                    label : '路局、段重点追查安全信息：',
                    itemColspan : 2,
                    item : '<div id="keysecurity" style="height:70px;overflow-y :auto"></div>'
                },{
                    label : '上级部门检查情况：',
                    itemColspan : 2,
                    item : '<div id="check" style="height:70px;overflow-y :auto"></div>'
                },{
                    label : '干部值班情况：',
                    itemColspan : 2,
                    item : '<div id="duty" style="height:70px;overflow-y :auto" ></div>'
                }
            ];
        ...
        ATTRS : {
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('DuanAdd'),delData=_self.get('delData');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
