...
import com.enovell.yunwei.km_micor_service.service.maintainManage.maintainPlan.MaintainApprovedService;

@RestController
@RequestMapping("/maintainApprovedAction")
public class MaintainApprovedAction {
	
	@Resource(name="maintainApprovedService")
	private MaintainApprovedService service;
