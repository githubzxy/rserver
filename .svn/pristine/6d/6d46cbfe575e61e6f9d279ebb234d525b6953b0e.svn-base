 ...
 * @date 18-11-21
 */
define('kmms/dayToJobManagement/inspectionSuperiors/inspectionSuperiorsPage',['bui/common','bui/data','bui/grid',
    'common/grid/SearchGridContainer',
    'kmms/dayToJobManagement/inspectionSuperiors/inspectionSuperiorsAdd',
    'bui/calendar',
    'kmms/dayToJobManagement/inspectionSuperiors/inspectionSuperiorsEdit',
//    'kmms/dayToJobManagement/duanSafetyNotification/duanSafetyNotificationInfo',
    ...
    var BUI = r('bui/common'),
        ...
        inspectionSuperiorsAdd = r('kmms/dayToJobManagement/inspectionSuperiors/inspectionSuperiorsAdd'),
        inspectionSuperiorsEdit = r('kmms/dayToJobManagement/inspectionSuperiors/inspectionSuperiorsEdit'),
...
//                });
                ...
                $('.addBtn').on('click',function(e){
                    var addDialog = new inspectionSuperiorsAdd({
                ...
                table.on('cellclick',function(ev){
                    ...
                    if(target.hasClass('infoBtn')){
                        var infoDialog = new inspectionSuperiorsInfo({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                            shiftId:docId
                        });
            	  ...
            	  if(target.hasClass('delBtn')){
                 	   BUI.Message.Confirm('确认要删除吗？',function(){
  	                       var postLoad = new PostLoad({
  	                           url : '/kmms/inspectionSuperiorsAction/removeDoc.cn',
  	                           el : _self.get('el'),
  	                           loadMsg : '删除中...'
  	                       });
                    ...
                    if(target.hasClass('editBtn')){
                        var editDialog = new inspectionSuperiorsEdit({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
                            shiftId:docId
                        });
            ...
            _initSearchForm:function(){
                return {
                    items : [
                        ...
                        {label : '上级检查情况',item : '<input type="text" name="noticeContent" id="noticeContent" style="width: 175px;"  />'}
...
//                        	'<span  class="grid-command infoBtn">详情</span>';
            ...
            _initStore:function () {
                ...
                var store = new Data.Store({
                    url : "/kmms/inspectionSuperiorsAction/findAll.cn",
                    autoLoad : true ,
                    pageSize : 10,
                    proxy : {
                        method : 'post',
...
//                        }
        ...
        },
        {
            ATTRS : {
                 ...
                 * 存储表名
                 */
                collectionName : {value:'inspectionSuperiors'}
            }
        });
