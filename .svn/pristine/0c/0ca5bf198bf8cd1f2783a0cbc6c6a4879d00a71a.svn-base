...
public class VideoVidiconDto implements Serializable {

	private static final long serialVersionUID = 7472698550541581434L;
	...
	public String getVidiconType() {
		return vidiconType;
	}

	public void setVidiconType(String vidiconType) {
		this.vidiconType = vidiconType;
	}
