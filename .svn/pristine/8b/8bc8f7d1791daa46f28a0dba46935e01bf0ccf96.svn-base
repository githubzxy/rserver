...
import com.enovell.yunwei.km_micor_service.service.productionManage.taskManage.TaskNetworkCenterService;
import com.enovell.yunwei.km_micor_service.util.JsonUtil;
import com.mongodb.DBObject;
import com.mongodb.util.JSON;

@RestController
@RequestMapping("/taskNetworkCenterAction")
public class TaskNetworkCenterAction {
	@Resource(name = "taskNetworkCenterService")
    private TaskNetworkCenterService service;
