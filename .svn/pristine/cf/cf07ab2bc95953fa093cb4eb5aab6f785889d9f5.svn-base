 ...
 * 详情模块
 */
define('kmms/technicalManagement/communicationResumeManage/trans/numberTransInfo',['bui/common',
	...
	var numberTransInfo = BUI.Overlay.Dialog.extend({
