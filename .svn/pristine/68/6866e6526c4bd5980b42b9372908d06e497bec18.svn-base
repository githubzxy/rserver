 ...
 * @date 19-06-17
 */
define('kmms/technicalManagement/communicationResumeManage/wireless/radioAdd',
		   ['bui/common',
    ...
    var RadioAdd = BUI.Overlay.Dialog.extend({
        ...
        ATTRS : {
            id : {value : 'radioDialog'},
            elAttrs : {value: {id:"radioAdd"}},
            title:{value:'新增车站电台-03'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('radioAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/wirelessAction/addDocRadio");
                    xhr.send(formData);
