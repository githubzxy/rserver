 ...
 * @date 19-06-17
 */
define('kmms/technicalManagement/communicationResumeManage/video/vidiconEdit',['bui/common',
	'common/form/FormContainer',
    'bui/form',
    ],function(r){
    var BUI = r('bui/common'),
        FormContainer= r('common/form/FormContainer');
    var VidiconEdit = BUI.Overlay.Dialog.extend({
            ...
            $.ajax({
                ...
                success:function(res){
                    ...
                    if(data){
                        ...
                        $('#formContainer #vidiconType').val(data.vidiconType);
            ...
            var childs = [
                {
                    ...
                    redStarFlag : true,
                    itemColspan : 1,
                    item : '<input type="text" name="vidiconType" id="vidiconType" style="width:98.5%" {required:true}/>'
                },{
                    label : '设备厂家：',
                    redStarFlag : true,
                    itemColspan : 1,
        ...
        ATTRS : {
            id : {value : 'vidiconEditDialog'},
            elAttrs : {value: {id:"vidiconPointEdit"}},
            title:{value:'编辑摄像机-03'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('vidiconEditForm'),delData=_self.get('delData');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/videoAction/updateDocVidicon");
                    xhr.send(formData);
