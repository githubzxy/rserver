 ...
 * @date 19-6-19
 */
define('kmms/technicalManagement/communicationResumeManage/dispatch/dutyInfo',['bui/common',
	...
	var dutyInfo = BUI.Overlay.Dialog.extend({
		            ...
		            var childs = [
		            	{
		                    label : '所属数字环序号：',
		                    itemColspan : 1,
		                    item : '<input type="text" name="numbeDigital" style="width:98%" id="numbeDigital" readOnly></input>'
		                },
		                {
		                    label : '所属调度操作台序号：',
		                    itemColspan : 1,
		                    item : '<input type="text" name="numberDispatch" style="width:98%" id="numberDispatch" readOnly></input>'
		                },
		            	{
		                    label : '车间：',
		                    itemColspan : 1,
