...
/**
 * 年月报表编制工区实体类
* @Title: YearMonthWorkArea.java 
* @Package com.enovell.yunwei.yearMonthPuTie.domain;
* @date 2017年9月19日 上午9:06:26 
* @author luoyan  
*/

public class YearMonthPutieGQ {
	 ...
	 * 车间业务数据
	 */
	private YearMonthPutieCJ yearMonthWorkShop;
	...
	public YearMonthPutieCJ getYearMonthWorkShop() {
		return yearMonthWorkShop;
	}
	public void setYearMonthWorkShop(YearMonthPutieCJ yearMonthWorkShop) {
		this.yearMonthWorkShop = yearMonthWorkShop;
	}
