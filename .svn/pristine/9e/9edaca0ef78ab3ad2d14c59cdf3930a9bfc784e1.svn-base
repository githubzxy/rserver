 ...
 * @date 19-6-17
 */
define('kmms/technicalManagement/communicationResumeManage/dispatch/dispatchChangerEdit',['bui/common',
	'common/form/FormContainer',
    'bui/form',
    ],function(r){
    var BUI = r('bui/common'),
        FormContainer= r('common/form/FormContainer');
    var dispatchChangerEdit = BUI.Overlay.Dialog.extend({
...
//        },
        ...
        ATTRS : {
            id : {value : 'dispatchChangerEditDialog'},
            elAttrs : {value: {id:"dispatchChangerPointEdit"}},
            title:{value:'调度交换机-02'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('dispatchChangerEditForm'),delData=_self.get('delData');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/dispatchAction/dispatchChanger/updateDoc");
                    xhr.send(formData);
