 ...
 * @date 19-06-17
 */
define('kmms/technicalManagement/communicationResumeManage/wireless/cableAdd',
		   ['bui/common',
    ...
    var CableAdd = BUI.Overlay.Dialog.extend({
        ...
        ATTRS : {
            id : {value : 'cableDialog'},
            elAttrs : {value: {id:"cableAdd"}},
            title:{value:'新增漏泄同轴电缆-02'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('cableAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/wirelessAction/addDocCable");
                    xhr.send(formData);
