 ...
 * @date 19-2-21
 */
define('kmms/constructionManage/pointInnerMaintainPlan/pointInnerSecondMaintainApply/pointInnerSecondMaintainApplyAdd',
		[
			'bui/common',
			'bui/form',
    ...
    var PointInnerSecondMaintainApplyAdd = BUI.Overlay.Dialog.extend({
...
//                },
            ...
            var form = new FormContainer({
                id : 'pointInnerSecondMaintainApplyAddForm',
                colNum : colNum,
...
//                elStyle:{overflowY:'scroll',height:'400px'}
        ...
        ATTRS : {
            id : {value : 'pointInnerSecondMaintainApplyAddDialog'},
            elAttrs : {value : {id:"pointInnerSecondMaintainApplyAdd"}},
            title:{value:'申请II级维修方案'},
            width:{value:600},
            height:{value:270},
            contextPath : {},
            ...
            save:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('pointInnerSecondMaintainApplyAddForm');
                    //获取上传文件
...
//                    formData.append('userId',_self.get('userId'));
                    console.log(data);
                    var pl = new PostLoad({
        				url : '/zuul/kmms/pointInnerSecondMaintainApplyAction/addDoc',
        				el : _self.get('el'),
        				loadMsg : '上传中...'
        			}); 
...
//                    xhr.open("POST", "/zuul/kmms/pointInnerSecondMaintainApplyAction/addDoc");
//                    xhr.send(data);
...
//                    }
    ...
    return PointInnerSecondMaintainApplyAdd;
});