 ...
 * @date 18-11-21
 */
define('kmms/dailyShift/cj/dailyShiftForCjEdit',['bui/common','common/form/FormContainer',
   'bui/form','common/org/OrganizationPicker',],function(r){
    var BUI = r('bui/common'),
    	OrganizationPicker = r('common/org/OrganizationPicker'),
        FormContainer= r('common/form/FormContainer');
    var DailyShiftForCjEdit = BUI.Overlay.Dialog.extend({
            ...
            var childs = [
                {
                    ...
                    label : '施工配合信息：',
                    itemColspan : 2,
                    item : '<div id="construction" style="height:75px;overflow-y :auto"></div>'
                },{
                    label : '上级部门检查情况：',
                    itemColspan : 2,
                    item : '<div id="check" style="height:75px;overflow-y :auto"></div>'
                },{
                    label : '干部值班情况：',
                    itemColspan : 2,
                    item : '<div id="duty" style="height:75px;overflow-y :auto" ></div>'
                }
            ];
...
//                elStyle:{overflowY:'scroll',height:'400px'}
        ...
        ATTRS : {
            id : {value : 'cjShiftEditDialog'},
            elAttrs : {value: {id:"cjShiftEdit"}},
            title:{value:'编辑交班'},
            width:{value:610},
            height:{value:395},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('CjEdit'),delData=_self.get('delData');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
