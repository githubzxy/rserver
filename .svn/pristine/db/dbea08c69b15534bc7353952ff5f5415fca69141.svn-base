 ...
 * @date 19-6-19
 */
define('kmms/technicalManagement/communicationResumeManage/wired/wiredAdd',
		   ['bui/common',
    ...
    var wiredAdd = BUI.Overlay.Dialog.extend({
        ...
        ATTRS : {
            id : {value : 'wiredDialog'},
            elAttrs : {value: {id:"wiredAdd"}},
            title:{value:'有线类-01'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('wiredAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/wiredAction/addDoc");
                    xhr.send(formData);
