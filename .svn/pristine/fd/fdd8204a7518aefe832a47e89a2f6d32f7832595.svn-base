...
import com.enovell.yunwei.km_micor_service.service.dayToJobManageService.CompanyTraceSafetyInfomationService;
import com.enovell.yunwei.km_micor_service.util.JsonUtil;

@RestController
@RequestMapping("/companyTraceSafetyInfomationAction")
public class CompanyTraceSafetyInfomationAction {
	@Resource(name = "companyTraceSafetyInfomationService")
    private CompanyTraceSafetyInfomationService service;
