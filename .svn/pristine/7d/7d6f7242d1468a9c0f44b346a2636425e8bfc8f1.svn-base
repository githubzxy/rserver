 ...
 * @date 19-6-19
 */
define('kmms/technicalManagement/communicationResumeManage/trans/dwdmEdit',['bui/common',
    ...
    var DwdmEdit = BUI.Overlay.Dialog.extend({
        ...
        ATTRS : {
            id : {value : 'dwdmEditDialog'},
            elAttrs : {value: {id:"dwdmPointEdit"}},
            title:{value:'编辑波分(DWDM)-01'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('dwdmEditForm'),delData=_self.get('delData');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/transAction/updateDoc");
                    xhr.send(formData);
