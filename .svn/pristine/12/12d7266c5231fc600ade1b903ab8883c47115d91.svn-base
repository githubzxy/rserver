 ...
 * @date 18-11-21
 */
define('kmms/dayToJobManagement/completionOfKeyTasks/completionOfKeyTasksEdit',['bui/common','common/form/FormContainer',
   'bui/form',],function(r){
    var BUI = r('bui/common'),
        FormContainer= r('common/form/FormContainer');
    var completionOfKeyTasksEdit = BUI.Overlay.Dialog.extend({
        ...
        ATTRS : {
            ...
            success:{
                value : function(){
                    ...
                    xhr.open("POST", "/kmms/completionOfKeyTasksAction/updateDoc");
                    xhr.send(formData);
    ...
    return completionOfKeyTasksEdit;
});