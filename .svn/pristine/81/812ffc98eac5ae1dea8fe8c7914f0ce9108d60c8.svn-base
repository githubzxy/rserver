...
public interface ProcuratorialDailyService {
	/**
     * 新增数据
     * @param doc 数据对象
     ...
     * @return 数据对象列表
     */
    List<Document> findAllDocument(String collectionName,  String userId , String workshop,String date ,int start, int limit, String endata);
    /**
     * 分页查询数量
     * @param collectionName 表名
     * @param endata 
     ...
     * @return 条数
     */
    long findAllDocumentCount(String collectionName, String userId,String workshop,String date, String endata);

	List<ProcuratorialDailyDto> findAllDocumentByexport(String workshopOfexport, String dateOfexport, String enddateOfexport);
