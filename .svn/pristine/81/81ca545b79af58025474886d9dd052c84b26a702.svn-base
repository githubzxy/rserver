 ...
 * 上级安全问题通知书情况详情
 */
define('kmms/dayToJobManagement/superiorSafetyNotification/superiorSafetyNotificationInfo',['bui/common','common/form/FormContainer',
	'common/uploader/ViewUploader','common/data/PostLoad'],function(r){
	var BUI = r('bui/common'),
		Uploader = r('common/uploader/ViewUploader'),
		FormContainer= r('common/form/FormContainer');
	var superiorSafetyNotificationInfo = BUI.Overlay.Dialog.extend({
	...
	return superiorSafetyNotificationInfo;
});