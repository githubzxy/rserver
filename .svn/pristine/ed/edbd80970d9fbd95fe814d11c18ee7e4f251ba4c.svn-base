 ...
 * @date 19-2-20
 */
define('kmms/constructionManage/constructionPlan/constructionAudit/constructionAuditPage',
	[
	 	'bui/common',
	 	'bui/data',
	 	'bui/grid',
	 	...
	 	'kmms/constructionManage/constructionPlan/constructionAudit/constructionAuditInfo',
	 	'kmms/constructionManage/constructionPlan/constructionAudit/constructionAuditAdd'
	],function (r) {
    var BUI = r('bui/common'),
    	...
    	ConstructionAuditInfo = r('kmms/constructionManage/constructionPlan/constructionAudit/constructionAuditInfo'),
    	ConstructionAuditAdd = r('kmms/constructionManage/constructionPlan/constructionAudit/constructionAuditAdd');
    	
    var ConstructionAuditPage = BUI.Component.Controller.extend(
        {
...
//    			});
                ...
                table.on('cellclick',function(ev){
                    ...
                    if(target.hasClass('infoBtn')){
                        var infoDialog = new ConstructionAuditInfo({
                    ...
                    if(target.hasClass('auditBtn')){
                        var editDialog = new ConstructionAuditAdd({
                            collectionName:_self.get('collectionName'),
                            userId:_self.get('userId'),
            ...
            _initStore:function () {
                ...
                var store = new Data.Store({
                    url : "/kmms/constructAuditAction/findAll.cn",
                    autoLoad : true ,
                    pageSize : 10,
                    proxy : {
                        method : 'post',
