 ...
 * @date 19-3-24
 */
define('kmms/securityManage/accidentQuery/accidentQueryPage',
	[
	 	'bui/common',
	 	'bui/data',
	 	'bui/grid',
...
//                var orgPicker=_self.get('orgPicker');
    			...
    			$("button[type='reset']").on('click',function(event){
    				...
    				$("#accidentObligationDepart").val("");
    				$("#accidentLineName").val("");
            ...
            _initSearchForm:function(){
                return {
                    items : [
                        ...
                        {label : '责任部门',item : '<select name="accidentObligationDepart" id="accidentObligationDepart" style="width: 210px;" ></select>'},
                        {label : '线名',item : '<input type="text" name="accidentLineName" id="accidentLineName" style="width: 175px;" >'}
//                        {label : '线名',item : '<select name="accidentLineName" id="accidentLineName" style="width: 210px;" ></select>'}
                    ]};
            },
            /**
             * 初始化时间查询
                ...
                var columns = [
                   {
                        ...
                        title:'责任部门',
                        dataIndex:'accidentObligationDepart',
                        elCls : 'center',
                        width:'15%'
                    },{
                        title:'线名',
                        dataIndex:'accidentLineName',
                        elCls : 'center',
                        width:'10%'
                    }, {
                        title:'事故等级',
                        ...
                        title:'详细等级',
                        dataIndex:'accidentDetailLevel',
                        elCls : 'center',
                        width:'15%'
                    },{
                    	title:'事故摘要',
                    	dataIndex:'accidentDigest',
                    	elCls : 'center',
                    	width:'15%'
                    },{
                    	title:'事故原因',
                    	...
                    	title:'事故概况',
                    	dataIndex:'accidentGeneral',
                    	elCls : 'center',
                    	width:'40%'
                    },{
                 
                    	title:'定责情况',
                    	dataIndex:'accidentDutySituation',
                    	elCls : 'center',
                    	width:'15%'
                    },{
                        title:'操作',
            ...
            _initStore:function () {
                ...
                var store = new Data.Store({
                    url : "/kmms/accidentQueryAction/findAll.cn",
                    autoLoad : true ,
                    pageSize : 20,
                    proxy : {
                        method : 'post',
