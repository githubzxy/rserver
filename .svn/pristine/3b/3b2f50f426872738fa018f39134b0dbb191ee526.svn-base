 ...
 * @date 19-6-19
 */
define('kmms/technicalManagement/communicationResumeManage/dispatch/dispatchChangerAdd',
		   ['bui/common',
    ...
    var dispatchChangerAdd = BUI.Overlay.Dialog.extend({
        ...
        ATTRS : {
            id : {value : 'dispatchChangerDialog'},
            elAttrs : {value: {id:"dispatchChangerAdd"}},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('dispatchChangerAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/dispatchAction/dispatchChanger/addDoc");
                    xhr.send(formData);
