 ...
 * @date 18-11-23
 */
define('kmms/securityRiskManagement/point/SecurityRiskPointAdd',['bui/common','common/form/FormContainer',
...
//                elStyle:{overflowY:'scroll',height:'400px'}
        ...
        ATTRS : {
            id : {value : 'securityRiskPointAddDialog'},
            elAttrs : {value: {id:"securityRiskPointAdd"}},
            title:{value:'新增'},
            width:{value:610},
            height:{value:240},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('securityRiskPointAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
