 ...
 * @date 19-06-17
 */
define('kmms/technicalManagement/communicationResumeManage/video/videoEdit',['bui/common',
	'common/form/FormContainer',
    'bui/form',
    ],function(r){
    var BUI = r('bui/common'),
        FormContainer= r('common/form/FormContainer');
    var VideoEdit = BUI.Overlay.Dialog.extend({
        ...
        ATTRS : {
            id : {value : 'videoEditDialog'},
            elAttrs : {value: {id:"videoPointEdit"}},
            title:{value:'编辑视频监控类-01'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('videoEditForm'),delData=_self.get('delData');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/videoAction/updateDocVideo");
                    xhr.send(formData);
