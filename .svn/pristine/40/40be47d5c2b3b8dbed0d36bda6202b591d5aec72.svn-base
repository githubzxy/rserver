 ...
 * @date 19-1-17
 */
define('kmms/dayToJobManagement/networkManageInfo/networkManageObstacleEdit',
	[
	 	'bui/common',
	 	'bui/form',
	 	'bui/calendar',
    ...
    var NetworkManageObstacleEdit = BUI.Overlay.Dialog.extend({
...
//                },
            ...
            var form = new FormContainer({
                id : 'networkManageObstacleEditForm',
                colNum : colNum,
        ...
        ATTRS : {
            id : {value : 'networkManageObstacleEditDialog'},
            elAttrs : {value: {id:"networkManageObstacleEdit"}},
            title:{value:'修改障碍情况'},
            width:{value:750},
            height:{value:540},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('networkManageObstacleEditForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
            		...
            		/*if(obstacleUploadFileArr.length==0){
...
//                    formData.append('orgName',_self.get('orgName'));
                    ...
                    xhr.open("POST", "/zuul/kmms/networkManageInfoAction/updateObstacleDoc");
                    xhr.send(formData);
    ...
    return NetworkManageObstacleEdit;
});