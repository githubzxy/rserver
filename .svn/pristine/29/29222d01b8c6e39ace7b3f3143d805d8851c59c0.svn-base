 ...
 * @date 19-06-17
 */
define('kmms/technicalManagement/communicationResumeManage/video/vidiconAdd',
		   ['bui/common',
    ...
    var VidiconAdd = BUI.Overlay.Dialog.extend({
            ...
            var childs = [
				{
                    ...
                    redStarFlag : true,
                    itemColspan : 1,
                    item : '<input type="text" name="vidiconType" id="vidiconType" style="width:98.5%" data-rules="{required:true}"/>'
                },{
                    label : '设备厂家：',
                    redStarFlag : true,
                    itemColspan : 1,
        ...
        ATTRS : {
            id : {value : 'vidiconDialog'},
            elAttrs : {value: {id:"vidiconAdd"}},
            title:{value:'新增摄像机-03'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('vidiconAddForm');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/videoAction/addDocVidicon");
                    xhr.send(formData);
