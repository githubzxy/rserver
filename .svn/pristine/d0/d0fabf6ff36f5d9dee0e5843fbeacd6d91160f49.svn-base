 ...
 * 详情模块
 */
define('kmms/technicalManagement/communicationResumeManage/line/lineAndLightInfo',['bui/common',
	...
	var lineAndLightInfo = BUI.Overlay.Dialog.extend({
		            ...
		            var childs = [
		            	{
		                    ...
		                    item : 
							       ...
							       '</th>'+
							       '<td style="width:30%">'+
								   '<input type="text" id="site_station_line" name="site_station_line" class="station" style="width:98%;" readOnly/>'+
								   '</td>'+
								   '</tr>'+
								   '<tr class="thTdPadding">'+
							       ...
							       '</th>'+
							       '<td style="width:30%">'+
								   '<input type="text" id="site_station_name" name="site_station_name" class="station" style="width:98%;" readOnly/>'+
								   '</td>'+
								   '</tr>'+
								   '<tr class="thTdPadding">'+
							       ...
							       '</th>'+
							       '<td style="width:30%">'+
								   '<input type="text" id="site_station_place" name="site_station_place" class="station" style="width:98%;" readOnly/>'+
								   '</td>'+
							       '</tr>'+
							       '<tr class="thTdPadding">'+
							       '<th rowspan="3">区间</th>'+
							       ...
							       '</th>'+
							       '<td style="width:30%">'+
								   '<input type="text" id="site_range_line" name="site_range_line" class="range" style="width:98%;" readOnly/>'+
								   '</td>'+
								   '</tr>'+
								   '<tr class="thTdPadding">'+
							       ...
							       '</th>'+
							       '<td style="width:30%">'+
								   '<input type="text" id="site_range_post" name="site_range_post" class="range" style="width:98%;" readOnly/>'+
								   '</td>'+
								   '</tr>'+
								   '<tr class="thTdPadding">'+
								   '<th style="width:20%" ">安装地点：'+
							       '</th>'+
							       '<td style="width:30%">'+
								   '<input type="text" id="site_range_place" name="site_range_place" class="range" style="width:98%;" readOnly/>'+
								   '</td>'+
							       '</tr>'+
							       '<tr class="thTdPadding">'+
							       '<th rowspan="2">其他</th>'+
							       ...
							       '</th>'+
							       '<td style="width:30%">'+
								   '<input type="text" id="site_other_line" name="site_other_line" class="other" style="width:98%;" readOnly/>'+
								   '</td>'+
								   '</tr>'+
								   '<tr class="thTdPadding">'+
								   '<th style="width:20%" >安装地点：'+
							       '</th>'+
							       '<td style="width:30%">'+
								   '<input type="text" id="site_other_place" name="site_other_place" class="other" style="width:98%;" readOnly/>'+
								   '</td>'+
								   '</tr>'+
								   '<tr class="thTdPadding">'+
		                    ...
		                    label : '总容量：',
		                    itemColspan : 1,
		                    item : '<input type="text" name="totalCapacity" id="totalCapacity" style="width:98.5%" readOnly/>'
		                },{
		                    label : '路产容量：',
		                    itemColspan : 1,
