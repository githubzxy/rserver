 ...
 * 详情模块
 */
define('kmms/workAssortProtocolManagement/workAssortProtocol/workAssortProtocolInfo',['bui/common','common/form/FormContainer',
	'common/uploader/ViewUploader','common/data/PostLoad'],function(r){
	var BUI = r('bui/common'),
		Uploader = r('common/uploader/ViewUploader'),
		FormContainer= r('common/form/FormContainer');
	var WorkAssortProtocolInfo = BUI.Overlay.Dialog.extend({
...
//                elStyle:{overflowY:'scroll',height:'400px'}
		...
		ATTRS : {
			id : {value : 'workAssortProtocolInfoDialog'},
