 ...
 * @date 19-6-19
 */
define('kmms/technicalManagement/communicationResumeManage/wired/wiredEdit',['bui/common',
	'common/form/FormContainer',
    'bui/form',
    ],function(r){
    var BUI = r('bui/common'),
        FormContainer= r('common/form/FormContainer');
    var wiredEdit = BUI.Overlay.Dialog.extend({
...
//        },
            ...
            var childs = [
            	{
                    ...
                    label : '路产容量：',
                    itemColspan : 1,
                    item : '<input type="text" name="roadCapacity" id="roadCapacity" style="width:99%" data-rules="{required:true}"/>'
                },{
                    label : '资产比例：',
                    itemColspan : 1,
                    ...
                    label : '容量单位：',
                    itemColspan : 1,
                    item : '<input type="text" name="capacityUnit" id="capacityUnit" style="width:99%" data-rules="{required:true}"/>'
                },
                {
                    label : '设备厂家：',
                    redStarFlag : true,
        ...
        ATTRS : {
            id : {value : 'wiredEditDialog'},
            elAttrs : {value: {id:"wiredPointEdit"}},
            title:{value:'有线类--01'},
            width:{value:630},
            height:{value:500},
            contextPath : {},
            ...
            success:{
                value : function(){
                    var _self = this;
                    var formAdd = _self.getChild('wiredEditForm'),delData=_self.get('delData');
                    //验证不通过
	        		if(!formAdd.isValid()){
	        			return;
	        		}
                    ...
                    xhr.open("POST", "/zuul/kmms/wiredAction/updateDoc");
                    xhr.send(formData);
