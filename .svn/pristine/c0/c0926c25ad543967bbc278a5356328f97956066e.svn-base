 ...
 */
@Service("yearMonthPutieMongoService")
public class YearMonthPutieMongoServiceImpl implements YearMonthPutieMongoService {
	/**
	...
	@Override
	public void batchInsert(@SuppressWarnings("rawtypes") List<Map> workShopData, String collectionName) {
